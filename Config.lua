...
local options = {
    ...
    args = {
        ...
        -- Character delete / track toggles: Characters tab row actions (CharactersUI.lua).
        spacerFont = {
            order = 119,
            type = "description",
            name = "\n",
        ...
        antiAliasing = {
            order = 126,
            type = "select",
            name = function() return (ns.L and ns.L["ANTI_ALIASING"]) or "Font Outline" end,
            desc = function() return (ns.L and ns.L["ANTI_ALIASING_DESC"]) or "Adds a thin border around text so labels stay readable on light backgrounds and colored text." end,
            width = 1.5,
            values = {
                none = "Off (smooth)",
        ...
        usePixelNormalization = {
            ...
            desc = function() return (ns.L and ns.L["RESOLUTION_NORMALIZATION_TOOLTIP"]) or "Adjust font sizes for monitor resolution; WoW UI Scale still scales text with the interface." end,
            width = "full",
