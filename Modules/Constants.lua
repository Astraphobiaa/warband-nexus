...
local Constants = {
    ...
    EVENTS = {
        ...
        ACHIEVEMENT_CATEGORY_CACHE_INVALIDATED = "WN_ACHIEVEMENT_CATEGORY_CACHE_INVALIDATED",
        ...
        REAGENT_DEPOSIT_CHANGED = "WN_REAGENT_DEPOSIT_CHANGED",
    },
