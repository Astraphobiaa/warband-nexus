...
function Q.Install(ctx)
    ...
    f._questPickerPrimed = false
        ...
        ns.UI_SetTextColorRole(f.questSelectedEmpty, "Dim")
        ...
        ns.UI_SetTextColorRole(questPickerHint, "Dim")
        ...
        ns.UI_SetTextColorRole(questTagColHead, "Dim")
        ...
        ns.UI_SetTextColorRole(questPickColHead, "Dim")
        ...
        ns.UI_SetTextColorRole(questTitleColHead, "Dim")
