...
assert_eq(roadmap.characterName, "TestHunter", "Character name is TestHunter")
assert_eq(roadmap.vault.hasAvailableRewards, true, "Unclaimed Great Vault reward detected")
assert_eq(roadmap.vault.dungeon.completedCount, 2, "2 Dungeon vault slots completed")
...
assert_eq(roadmap.seasonalPower.keystoneLevel, 10, "Keystone level parsed (+10)")
...
-- Test 5: Raid lockouts check
assert_true(#roadmap.raidLockouts >= 1, "At least 1 raid lockout populated")
assert_eq(roadmap.raidLockouts[1].name, "The Venomous Abyss", "Raid lockout instance name matches")
