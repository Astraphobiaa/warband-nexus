...
| **[nanjuekaien1](https://github.com/nanjuekaien1)** | Simplified Chinese (`zhCN`) locale: extensive string updates, vault/delves wording, Blizzard global parity section cleanup, and keybinding globals ([PR #7](https://github.com/Astraphobiaa/warband-nexus/pull/7), [PR #8](https://github.com/Astraphobiaa/warband-nexus/pull/8)). |
