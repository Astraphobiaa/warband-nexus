...
L["LOOT_ALERTS"] = "戰利品警報"
L["LOOT_ALERTS_TOOLTIP"] = "收藏品彈窗主開關。關閉後將隱藏所有收藏品通知。"
...
L["CHANGELOG_V211"] = "改進：\n" ..
    "- 專業：專注度追蹤現在能正確識別每個專業。\n" ..
    "- 聊天：聲望和貨幣通知現在遵循每個面板的聊天設定。\n" ..
    "- 聊天：非破壞性訊息抑制保留您的聊天面板配置。\n" ..
    "- 資料完整性：標準化角色金鑰規範化。\n" ..
    "- 計畫：重複偵測防止添加相同物品兩次。\n" ..
    "- 貨幣：更嚴格的追蹤過濾器防止未追蹤角色出現。\n" ..
    "- 嘗試計數器：擴展難度映射（普通、10人普通、25人普通、隨機團隊）。\n" ..
    "- 汙染安全：Midnight 12.0 聲望解析秘密值保護。\n" ..
    "\n" ..
    "錯誤修復：\n" ..
    "- 修復了專業之間專注度資料被覆蓋的問題。\n" ..
    "- 修復了非預設聊天面板中缺少聲望/貨幣通知的問題。\n" ..
    "- 修復了副本戰鬥中的汙染錯誤（Midnight 12.0）。\n" ..
    "- 修復了處理程序為nil時事件佇列崩潰的問題。\n" ..
    "- 修復了資料庫未初始化時PvE快取清除崩潰的問題。\n" ..
    "- 修復了卡片佈局除以零的問題。\n" ..
    "\n" ..
    "感謝您的持續支持！\n" ..
    "\n" ..
    "如需報告問題或分享反饋，請在CurseForge - Warband Nexus上留言。"
