...
L["CONFIG_VAULT_BUTTON_SECTION"] = "寶庫按鈕"
L["CONFIG_VAULT_OPT_ENABLED"] = "寶庫按鈕"
L["CONFIG_VAULT_OPT_ENABLED_DESC"] = "顯示可拖曳的大秘寶按鈕。"
L["CONFIG_VAULT_OPT_MOUSEOVER"] = "滑鼠移上時才顯示"
L["CONFIG_VAULT_OPT_MOUSEOVER_DESC"] = "在游標移到儲存位置之前隱藏按鈕。"
L["CONFIG_VAULT_OPT_READY_ONLY"] = "有獎勵可領時才顯示"
L["CONFIG_VAULT_OPT_READY_ONLY_DESC"] = "僅當至少一名角色有可領取的寶庫獎勵時顯示按鈕。"
L["CONFIG_VAULT_OPT_REALM"] = "顯示伺服器名稱"
L["CONFIG_VAULT_OPT_REALM_DESC"] = "在寶庫按鈕表格與提示資訊中顯示角色的伺服器名稱。"
...
L["CONFIG_VAULT_COL_RAID_DESC"] = "在寶庫按鈕表格中顯示團隊寶庫進度。"
L["CONFIG_VAULT_COL_DUNGEON"] = "地城欄"
L["CONFIG_VAULT_COL_DUNGEON_DESC"] = "在寶庫按鈕表格中顯示傳奇鑰石地城寶庫進度。"
L["CONFIG_VAULT_COL_WORLD"] = "世界任務欄"
L["CONFIG_VAULT_COL_WORLD_DESC"] = "在寶庫按鈕表格中顯示世界活動寶庫進度。"
L["CONFIG_VAULT_COL_BOUNTY"] = "尋寶獵人的賞金欄"
L["CONFIG_VAULT_COL_BOUNTY_DESC"] = "在寶庫按鈕表格中顯示尋寶獵人的賞金完成狀態。"
L["CONFIG_VAULT_COL_VOIDCORE"] = "朦朧虛無核心欄"
L["CONFIG_VAULT_COL_VOIDCORE_DESC"] = "在寶庫按鈕表格中顯示朦朧虛無核心進度。"
L["CONFIG_VAULT_COL_MANAFLUX"] = "晨光魔流欄"
L["CONFIG_VAULT_COL_MANAFLUX_DESC"] = "在寶庫按鈕表格中顯示晨光魔流貨幣。"
L["CONFIG_VAULT_BUTTON_OPACITY"] = "按鈕不透明度"
L["CONFIG_VAULT_BUTTON_OPACITY_DESC"] = "調整寶庫按鈕可見時的不透明度。"
