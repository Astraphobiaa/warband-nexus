...
L["CHANGELOG_V250"] = "新功能：\n- To-Do標籤：計劃部分重新命名為To-Do，全新設計\n- 每週重置計時器：即時倒數\n- 角色概覽：任務和寶庫進度匯總卡片\n- Wowhead連結：右鍵複製Wowhead連結\n- 製造裝備改版：階級重鑄資訊替代誤導性的X/6標記\n- 提醒系統：每日登入、每週重置和倒數提醒\n\n裝備標籤：\n- 製造物品顯示階級+物品等級（如'神話 285'）而非'神話 5/6'\n- 最大物品等級的製造物品不再顯示錯誤的升級箭頭\n- 提示框顯示重鑄費用、建議階級和所需紋章\n\n專業知識：\n- 新增草藥學和採礦每週採集任務追蹤\n- 新增缺失的附魔每週任務變體\n- 驗證所有論文、獨特物品、寶藏和採集ID\n\n效能：\n- 限制調整大小更新——視窗縮放不再掉幀\n- 裝備標籤框架池化——每次重新整理減少約60個框架建立\n- 修復計劃描述展開時的框架洩漏\n\n錯誤修復：\n- 修復提醒對話框儲存時清除區域提醒的問題\n- 修復專業裝備的taint保護漏洞\n- 修復階級名稱解析錯誤\n- 修復最大物品等級從289修正為285\n\n感謝您的持續支持！\n如需回報問題，請在CurseForge - Warband Nexus上留言。"
