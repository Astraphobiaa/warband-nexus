...
L["MODULE_TRY_COUNTER"] = "嘗試計數"
L["MODULE_TRY_COUNTER_DESC"] = "自動追蹤 NPC 擊殺、首領、釣魚和容器掉落嘗試次數。停用將停止所有嘗試計數處理、工具提示和通知。"
...
L["CHANGELOG_V242"] = "新功能：\n- 公會與休息經驗追蹤：\n  • 跨角色追蹤公會成員與休息經驗\n- 金錢日誌與黃金自動化 - 物品介面：\n  • 每角色黃金日誌、存取款歷史\n  • 物品標籤頁中的黃金目標自動化\n- 新標籤頁：裝備：\n  • 帶物品等級追蹤的已裝備檢視\n  • 升級機會與儲存推薦（裝綁/戰團綁定）\n  • 跨角色升級候選\n- 新標籤頁：收藏：\n  • 坐騎、寵物、玩具、幻化等概覽\n  • 追蹤收藏進度與尋找遺漏物品\n\n改進：\n- 午夜 PvE 更新：\n  • 完整相容 Midnight 12.0.x API\n  • 首領/難度處理，issecretvalue 保護\n- 午夜聲望更新：聲望快取與 API 更新\n- 午夜貨幣更新：貨幣快取與元資料\n- 專業改進：配方助手增強、專業視窗處理\n- 計劃修訂：來源顯示修正（如 Nether-Warped Drake）、Mythic 顏色一致性\n- 設定修訂：設定 UI 更新與模組管理\n- 配方助手更新：材料來源與品質層級改進\n- 效能改進：幀預算、批次大小、非同步最佳化\n- 通知與嘗試計數穩定性：issecretvalue 保護、去重修正\n- 午夜雜項：API 相容性，僅除錯模式輸出\n- 在地化：Changelog 與 What's New 翻譯至 11 種語言，歡迎介面標籤描述更新\n\n感謝支持！CurseForge - Warband Nexus。"
L["CHANGELOG_V243"] = "新功能：\n- 公會與休息經驗追蹤：跨角色追蹤公會成員與休息經驗\n- 金錢日誌與黃金自動化 - 物品介面：每角色黃金日誌、存取款歷史\n- 新標籤頁：裝備：已裝備、升級選項、儲存推薦、跨角色升級候選\n- 新標籤頁：收藏：坐騎、寵物、玩具、幻化概覽與收藏進度\n\n改進：\n- 午夜 PvE/聲望/貨幣更新\n- 專業與配方助手、計劃、設定、效能、通知\n- 11種語言在地化\n\n感謝支持！CurseForge - Warband Nexus。"
