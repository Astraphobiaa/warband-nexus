...
L["CUSTOM_HEADER_MENU_NO_CANDIDATES"] = "No eligible characters."
L["CUSTOM_HEADER_MENU_ADD_FMT"] = "Add: %s"
L["CUSTOM_HEADER_ROW_ADD_TOOLTIP"] = "Edit this section"
L["CUSTOM_HEADER_ROW_ADD_TOOLTIP_BODY"] = "Search, tick characters, then Add selected. In the roster window, tick the first column to remove from this section. Each character is in at most one custom section."
...
L["CUSTOM_HEADER_SECTION_NONE"] = NONE or "None"
L["CUSTOM_HEADER_LOCK_TOOLTIP_TITLE"] = "Lock section"
L["CUSTOM_HEADER_LOCK_TOOLTIP_DESC"] = "Lock this section to protect its characters from being moved to other sections."
L["CUSTOM_HEADER_UNLOCK_TOOLTIP_TITLE"] = "Unlock section"
L["CUSTOM_HEADER_UNLOCK_TOOLTIP_DESC"] = "This section is locked against accidental character moves. Click to unlock."
L["CUSTOM_HEADER_ROW_LOCKED_TITLE"] = "Section Locked"
L["CUSTOM_HEADER_ROW_LOCKED_TOOLTIP"] = "Character is locked in section '%s'. Unlock that section first to move."
L["CUSTOM_HEADER_ROW_WILL_MOVE"] = "Will move from '%s'"
L["CUSTOM_HEADER_SECTION_LOCKED_REMOVE_TOOLTIP"] = "This section is locked. Unlock header to remove members."
L["CUSTOM_HEADER_LOCKED_SHORT"] = "Locked"
L["CUSTOM_HEADER_LOCK_CHAR"] = "Lock character to section"
L["CUSTOM_HEADER_UNLOCK_CHAR"] = "Unlock this character"
L["REAGENT_DEPOSIT_BTN"] = "Reagents"
L["REAGENT_DEPOSIT_TITLE"] = "Reagent Deposit Manager"
L["REAGENT_DEPOSIT_ENABLE"] = "Enable Deposit Manager"
L["REAGENT_DEPOSIT_AUTO_OPEN"] = "Auto-deposit when Bank opens"
L["REAGENT_DEPOSIT_AUTO_OPEN_DESC"] = "Automatically transfers matching items to bank every time you open the bank frame."
L["REAGENT_DEPOSIT_IGNORE_FOOD"] = "Ignore Food & Drinks (including Warbound)"
L["REAGENT_DEPOSIT_IGNORE_FOOD_DESC"] = "Never automatically deposit food, drinks, feasts, or hearty meals into the bank, keeping your raid and dungeon consumables safe."
L["REAGENT_DEPOSIT_CHAR_ONLY"] = "Only For This Character (%s)"
L["REAGENT_DEPOSIT_DESTINATION"] = "Destination"
L["REAGENT_DEPOSIT_DEST_WARBAND"] = "Warband Bank (Account)"
L["REAGENT_DEPOSIT_DEST_REAGENT"] = "Personal Reagent Bank"
L["REAGENT_DEPOSIT_DEST_WARBAND_DESC"] = "Deposits matching reagents and tokens into your Warband Bank, accessible across your entire account."
L["REAGENT_DEPOSIT_DEST_WARBAND_NOTE"] = "Note: Soulbound items cannot be deposited into the Warband Bank due to Blizzard game restrictions."
L["REAGENT_DEPOSIT_DEST_REAGENT_DESC"] = "Deposits matching reagents into this character's personal Reagent Bank tab."
L["REAGENT_DEPOSIT_DEST_REAGENT_NOTE"] = "Note: Only standard crafting reagents can be stored here. Expansion mini-game or covenant materials are not accepted."
L["REAGENT_DEPOSIT_CATEGORIES"] = "Deposit Categories"
L["REAGENT_DEPOSIT_SELECT_ALL"] = "Select All"
L["REAGENT_DEPOSIT_CLEAR_ALL"] = "Clear All"
L["REAGENT_DEPOSIT_NOW"] = "Deposit Items Now"
L["REAGENT_DEPOSIT_SENT"] = "Depositing..."
L["REAGENT_DEPOSIT_BANK_CLOSED_TIP"] = "Open your bank or Warband bank to deposit items now."
L["REAGENT_CAT_HERBS"] = "Herbs"
L["REAGENT_CAT_MINING"] = "Metal & Stone"
L["REAGENT_CAT_LEATHER"] = "Leather & Hides"
L["REAGENT_CAT_CLOTH"] = "Cloth"
L["REAGENT_CAT_ENCHANTING"] = "Enchanting"
L["REAGENT_CAT_INSCRIPTION"] = "Inscription"
L["REAGENT_CAT_COOKING"] = "Cooking"
L["REAGENT_CAT_GEMS"] = "Gems"
L["REAGENT_CAT_PARTS"] = "Engineering Parts"
L["REAGENT_CAT_ELEMENTAL"] = "Elemental"
L["REAGENT_CAT_GENERAL"] = "General Reagents"
L["REAGENT_CAT_TOKENS"] = "Item Currencies (Marks)"
L["REAGENT_CAT_WARBOUND"] = "Warbound Gear (WuE)"
...
L["LANGUAGE_TR_FONT_HINT"] = "If Turkish characters do not display correctly, try a different font such as Exo or Arial."
...
L["PVP_DESC"] = "Compare rated brackets across your warband: 2v2, 3v3, Solo Shuffle, Blitz, and Rated BG ratings with weekly and seasonal win records. Tracks honor level, Honor and Conquest caps, recent match history with rating changes, and the active brawl."
...
L["MAIL_REMINDER"] = "Mail expiry reminder"
L["MAIL_REMINDER_TOOLTIP"] = "Show a reminder popup on login when mail on any tracked character expires within a week. The envelope icon on the Characters tab turns orange in the last week and red in the last day."
L["MAIL_REMINDER_TITLE"] = "Mail expiring soon!"
L["MAIL_REMINDER_ACTION"] = "You have %d mail(s) expiring, soonest in %s"
L["MAIL_REMINDER_ACTION_SIMPLE"] = "You have %d mail(s) expiring soon"
...
L["MODULE_PVP"] = "PvP"
L["MODULE_PVP_DESC"] = "Track rated brackets, honor progress, and match history. Disabling stops all PvP data collection."
...
L["ABOUT_COMMUNITY_HINT"] = "Click a button to show its link, then press Ctrl+C to copy."
...
L["GEAR_DAWNCREST_PLAYBOOK_TITLE"] = "Mistcrest upgrade playbook"
L["GEAR_DAWNCREST_PLAYBOOK_SUMMARY"] = "Each upgrade step: %s Mistcrests + gold. Earn via delves, dungeons, Mythic+, and raids - hover header for tier sources."
L["GEAR_DAWNCREST_PLAYBOOK_TOOLTIP_LEAD"] = "Item upgrades spend %s Mistcrests per tier step (plus gold) at the upgrade vendor."
...
L["GEAR_DAWNCREST_PLAYBOOK_BY_TIER"] = "Sources by Mistcrest tier:"
...
L["GEAR_TT_UPGRADE_FALLBACK_LEAD"] = "Upgrades use Mistcrest (amounts on the currency panel). Examples by tier:"
...
L["GEAR_CRAFTED_COST_DAWNCREST"] = "Cost: %d %s Mistcrest"
...
L["CLICK_TO_COPY_URL"] = "Click to copy the link"
...
L["CONCENTRATION_CAP_IN"] = "Cap in %s"
L["CONCENTRATION_CAPPED"] = "Capped (1,000/1,000)"
L["CONCENTRATION_EXPIRING_ALERT"] = "Concentration capping soon on %s (%s)"
L["CASCADE_SAVINGS_BANNER"] = "Cascades to %d alts: Saves %d %s across your Warband"
L["CASCADE_AFFECTED_ALTS"] = "Upgrading to %d grants account-wide crest discounts to:"
L["NEAREST_ELIGIBLE_ALT"] = "Best Alt: %s (%s)"
L["KEYSTONE_SYNERGY_TITLE"] = "Keystone Synergy"
L["KEYSTONE_RATING_BOOST"] = "Held by %s: +%d potential rating for %s"
L["KEYSTONE_REROLL_SUGGESTION"] = "Target Reroll: %s (%d alts need score)"
