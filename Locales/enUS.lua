...
L["AUTO_TRY_COUNTER_TOOLTIP"] = "Automatically count failed drop attempts when looting NPCs, rares, bosses, fishing, or containers. Attempt totals update in the addon UI; chat shows milestones (e.g. obtained), not every +1. Moving from Rarity: enable Rarity once, then |cff00ccff/wn rarityimport|r (copies data + backup), then you can disable Rarity; |cff00ccff/wn rarityrestore|r reapplies the saved backup if needed."
