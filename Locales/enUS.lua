...
L["ICON_THEME"] = "Icon Theme"
L["ICON_THEME_TOOLTIP"] = "Classic uses Blizzard icons. Modern uses custom Atlas Icons (PNG) for plan actions and collection slots."
L["ICON_THEME_CLASSIC"] = "Classic"
L["ICON_THEME_MODERN"] = "Modern"
L["ICON_THEME_APPLIED_RELOAD"] = "Icon theme changed. Open Plans or reload UI to refresh all rows."
