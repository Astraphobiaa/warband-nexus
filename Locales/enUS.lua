...
L["CONFIG_VAULT_BUTTON_SECTION"] = "Vault Button"
L["CONFIG_VAULT_OPT_ENABLED"] = "Vault Button"
L["CONFIG_VAULT_OPT_ENABLED_DESC"] = "Show the draggable Great Vault status button."
L["CONFIG_VAULT_OPT_MOUSEOVER"] = "Hide Until Mouseover"
L["CONFIG_VAULT_OPT_MOUSEOVER_DESC"] = "Keep the vault button invisible until the cursor is over its saved position."
L["CONFIG_VAULT_OPT_READY_ONLY"] = "Hide Until Ready"
L["CONFIG_VAULT_OPT_READY_ONLY_DESC"] = "Only show the vault button when at least one character has a vault reward ready to claim."
L["CONFIG_VAULT_OPT_REALM"] = "Show Realm Names"
L["CONFIG_VAULT_OPT_REALM_DESC"] = "Show character realm names in vault button tables and tooltips."
...
L["CONFIG_VAULT_COL_RAID_DESC"] = "Show raid vault progress in the vault button table."
L["CONFIG_VAULT_COL_DUNGEON"] = "Dungeon Column"
L["CONFIG_VAULT_COL_DUNGEON_DESC"] = "Show Mythic+ dungeon vault progress in the vault button table."
L["CONFIG_VAULT_COL_WORLD"] = "World Column"
L["CONFIG_VAULT_COL_WORLD_DESC"] = "Show world activity vault progress in the vault button table."
L["CONFIG_VAULT_COL_BOUNTY"] = "Trovehunter's Bounty Column"
L["CONFIG_VAULT_COL_BOUNTY_DESC"] = "Show Trovehunter's Bounty completion in the vault button table."
L["CONFIG_VAULT_COL_VOIDCORE"] = "Nebulous Voidcore Column"
L["CONFIG_VAULT_COL_VOIDCORE_DESC"] = "Show Nebulous Voidcore progress in the vault button table."
L["CONFIG_VAULT_COL_MANAFLUX"] = "Dawnlight Manaflux Column"
L["CONFIG_VAULT_COL_MANAFLUX_DESC"] = "Show Dawnlight Manaflux currency in the vault button table."
L["CONFIG_VAULT_BUTTON_OPACITY"] = "Button Opacity"
L["CONFIG_VAULT_BUTTON_OPACITY_DESC"] = "Adjust the vault button opacity when it is visible."
