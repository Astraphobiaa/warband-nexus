...
L["KEYBINDING_REPLACES"] = "Diese Taste war %s zugewiesen — sie steht jetzt für Warband Nexus."
...
L["KEYBINDING_VERIFY_FAIL"] = "Die Taste ist noch einer anderen Aktion zugewiesen (%s). Öffne Esc > Optionen > Tastaturbelegung, entferne dort die Belegung und versuche es erneut."
...
L["AUTO_SCAN"] = "Auto-Scan beim Banköffnen"
...
L["VAULT_COMPLETE_PREFIX"] = "Schließe ab"
...
L["SHOW_TOOLTIP_ITEM_COUNT"] = "Gegenstände in Tooltips anzeigen"
...
L["CROSS_CHAR_SUMMARY"] = "Charakterübersicht"
...
L["CURRENCY_ACCOUNT_WIDE_NOTE"] = "Accountweit (Kriegsmeute) — gleicher Kontostand bei allen Charakteren."
L["YOU_MARKER"] = "(Du)"
...
L["ADD_CUSTOM_DESC"] = "Drop-Quellen hinzufügen, die nicht in der eingebauten Datenbank sind, oder bestehende eigene Einträge entfernen."
...
L["ADD_ITEMS_TO_PLANS"] = "Füge Gegenstände zu deinen Plänen hinzu, um sie hier zu sehen!"
...
L["CONFIG_RESET_PLANS_CONFIRM"] = "Dies entfernt alle abgeschlossenen Pläne. Fortfahren?"
L["CONFIG_RESET_PLANS_FORMAT"] = "%d abgeschlossene(r) Plan/Pläne entfernt."
L["CONFIG_NO_COMPLETED_PLANS"] = "Keine abgeschlossenen Pläne zum Entfernen."
...
L["CONFIG_DELETE_CONFIRM"] = "Bist du sicher, dass du alle Daten dieses Charakters dauerhaft löschen möchtest? Dies kann nicht rückgängig gemacht werden."
L["CONFIG_DELETE_SUCCESS"] = "Charakterdaten gelöscht:"
...
L["CONFIG_FONT_SIZE"] = "Schriftgrößen-Skalierung"
...
L["GOLD_MANAGEMENT_WARNING"] = "|cff44ff44Vollautomatisch:|r Sowohl Goldeinzahlungen als auch -abhebungen werden automatisch durchgeführt, wenn die Bank geöffnet ist. Lege deinen Zielbetrag fest und lass das Addon dein Gold verwalten!"
...
L["GEAR_NO_CURRENCY_DATA"] = "Noch keine Währungsdaten"
L["GEAR_NO_ITEMS_FOUND"] = "Keine passenden ausgerüsteten Gegenstände gefunden"
L["GEAR_NO_STORAGE_FINDS"] = "Keine Lager-Upgrades gefunden. Bank-Tabs öffnen für bessere Ergebnisse."
L["GEAR_NO_UPGRADE_ITEMS"] = "Keine Upgrades verfügbar – alle Ausrüstung ist auf maximaler Stufe oder wird nicht unterstützt."
L["GEAR_NO_UPGRADES_AVAILABLE"] = "Mit aktuellen Ressourcen keine Upgrades verfügbar"
L["GEAR_SEARCH_PLACEHOLDER"] = "Ausgerüstete Gegenstände suchen..."
L["GEAR_SECTION_EQUIPPED"] = "AUSGERÜSTETE AUSRÜSTUNG"
L["GEAR_SECTION_LIST"] = "Alle ausgerüsteten Gegenstände"
L["GEAR_SECTION_RESOURCES"] = "RESSOURCEN"
L["GEAR_SECTION_STORAGE"] = "Lager-Upgrades"
L["GEAR_SECTION_UPGRADES"] = "Upgrade-Möglichkeiten"
...
L["GEAR_UPGRADE_CURRENT_CHAR_ONLY"] = "Upgrade-Info nur für aktuellen Charakter verfügbar."
L["GEAR_UPGRADEABLE_SLOTS"] = "Platz/Plätze verbesserbar"
...
L["POPUP_POSITION_SAME_CRITERIA"] = "Gleiche Position für alle (Erfolg, Kriterien-Fortschritt usw.)"
L["PROF_DATA_SOURCE_NOTE"] = "Konzentration, Wissen und Rezepte aktualisieren sich, wenn du das Berufefenster (K) bei jedem Charakter öffnest."
L["PROF_FILTER_ALL"] = "Alle"
L["PROF_FILTER_EXPANSION"] = "Erweiterungsfilter"
L["PROF_FILTER_STRICT_NOTE"] = "Nur Berufsdaten dieser Erweiterung für alle Charaktere anzeigen."
...
L["PROF_FIRSTCRAFT_OPEN_WINDOW"] = "Öffne zuerst ein Berufefenster und führe den Befehl dann erneut aus."
...
L["RESET_CRITERIA_BLIZZARD"] = "Zurücksetzen (rechte Seite)"
