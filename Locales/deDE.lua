...
L["CMD_PLANS"] = "Pläne-Tracker-Fenster umschalten"
...
-- =============================================
L["CHANGELOG_V247"] = "NEUE FUNKTIONEN:\n- UI-Skalierung: Addon-Oberfläche in den Einstellungen anpassen\n- Gold-Automatisierung: Separate Gold-Verwaltung pro Charakter\n- Gold-Eingabe: Live-Formatierung mit 9.999.999g Maximum\n\nVERBESSERUNGEN:\n- Ruf-UI: Umfassende Überarbeitung mit verbessertem Layout\n- Lager-UI: Überarbeitet für bessere Leistung\n- Berufe-UI: Verbesserte Spalten und Layout\n- Minimap: Klassengefärbte Namen, verbesserter Tooltip\n- Gold-Protokoll: Verbesserte Transaktionsanzeige\n- UI-Hierarchie: Optimierte Frame-Anordnung\n\nLEISTUNG & LOKALISIERUNG:\n- Veraltete Module entfernt, umfassende Code-Bereinigung\n- Alle 11 Sprachen synchronisiert (1.404 Schlüssel, keine Lücken)\n- WoW Global Strings Integration\n\nVielen Dank für eure Unterstützung!\nUm Probleme zu melden oder Feedback zu geben, hinterlasst einen Kommentar auf CurseForge - Warband Nexus."
