...
-- =============================================
L["CHANGELOG_V211"] = "УЛУЧШЕНИЯ:\n" ..
    "- Профессии: Отслеживание концентрации теперь корректно определяет каждую профессию.\n" ..
    "- Чат: Уведомления о репутации и валюте теперь учитывают настройки каждой панели.\n" ..
    "- Чат: Неразрушающее подавление сообщений сохраняет конфигурацию чата.\n" ..
    "- Целостность данных: Стандартизированная нормализация ключей персонажей.\n" ..
    "- Планы: Обнаружение дубликатов предотвращает двойное добавление.\n" ..
    "- Валюта: Более строгий фильтр отслеживания предотвращает неотслеживаемых персонажей.\n" ..
    "- Счётчик попыток: Расширенное сопоставление сложности (Обычный, 10Об, 25Об, ПГ).\n" ..
    "- Защита от Taint: Защита секретных значений Midnight 12.0 для парсинга репутации.\n" ..
    "\n" ..
    "ИСПРАВЛЕНИЯ:\n" ..
    "- Исправлена перезапись данных концентрации между профессиями.\n" ..
    "- Исправлено отсутствие уведомлений о репутации/валюте в нестандартных панелях чата.\n" ..
    "- Исправлена ошибка taint во время боя в подземелье (Midnight 12.0).\n" ..
    "- Исправлен сбой очереди событий при nil обработчике.\n" ..
    "- Исправлен сбой очистки кэша PvE без инициализированной базы данных.\n" ..
    "- Исправлено деление на ноль в раскладке карточек.\n" ..
    "\n" ..
