...
L["CHARACTERS_DESC"] = "Просмотр всех ваших персонажей с информацией о золоте, уровне, профессиях и последнем времени игры."
L["ITEMS_DESC"] = "Поиск предметов во всех сумках и банках. Автоматическое обновление при открытии банка."
L["STORAGE_DESC"] = "Просмотр всего вашего инвентаря, собранного со всех персонажей и банков."
L["PVE_DESC"] = "Отслеживание Великого хранилища, ключей Мифический+ и блокировок рейдов для всех персонажей."
L["REPUTATIONS_DESC"] = "Мониторинг прогресса репутации с умной фильтрацией (На весь аккаунт против Привязанные к персонажу)."
L["CURRENCY_DESC"] = "Просмотр всех валют, организованных по дополнениям, с опциями фильтрации."
L["PLANS_DESC"] = "Просмотр и отслеживание средств передвижения, питомцев, игрушек, достижений и трансмогрификаций, которые вы ещё не собрали."
L["STATISTICS_DESC"] = "Просмотр очков достижений, прогресса коллекции и статистики использования сумок/банков."
...
-- =============================================
L["CHANGELOG_V200"] = "КРУПНЫЕ ОБНОВЛЕНИЯ:\n" ..
    "- Уведомления о добыче и достижениях: Получайте уведомления, когда вы получаете средства передвижения, питомцев, игрушки, иллюзии, титулы и достижения\n" ..
    "- Напоминание о еженедельном хранилище: Всплывающее уведомление, когда у вас есть неполученные награды хранилища\n" ..
    "- Вкладка Планы: Организуйте свои цели и отслеживайте, что вы хотите собрать дальше\n" ..
    "- Система шрифтов: Настраиваемые шрифты во всём аддоне\n" ..
    "- Цвета темы: Пользовательские акцентные цвета для персонализации интерфейса\n" ..
    "- Улучшения интерфейса: Более чистый макет, лучшая организация, поиск и визуальная полировка\n" ..
    "- Сообщения в чате о приросте репутации и валюты: Сообщения [WN-Репутация] и [WN-Валюта] в реальном времени с прогрессом\n" ..
    "- Система подсказок: Улучшенные подсказки по всему интерфейсу\n" ..
    "- Отслеживание персонажей: Выберите, каких персонажей отслеживать\n" ..
    "- Избранные персонажи: Отметьте своих любимых персонажей в списке звездой\n" ..
    "\n" ..
    "МЕЛКИЕ ОБНОВЛЕНИЯ:\n" ..
    "- Модуль банка отключён\n" ..
    "- Удалена старая система базы данных (улучшения и исправления ошибок)\n" ..
    "- Опция скрытия всплывающего окна достижения Blizzard при использовании уведомлений WN\n" ..
    "- Настраиваемая позиция уведомлений для всплывающих уведомлений о добыче и достижениях\n" ..
    "\n" ..
    "Спасибо за использование Warband Nexus!\n" ..
    "\n" ..
    "Если вы хотите сообщить об ошибке или оставить отзыв, вы можете оставить комментарий на CurseForge - Warband Nexus."
