...
-- =============================================
L["CHANGELOG_V211"] = "새로운 기능:\n" ..
    "- 업적 팝업: 연결된 업적 기준을 클릭하여 추적 및 +추가 버튼이 있는 세부 정보를 확인하세요.\n" ..
    "- 계획됨 표시: 계획에 있는 아이템, 탈것, 소환수, 장난감, 업적에 노란색 \"(계획됨)\" 접미사가 표시됩니다.\n" ..
    "- 계획됨 필터: 찾아보기 뷰에서 계획된 아이템만 표시하는 새로운 체크박스.\n" ..
    "- 난이도별 시도 카운터: 시도 횟수가 이제 드롭 난이도를 준수합니다 (예: 피라크 탈것은 영웅+ 에서만).\n" ..
    "\n" ..
    "개선 사항:\n" ..
    "- 계획 UI: 더 촘촘한 카드 배치를 위한 벽돌쌓기 레이아웃.\n" ..
    "- 계획 UI: 완료된 기준은 더 이상 상호작용할 수 없습니다 (추적/+추가 비활성화).\n" ..
    "- 툴팁: 수집된 아이템에 녹색 체크 아이콘 (\"수집됨\" 텍스트 대체).\n" ..
    "- 시도 카운터: 17+ 도른 섬 희귀 NPC와 함께 딱딱거리는 파편 지역 추적.\n" ..
    "- 시도 카운터: 기타 기계장치 수확물 표시 (탈것 3, 소환수 6) 툴팁.\n" ..
    "- Midnight 12.0: 전투 안전을 위한 난이도 매칭 비밀 값 보호.\n" ..
    "\n" ..
    "버그 수정:\n" ..
    "- 잘못된 난이도에서 시도 카운터가 증가하지 않습니다 (예: 일반에서 피라크).\n" ..
    "- 찾아보기 또는 팝업에서 +추가 후 계획이 즉시 나타납니다.\n" ..
    "- 업적 팝업이 외부 클릭 시 닫힙니다.\n" ..
    "- 상인 장난감 및 감지된 소환수에 대한 알림이 다시 작동합니다.\n" ..
    "- 반복 가능한 아이템 드롭에 대한 알림이 다시 작동합니다.\n" ..
    "- 계획 탭 첫 로드 시 카드 레이아웃 간격이 수정되었습니다.\n" ..
    "\n" ..
    "지속적인 지원에 감사드립니다!\n" ..
    "\n" ..
    "문제를 보고하거나 피드백을 공유하려면 CurseForge - Warband Nexus에 댓글을 남겨주세요."
...
-- =============================================
L["CHANGELOG_V212"] = "개선 사항:\n" ..
    "- 전문 기술: 집중도 추적이 이제 각 전문 기술을 올바르게 독립적으로 식별합니다.\n" ..
    "- 데이터 무결성: 모든 모듈에서 캐릭터 키 정규화를 표준화했습니다.\n" ..
    "- 계획: 중복 감지로 동일한 항목을 두 번 추가하는 것을 방지합니다.\n" ..
    "- 계획: GetPlanByID가 이제 표준 및 사용자 정의 계획 목록을 모두 검색합니다.\n" ..
    "- 화폐: 추적되지 않는 캐릭터가 표시되지 않도록 더 엄격한 추적 필터를 적용했습니다.\n" ..
    "- 이벤트: 재진입을 방지하기 위해 실행 전에 타이머를 설정하는 스로틀 함수.\n" ..
    "- 시도 카운터: 확장된 난이도 매핑 (일반, 10인 일반, 25인 일반, 공격대 찾기).\n" ..
    "\n" ..
    "버그 수정:\n" ..
    "- 전문 기술 간 집중도 데이터가 덮어쓰이는 문제 수정 (예: 연금술이 주문각인 값을 표시).\n" ..
    "- 다른 전문 기술 창을 열 때 집중도가 교환되는 문제 수정.\n" ..
    "- 핸들러 또는 인자가 nil일 때 이벤트 대기열 충돌 수정.\n" ..
    "- 데이터베이스가 초기화되지 않았을 때 PvE 캐시 삭제 충돌 수정.\n" ..
    "- 부모 프레임에 너비가 없을 때 카드 레이아웃 0으로 나누기 오류 수정.\n" ..
    "\n" ..
    "정리:\n" ..
    "- 사용하지 않는 골드 이체 UI 코드 및 관련 로케일 키 제거.\n" ..
    "- 사용하지 않는 스캔 상태 UI 요소 제거.\n" ..
    "\n" ..
    "지속적인 지원에 감사드립니다!\n" ..
    "\n" ..
    "문제를 보고하거나 피드백을 공유하려면 CurseForge - Warband Nexus에 댓글을 남겨주세요."
