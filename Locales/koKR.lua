...
L["SHOW_TOOLTIP_ITEM_COUNT_TOOLTIP"] = "툴팁에 전투부대 및 캐릭터 아이템 개수를 표시합니다 (WN 검색)."
...
L["LOOT_ALERTS_TOOLTIP"] = "수집품 팝업 마스터 토글. 비활성화하면 모든 수집품 알림이 숨겨집니다."
L["LOOT_ALERTS_MOUNT"] = "탈것 알림"
L["LOOT_ALERTS_MOUNT_TOOLTIP"] = "새 탈것을 수집하면 알림을 표시합니다."
L["LOOT_ALERTS_PET"] = "애완동물 알림"
L["LOOT_ALERTS_PET_TOOLTIP"] = "새 애완동물을 수집하면 알림을 표시합니다."
L["LOOT_ALERTS_TOY"] = "장난감 알림"
L["LOOT_ALERTS_TOY_TOOLTIP"] = "새 장난감을 수집하면 알림을 표시합니다."
L["LOOT_ALERTS_TRANSMOG"] = "외형 알림"
L["LOOT_ALERTS_TRANSMOG_TOOLTIP"] = "새 방어구 또는 무기 외형을 수집하면 알림을 표시합니다."
L["LOOT_ALERTS_ILLUSION"] = "환영 알림"
L["LOOT_ALERTS_ILLUSION_TOOLTIP"] = "새 무기 환영을 수집하면 알림을 표시합니다."
L["LOOT_ALERTS_TITLE"] = "칭호 알림"
L["LOOT_ALERTS_TITLE_TOOLTIP"] = "새 칭호를 획득하면 알림을 표시합니다."
L["LOOT_ALERTS_ACHIEVEMENT"] = "업적 알림"
L["LOOT_ALERTS_ACHIEVEMENT_TOOLTIP"] = "새 업적을 획득하면 알림을 표시합니다."
...
L["CURRENCY_ACCOUNT_WIDE_NOTE"] = "계정 공유 (전쟁부대) — 모든 캐릭터에 동일한 잔액."
L["YOU_MARKER"] = "(당신)"
L["WN_SEARCH"] = "WN 검색"
...
L["COLLECTED_ITEM_MSG"] = "희귀 전리품을 획득했습니다"
...
-- =============================================
L["CHANGELOG_V211"] = "개선 사항:\n" ..
    "- 전문 기술: 집중도 추적이 이제 각 전문 기술을 독립적으로 식별합니다.\n" ..
    "- 채팅: 평판 및 화폐 알림이 이제 패널별 채팅 설정을 준수합니다.\n" ..
    "- 채팅: 비파괴적 메시지 억제로 채팅 패널 설정을 보존합니다.\n" ..
    "- 데이터 무결성: 모든 모듈에서 표준화된 캐릭터 키 정규화.\n" ..
    "- 계획: 중복 감지로 같은 항목을 두 번 추가하는 것을 방지합니다.\n" ..
    "- 화폐: 더 엄격한 추적 필터로 추적되지 않는 캐릭터를 방지합니다.\n" ..
    "- 시도 카운터: 확장된 난이도 매핑 (일반, 10인 일반, 25인 일반, 무작위 찾기).\n" ..
    "- 테인트 안전: Midnight 12.0 평판 파싱 비밀 값 보호.\n" ..
    "\n" ..
    "버그 수정:\n" ..
    "- 전문 기술 간 집중도 데이터 덮어쓰기 수정.\n" ..
    "- 기본이 아닌 채팅 패널에서 평판/화폐 알림 누락 수정.\n" ..
    "- 인스턴스 전투 중 테인트 오류 수정 (Midnight 12.0).\n" ..
    "- nil 핸들러로 인한 이벤트 큐 충돌 수정.\n" ..
    "- 초기화되지 않은 데이터베이스에서 PvE 캐시 정리 충돌 수정.\n" ..
    "- 카드 레이아웃 0으로 나누기 수정.\n" ..
    "\n" ..
    "지속적인 지원에 감사합니다!\n" ..
    "\n" ..
