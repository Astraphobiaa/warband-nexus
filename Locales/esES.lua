...
L["KEYBINDING_REPLACES"] = "Esa tecla estaba asignada a %s — ahora es para Warband Nexus."
...
L["KEYBINDING_VERIFY_FAIL"] = "La tecla sigue asignada a otra acción (%s). Abre Esc > Opciones > Controles, elimina esa asignación y vuelve a intentarlo aquí."
...
L["VAULT_MAX_TIER"] = "Nivel máximo"
L["VAULT_AT_MAX"] = "¡Nivel máximo alcanzado!"
...
L["QUEST_TYPE_CONTENT_EVENTS_DESC"] = "Objetivos bonus, tareas de evento y actividades estilo campaña"
...
L["TRYCOUNTER_FIRST_TRY"] = "¡al primer intento!"
...
L["TRYCOUNTER_INSTANCE_DROPS_TRUNCATED"] = "… |cffffccff%d|r más — |cffffffff/wn check|r en un jefe (objetivo o ratón)."
...
-- Parity with enUS
L["ACHIEVEMENT"] = "Logro"
L["ADD_ITEMS_TO_PLANS"] = "¡Añade objetos a tus planes para verlos aquí!"
...
L["CRITERIA_POSITION_LABEL"] = "Posición del progreso de criterios"
...
L["GEAR_NO_CURRENCY_DATA"] = "Aún no hay datos de moneda"
L["GEAR_NO_ITEMS_FOUND"] = "No se encontraron objetos equipados que coincidan"
L["GEAR_NO_STORAGE_FINDS"] = "No se encontraron mejoras de banco. Abre las pestañas del banco para mejores resultados."
L["GEAR_NO_UPGRADE_ITEMS"] = "No hay mejoras disponibles: todo el equipo está al nivel máximo o no compatible."
...
L["LT_COLLECTION_SCAN"] = "Escaneo de colección"
...
L["POPUP_POSITION_SAME_CRITERIA"] = "Misma posición para todo (logro, progreso de criterios, etc.)"
L["PROF_DATA_SOURCE_NOTE"] = "Concentración, conocimiento y recetas se actualizan al abrir la ventana de profesiones (K) en cada personaje."
L["PROF_FILTER_ALL"] = "Todo"
L["PROF_FILTER_EXPANSION"] = "Filtro de expansión"
L["PROF_FILTER_STRICT_NOTE"] = "Mostrar solo datos de profesión de esta expansión para todos los personajes."
L["PROF_FIRSTCRAFT_HEADER"] = "Recetas de primera fabricación"
L["PROF_FIRSTCRAFT_NO_DATA"] = "No hay datos de profesión disponibles."
L["PROF_FIRSTCRAFT_NONE"] = "No hay recetas aprendidas con bonus de primera fabricación restante."
L["PROF_FIRSTCRAFT_OPEN_WINDOW"] = "Abre primero una ventana de profesión y vuelve a ejecutar este comando."
...
L["SET_POSITION_CRITERIA"] = "Establecer posición de criterios"
...
L["SOURCE"] = "Fuente"
L["SOURCE_QUEST_REWARD"] = "Recompensa de misión"
