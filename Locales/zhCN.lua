...
L["VAULT_SLOT_RAIDS"] = RAIDS or "团队"
...
L["VAULT_TRACKER_STATUS_SLOTS_READY"] = "槽位已就绪"

L["CONFIG_VAULT_BUTTON"] = "金库按钮"
L["CONFIG_VAULT_BUTTON_DESC"] = "显示可拖动的金库按钮。左键：切换主窗口；右键：打开 WN 快捷菜单。"
L["VAULT_BUTTON_MENU_TITLE"] = "WN 菜单"
L["VAULT_BUTTON_MENU_TRACKER"] = "金库追踪器"
