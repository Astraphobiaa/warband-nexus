...
L["DIFFICULTY_HEROIC"] = PLAYER_DIFFICULTY2 or "英勇"
L["DIFFICULTY_MYTHIC"] = PLAYER_DIFFICULTY6 or "神话"
L["DIFFICULTY_NORMAL"] = PLAYER_DIFFICULTY1 or "普通的"
L["DUNGEON_CAT"] = LFG_TYPE_DUNGEON or "地下城"
L["FALLBACK_UNKNOWN_SOURCE"] = UNKNOWN or "未知"
L["FIRSTCRAFT"] = PROFESSIONS_FIRST_CRAFT or "第一工艺"
L["GROUP_MISC"] = BAG_FILTER_MISCELLANEOUS or "各种各样的"
L["GROUP_PROFESSION"] = BATTLE_PET_SOURCE_4 or "职业"
L["HEADER_CHARACTERS"] = CHARACTER or "人物"
L["HEADER_FAVORITES"] = FAVORITES or "收藏夹"
L["ITEMS_GUILD_BANK"] = GUILD_BANK or "行会银行"
L["ITEMS_PLAYER_BANK"] = BANK or "玩家银行"
L["NONE_LABEL"] = NONE or "没有任何"
L["NOTIFICATIONS_LABEL"] = NOTIFICATIONS or "通知"
L["OK_BUTTON"] = OKAY or "好的"
L["PARSE_ARENA"] = ARENA or "竞技场"
L["PARSE_DROP"] = BATTLE_PET_SOURCE_1 or "降低"
L["PARSE_DUNGEON"] = DUNGEONS or "地下城"
L["PARSE_FACTION"] = FACTION or "派"
L["PARSE_RAID"] = RAID or "袭击"
L["PARSE_REPUTATION"] = REPUTATION or "名声"
L["PARSE_ZONE"] = ZONE or "区"
L["PVE_HEADER_DUNGEONS"] = DUNGEONS or "地下城"
L["PVE_HEADER_RAIDS"] = RAIDS or "突袭"
L["PVP_TYPE"] = PVP or "玩家对战"
L["RAID_CAT"] = RAID or "袭击"
L["RAIDS_LABEL"] = RAIDS or "突袭"
L["RELOAD_UI_BUTTON"] = RELOADUI or "重新加载用户界面"
L["RESET_LABEL"] = RESET or "重置"
L["SEARCH_PLACEHOLDER"] = SEARCH .. "..."
L["SLOT_BACK"] = INVTYPE_CLOAK or "后退"
L["SLOT_CHEST"] = INVTYPE_CHEST or "胸部"
L["SLOT_FEET"] = INVTYPE_FEET or "脚"
L["SLOT_HANDS"] = INVTYPE_HAND or "手"
L["SLOT_HEAD"] = INVTYPE_HEAD or "头"
L["SLOT_LEGS"] = INVTYPE_LEGS or "腿"
L["SLOT_MAINHAND"] = INVTYPE_WEAPONMAINHAND or "主手"
L["SLOT_OFFHAND"] = INVTYPE_WEAPONOFFHAND or "副手"
L["SLOT_SHIRT"] = INVTYPE_BODY or "衬衫"
L["SLOT_SHOULDER"] = INVTYPE_SHOULDER or "肩膀"
...
L["SOURCE_TYPE_DROP"] = BATTLE_PET_SOURCE_1 or "降低"
L["SOURCE_TYPE_IN_GAME_SHOP"] = BATTLE_PET_SOURCE_10 or "游戏内商店"
L["SOURCE_TYPE_PET_BATTLE"] = BATTLE_PET_SOURCE_5 or "宠物对战"
L["SOURCE_TYPE_PROFESSION"] = BATTLE_PET_SOURCE_4 or "职业"
L["SOURCE_TYPE_PROMOTION"] = BATTLE_PET_SOURCE_8 or "晋升"
L["SOURCE_TYPE_PVP"] = PVP or "玩家对战"
L["SOURCE_TYPE_QUEST"] = BATTLE_PET_SOURCE_2 or "寻求"
...
L["STAT_CRITICAL_STRIKE"] = STAT_CRITICAL_STRIKE or "致命一击"
...
L["STAT_VERSATILITY"] = STAT_VERSATILITY or "多功能性"
L["TAB_CHARACTERS"] = CHARACTER or "人物"
L["TAB_CURRENCY"] = CURRENCY or "货币"
L["TAB_ITEMS"] = ITEMS or "项目"
L["TAB_REPUTATION"] = REPUTATION or "名声"
L["TAB_STATISTICS"] = STATISTICS or "统计数据"
L["TYPE_MOUNT"] = MOUNT or "山"
...
L["VAULT_SLOT_RAIDS"] = RAIDS or "突袭"
...
L["CLICK_FOR_WOWHEAD_LINK"] = "点击查看哇头链接"
...
L["EVENT_GROUP_SOIREE"] = "萨尔瑟利尔晚会"
L["EVENT_GROUP_ABUNDANCE"] = "丰富"
L["EVENT_GROUP_HARANIR"] = "哈拉尼尔传说"
L["EVENT_GROUP_STORMARION"] = "风暴战士突击"
L["QUEST_CATEGORY_DESC_WEEKLY"] = "每周目标、狩猎、火花、世界首领、探索"
L["QUEST_CATEGORY_DESC_WORLD"] = "全区可重复的世界任务"
L["QUEST_CATEGORY_DESC_DAILY"] = "来自 NPC 的每日可重复任务"
...
CurseForge: Warband Nexus]=]
L["GEAR_STORAGE_SUBTITLE"] = "仅限可转让物品（BoE / Warbound）"
