...
L["LOOT_ALERTS"] = "战利品警报"
L["LOOT_ALERTS_TOOLTIP"] = "收藏品弹窗主开关。关闭后将隐藏所有收藏品通知。"
...
L["CHANGELOG_V211"] = "改进：\n" ..
    "- 专业：专注度追踪现在能正确识别每个专业。\n" ..
    "- 聊天：声望和货币通知现在遵循每个面板的聊天设置。\n" ..
    "- 聊天：非破坏性消息抑制保留您的聊天面板配置。\n" ..
    "- 数据完整性：标准化角色密钥规范化。\n" ..
    "- 计划：重复检测防止添加相同物品两次。\n" ..
    "- 货币：更严格的追踪过滤器防止未追踪角色出现。\n" ..
    "- 尝试计数器：扩展难度映射（普通、10人普通、25人普通、随机团队）。\n" ..
    "- 污染安全：Midnight 12.0 声望解析秘密值保护。\n" ..
    "\n" ..
    "错误修复：\n" ..
    "- 修复了专业之间专注度数据被覆盖的问题。\n" ..
    "- 修复了非默认聊天面板中缺少声望/货币通知的问题。\n" ..
    "- 修复了副本战斗中的污染错误（Midnight 12.0）。\n" ..
    "- 修复了处理程序为nil时事件队列崩溃的问题。\n" ..
...
L["SORT_MODE_ILVL"] = "装备等级（最高）"
L["SORT_MODE_GOLD"] = "金币（最多）"
