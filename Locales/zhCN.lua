...
L["VAULT_MAX_TIER"] = "最高阶段"
L["VAULT_AT_MAX"] = "已达最高阶段！"
...
L["CHANGELOG_V250"] = "新功能：\n- To-Do标签：计划部分重命名为To-Do，全新设计\n- 每周重置计时器：实时倒计时\n- 角色概览：任务和宝库进度汇总卡片\n- Wowhead链接：右键复制Wowhead链接\n- 制造装备改版：层级重铸信息替代误导性的X/6标记\n- 提醒系统：每日登录、每周重置和倒计时提醒\n\n装备标签：\n- 制造物品显示层级+物品等级（如'神话 285'）而非'神话 5/6'\n- 最大物品等级的制造物品不再显示错误的升级箭头\n- 提示框显示重铸费用、推荐层级和所需纹章\n\n专业知识：\n- 添加草药学和采矿每周采集任务追踪\n- 添加缺失的附魔每周任务变体\n- 验证所有论文、唯一物品、宝藏和采集ID\n\n性能：\n- 限制调整大小更新——窗口缩放不再掉帧\n- 装备标签框架池化——每次刷新减少约60个框架创建\n- 修复计划描述展开时的框架泄漏\n\n错误修复：\n- 修复提醒对话框保存时清除区域提醒的问题\n- 修复专业装备的taint保护漏洞\n- 修复层级名称解析错误\n- 修复最大物品等级从289修正为285\n\n感谢您的持续支持！\n如需报告问题，请在CurseForge - Warband Nexus上留言。"
...
L["STAT_CRITICAL_STRIKE"] = STAT_CRITICAL_STRIKE or "暴击"
