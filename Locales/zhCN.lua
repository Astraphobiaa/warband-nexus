...
L["CMD_UIMAP_HERE"] = "当前地图ID及父级链（非调试）"
...
L["REMINDER_CARD_CLICK_OPEN_SETTINGS"] = "点击号角打开提醒设置。"
...
L["SETTINGS_SECTION_REMINDER_TOAST"] = "待办提醒弹窗"
...
L["SETTINGS_NOTIF_POSITION_COMBAT"] = "战斗中无法设置通知预览位置。"
...
-- -----------------------------------------------------------------------------
L["SETTINGS_NOTIF_COORD_ANCHOR"] = "定位"
