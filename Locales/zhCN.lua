...
L["EA_TOOLTIP_BOUNTY_LABEL"] = "宝藏猎人赏金"
...
L["EA_TOOLTIP_GRID_SUB"] = "团队、地下城、世界栏与追踪器一致。按住Shift：距下一槽剩余次数。"
L["EA_TOOLTIP_SHIFT_HINT"] = "按住 Shift 查看宝库列剩余进度。"
L["EA_TOOLTIP_SECTION_VAULT"] = "伟大宝库"
...
L["EA_TOOLTIP_NO_CHAR_VAULT"] = "该角色尚无宝库数据。请打开一次伟大宝库。"
...
L["EA_TOOLTIP_STASH_HEADER_DESC"] = "该角色本周金色储藏领取情况。"
L["EA_TOOLTIP_STASH_LABEL"] = "金色储藏"
...
L["EA_TOOLTIP_STATUS_SLOTS_EARNED"] = "已获得 %d 个槽位 - 在伟大宝库领取"
...
L["EA_TOOLTIP_VOIDCORE_LABEL"] = "星云虚空核"
...
L["PLAN_GEO_ELLIPSIS"] = "…"
L["PLAN_GEO_INSTANCE_GATE"] = "副本门：#%s"
