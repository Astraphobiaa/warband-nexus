...
L["SETTINGS_SECTION_MODULES_LIST"] = "已启用的模块"
L["SETTINGS_SECTION_VAULT_GENERAL"] = "快捷方式"
L["SETTINGS_SECTION_VAULT_LOOK"] = "外观与透明度"
L["SETTINGS_SECTION_TAB_WARBAND"] = "战团银行"
L["SETTINGS_SECTION_TAB_PERSONAL_BANK"] = "个人银行"
L["SETTINGS_SECTION_TAB_INVENTORY"] = "背包"
L["SETTINGS_SECTION_NOTIF_TIMING"] = "计时"
L["SETTINGS_SECTION_NOTIF_POSITION"] = "位置"
L["DEBUG_MODE"] = "调试日志"
...
L["RECENT_TOOLTIP_OBTAINED_BY"] = "获得自："
L["RECENT_TOOLTIP_ACHIEVEMENT_EARNED_BY"] = "此成就由 %s 获得"
L["RECENT_TOOLTIP_EARNED_BY"] = "由 %s 获得"
L["POINTS_LABEL"] = "点数"
...
L["REP_API_UNAVAILABLE_DESC"] = "此服务器上 C_Reputation API 不可用。此功能需要 WoW 12.0.5（至暗之夜）。"
...
L["SETTINGS_SECTION_THEME_COLORS"] = "颜色与强调色"
L["SETTINGS_SECTION_THEME_TYPOGRAPHY"] = "字体与可读性"
L["COLOR_PURPLE"] = "紫色主题"
...
L["USE_CLASS_COLOR_ACCENT"] = "将职业颜色用作强调色"
L["USE_CLASS_COLOR_ACCENT_TOOLTIP"] = "将当前角色的职业颜色用于强调色、边框和选项卡。当无法识别职业时，将回退至已保存的主题颜色。"
-- Settings - Font
L["FONT_FAMILY"] = "字体"
...
L["GEAR_DAWNCREST_PLAYBOOK_TITLE"] = "曙光纹章升级指南"
L["GEAR_DAWNCREST_PLAYBOOK_SUMMARY"] = "每次升级消耗：%s个曙光纹章 + 金币。可通过地下堡、地下城、史诗钥石和团队副本获取——将鼠标悬停可查看各等级来源。"
L["GEAR_DAWNCREST_PLAYBOOK_TOOLTIP_LEAD"] = "在升级商人处，物品每提升一个等级需消耗%s个曙光纹章（外加金币）。"
L["GEAR_DAWNCREST_PLAYBOOK_CAP_HINT"] = "赛季上限和每周上限均适用—— 货币处会显示数量（按住Shift键可查看赛季进度）。"
L["GEAR_DAWNCREST_PLAYBOOK_BY_TIER"] = "按曙光纹章等级划分获取来源："
L["GEAR_DAWNCREST_PLAYBOOK_NO_SOURCES"] = "通过与此纹章等级对应的赛季PvE奖励获取。"
...
L["PATREON_TOOLTIP"] = "WarbandNexus的Patreon"
...
-- -----------------------------------------------------------------------------
-- Parity sync from enUS.lua (auto-appended) — 133 keys
-- -----------------------------------------------------------------------------
