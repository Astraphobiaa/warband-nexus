...
至暗之夜（Midnight）大型版本（已保存副本、尝试计数器、PvE/装备/计划、缓存架构）。各语言文件中已移除旧补丁的逐条说明；请用 `/wn changelog` 查看当前构建（v3.1.2）。
...
L["REMINDER_HOLIDAY_NEW_YEAR"] = "新年"  -- 春节？
L["REMINDER_HOLIDAY_PEON_DAY"] = "苦工节"  --- 第一次听说
