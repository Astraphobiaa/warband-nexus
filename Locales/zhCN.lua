...
L["GEAR_UPGRADEABLE_SLOTS"] = "个槽位可升级"
...
L["MODULE_TRY_COUNTER"] = "尝试计数"
L["MODULE_TRY_COUNTER_DESC"] = "自动追踪NPC击杀、首领、钓鱼和容器掉落尝试次数。禁用将停止所有尝试计数处理、工具提示和通知。"
...
L["CHANGELOG_V242"] = "新功能：\n- 公会与休息经验追踪：\n  • 跨角色追踪公会成员与休息经验\n- 金钱日志与黄金自动化 - 物品界面：\n  • 每角色黄金日志、存取款历史\n  • 物品标签页中的黄金目标自动化\n- 新标签页：装备：\n  • 带物品等级追踪的已装备查看\n  • 升级机会与存储推荐（装绑/战团绑定）\n  • 跨角色升级候选\n- 新标签页：收藏：\n  • 坐骑、宠物、玩具、幻化等概览\n  • 追踪收藏进度与查找缺失物品\n\n改进：\n- 午夜 PvE 更新：\n  • 完整兼容 Midnight 12.0.x API\n  • 首领/难度处理，issecretvalue 保护\n- 午夜声望更新：声望缓存与 API 更新\n- 午夜货币更新：货币缓存与元数据\n- 专业改进：配方助手增强、专业窗口处理\n- 计划修订：来源显示修正（如 Nether-Warped Drake）、Mythic 颜色一致性\n- 设置修订：设置 UI 更新与模块管理\n- 配方助手更新：材料来源与品质层级改进\n- 性能改进：帧预算、批大小、异步优化\n- 通知与尝试计数稳定性：issecretvalue 保护、去重修正\n- 午夜杂项：API 兼容性，仅调试模式输出\n- 本地化：Changelog 与 What's New 翻译至 11 种语言，欢迎界面标签描述更新\n\n感谢支持！CurseForge - Warband Nexus。"
L["CHANGELOG_V243"] = "新功能：\n- 公会与休息经验追踪：跨角色追踪公会成员与休息经验\n- 金钱日志与黄金自动化 - 物品界面：每角色黄金日志、存取款历史\n- 新标签页：装备：已装备、升级选项、存储推荐、跨角色升级候选\n- 新标签页：收藏：坐骑、宠物、玩具、幻化概览与收藏进度\n\n改进：\n- 午夜 PvE/声望/货币更新\n- 专业与配方助手、计划、设置、性能、通知\n- 11种语言本地化\n\n感谢支持！CurseForge - Warband Nexus。"
