...
L["ITEMS_LOADING_STAGE_WAIT"] = "等待启动"
L["ITEMS_LOADING_STAGE_INIT"] = "正在初始化物品缓存"
L["ITEMS_LOADING_STAGE_RESTORE"] = "正在读取已保存的背包信息"
...
L["NOTIF_UNIFIED_TOAST_LAYOUT"] = "单一堆叠弹窗（所有弹窗类型共享一个窗口）"
L["NOTIF_PER_LANE_HINT"] = "独立位置：选择一个弹窗，拖拽预览，右键点击可设置精确的X/Y坐标。再次点击弹窗按钮以保存。"
L["NOTIF_POS_BTN_ACH"] = "成就。"
L["NOTIF_POS_BTN_CRITERIA"] = "进度"
L["NOTIF_POS_BTN_TRY"] = "尝试次数"
L["NOTIF_POS_BTN_REMINDER"] = "待办提醒"
L["NOTIF_DRAG_LANE_GHOST_MSG"] = "拖拽预览，然后右键点击设置坐标。再次点击共同窗口按钮以保存。"
L["NOTIF_USE_PER_LANE_BUTTONS"] = "使用下方的分类按钮来定位每种弹窗，或重新开启统一堆叠。"
...
L["PROFESSIONS_LAYOUT_HINT"] = "提示：使用“分栏”来显示每周任务、论述、宝藏及其他进度。"
...
L["CONFIG_MAIN_NAV_LAYOUT_DESC"] = "选择主标签页显示在顶部或左侧图标栏；需重载界面(/reload)后生效。"
L["CONFIG_MAIN_NAV_LAYOUT_TOP"] = "横向标签（顶部栏）"
L["CONFIG_MAIN_NAV_LAYOUT_RAIL"] = "左侧图标栏"
L["CONFIG_MAIN_NAV_LAYOUT_RELOAD_NOTICE"] = "导航布局需重载界面(/reload)后生效。"
...
L["CUSTOM_HEADER_NEW"] = "新建自定义标题"
L["CUSTOM_HEADER_DELETE_PICK"] = "删除自定义标题…"
...
L["FAVORITE_EDIT_ON_CHARACTER_TAB"] = "在角色标签页中更改收藏。"
L["CUSTOM_HEADER_REMOVE_ASSIGN"] = "从自定义标题中移除"
L["CUSTOM_HEADER_NEW_DIALOG_TITLE"] = "新建自定义标题"
L["CUSTOM_HEADER_NEW_DIALOG_HINT"] = "输入一个名称。你可以使用每行上的文件夹按钮，将已追踪的非收藏角色移入此处。"

L["CUSTOM_HEADER_NEW_DIALOG_LABEL"] = "分类名称"
L["CUSTOM_HEADER_NEW_DIALOG_CREATE"] = "创建分类"
L["CUSTOM_HEADER_ROSTER_WINDOW_HINT"] = "第一个列表：勾选框初始为选中状态（仍在此分类中）。取消勾选可将角色加入移除队列。第二个列表：勾选将角色加入添加队列。点击“添加选中项”后才会保存更改。"
L["CUSTOM_HEADER_ROSTER_CLOSE"] = "关闭"
L["CUSTOM_HEADER_PICKER_FILTER_LABEL"] = "搜索"
L["CUSTOM_HEADER_PICKER_EMPTY"] = "没有匹配的角色。"
L["CUSTOM_HEADER_ADD_SELECTED"] = "添加选中项"
L["CUSTOM_HEADER_REMOVE_LINK"] = "移除"
L["CUSTOM_HEADER_DELETE_DIALOG_TITLE"] = "删除自定义标题？"
L["CUSTOM_HEADER_DELETE_DIALOG_BODY"] = "移除标题 |cffffcc00%s|r 并取消其角色的分组？"
...
L["GEAR_STORAGE_TABLE_HDR_SLOT"] = "部位"
...
L["CONFIG_PLAN_REMINDER_TOAST_DESC"] = "当计划提醒触发时显示紧凑弹窗（每日登录、每月登录、每周重置、进入区域或副本等）。计划列表仍会显示号角标记。"
L["CURRENCY_COLLAPSE_ALL_TOOLTIP"] = "折叠列表中的所有货币分类标题。"
L["CURRENCY_EXPAND_ALL_TOOLTIP"] = "展开列表中的所有货币分类标题。"
L["DEBUG_RELOAD_UI_BTN"] = "重载界面"
L["DEBUG_RELOAD_UI_TOOLTIP"] = "重载整个界面（/reload）。魔兽世界无法热重载插件Lua文件；保存文件后请使用此功能。"
...
L["PLAN_GEO_BUCKET_WEEKLY_ACTIVITY"] = "每周任务和活动"
...
L["REMINDER_CARD_CLICK_CONFIGURE"] = "点击配置提醒。"
L["REMINDER_CARD_CLICK_OPEN_SETTINGS"] = "点击号角图标打开提醒设置。"
L["REMINDER_COLLECTIBLE_ZONE_HINT"] = "收藏品很少在API中暴露单个“必选区域”；请添加地图ID、捕获副本或匹配存储/来源文本中的区域名称。"
L["REMINDER_DRAG_TOAST_DRAG_MSG"] = "拖拽预览，然后右键点击保存并关闭。"
L["REMINDER_FOCUS_LOCATION"] = "仅限此计划的区域/副本提醒"
L["REMINDER_INSTANCE_CAPTURE"] = "捕获当前副本"
L["REMINDER_INSTANCE_CAPTURED_FMT"] = "副本ID %s，难度 %s（nil = 任意）"
L["REMINDER_INSTANCE_ENTER"] = "已进入副本（%s）"
L["REMINDER_INSTANCE_GENERIC"] = "地下城或团队副本"
L["REMINDER_INSTANCE_NONE"] = "未捕获副本。"
L["REMINDER_INSTANCE_NOT_INSIDE"] = "请先进入一个地下城或团队副本，然后再捕获。"
L["REMINDER_MONTHLY_LOGIN"] = "每月登录"
L["REMINDER_OPT_INSTANCE"] = "进入此副本时提醒"
L["REMINDER_OPT_MONTHLY"] = "每个月首次登录时提醒"
L["REMINDER_OPT_ZONE_ENTER_MATCHING"] = "进入匹配区域时提醒我"
L["REMINDER_OPT_ZONE_HINTS"] = "匹配计划标题/来源文本中的区域名称"
L["REMINDER_SHORT_BEFORE_RESET"] = "重置前%dd"
L["REMINDER_SHORT_DAILY"] = "每日登录"
L["REMINDER_SHORT_FOCUS"] = "焦点位置"
L["REMINDER_SHORT_INSTANCE"] = "副本"
L["REMINDER_SHORT_MONTHLY"] = "每月登录"
L["REMINDER_SHORT_WEEKLY"] = "每周重置"
L["REMINDER_SHORT_ZONE"] = "进入区域"
L["REMINDER_TOAST_MATCH_CRITERIA"] = "与进度弹窗使用相同定位"
L["REMINDER_TOAST_TITLE"] = "待办提醒"
L["REMINDER_TOAST_USES_CRITERIA_LANE"] = "使用进度弹窗（进度 X/Y 弹窗）"
L["REMINDER_TOY_ZONE_HINT"] = "玩具在日志中通常缺少丰富的来源信息——请使用手动添加地图ID或捕获副本。"
L["REMINDER_ZONE_ADD"] = "添加"
L["REMINDER_ZONE_CATALOG_ADD"] = "添加"
L["REMINDER_ZONE_CATALOG_AREAS"] = "微型地区"
L["REMINDER_ZONE_CATALOG_DELVES"] = "地下堡"
L["REMINDER_ZONE_CATALOG_DUNGEONS"] = "地下城"
L["REMINDER_ZONE_CATALOG_EXPANSIONS_LABEL"] = "内容更新"
L["REMINDER_ZONE_CATALOG_HINT_SHORT"] = "左侧选择内容更新，右侧添加区域，完成后保存。"
...
L["REMINDER_ZONE_CAT_BC"] = "燃烧的远征"  -- EXPANSION_NAME1
L["REMINDER_ZONE_CAT_BFA"] = "争霸艾泽拉斯"  -- EXPANSION_NAME7
L["REMINDER_ZONE_CAT_CATA"] = "大地的裂变"  -- EXPANSION_NAME3
L["REMINDER_ZONE_CAT_DRAGONFLIGHT"] = "巨龙时代"  -- EXPANSION_NAME9
L["REMINDER_ZONE_CAT_EASTERN_KINGDOMS"] = "东部王国"
L["REMINDER_ZONE_CAT_KALIMDOR"] = "卡利姆多"
L["REMINDER_ZONE_CAT_LEGION"] = "军团再临"  -- EXPANSION_NAME6
L["REMINDER_ZONE_CAT_MIDNIGHT"] = "至暗之夜"  -- EXPANSION_NAME11
L["REMINDER_ZONE_CAT_MOP"] = "熊猫人之谜"  -- EXPANSION_NAME4
L["REMINDER_ZONE_CAT_SHADOWLANDS"] = "暗影国度"  -- EXPANSION_NAME8
L["REMINDER_ZONE_CAT_TAG_INSTANCE"] = "[副本]"
L["REMINDER_ZONE_CAT_TAG_RELATED"] = "[+]"
L["REMINDER_ZONE_CAT_TAG_ZONE"] = "[区域]"
L["REMINDER_ZONE_CAT_TWW"] = "地心之战"  -- EXPANSION_NAME10
L["REMINDER_ZONE_CAT_WOD"] = "德拉诺之王"  -- EXPANSION_NAME5
L["REMINDER_ZONE_CAT_WRATH"] = "巫妖王之怒"  -- EXPANSION_NAME2
