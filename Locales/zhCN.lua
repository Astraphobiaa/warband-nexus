--[[
    Warband Nexus - Chinese (Simplified)
]]
...
ns.LOCALES.zhCN = ns.LOCALES.zhCN or {}
local L = ns.LOCALES.zhCN
...
L["SETTINGS_COMPACT_MAIN_WINDOW_LABEL"] = "紧凑主窗口"
L["SETTINGS_COMPACT_MAIN_WINDOW_HINT"] = "更紧的最小尺寸与适中的默认大小。仍可横向滚动查看较宽标签页。"
L["COLLECTIONS_EXPAND_ALL_TOOLTIP"] = "展开所有来源分类区块。"
L["COLLECTIONS_COLLAPSE_ALL_TOOLTIP"] = "折叠所有来源分类区块。"
L["PLANS_EXPAND_ALL_TOOLTIP"] = "展开所有待办区块和分组。"
L["PLANS_COLLAPSE_ALL_TOOLTIP"] = "折叠所有待办区块和分组。"
L["PVE_EXPAND_ALL_TOOLTIP"] = "展开所有 PvE 区块和角色行。"
L["PVE_COLLAPSE_ALL_TOOLTIP"] = "折叠所有 PvE 区块和角色行。"
...
L["SETTINGS_SECTION_VAULT_LOOK"] = "外观与不透明度"
L["SETTINGS_SECTION_TAB_WARBAND"] = "战团银行"
L["SETTINGS_SECTION_TAB_PERSONAL_BANK"] = "个人银行"
L["SETTINGS_SECTION_TAB_INVENTORY"] = "背包"
L["SETTINGS_SECTION_NOTIF_TIMING"] = "时间"
L["SETTINGS_SECTION_NOTIF_POSITION"] = "位置"
L["SETTINGS_NOTIF_POSITION_COMBAT"] = "战斗中无法调整通知预览位置。"
L["SETTINGS_NOTIF_COORD_TITLE"] = "通知位置（像素）"
L["SETTINGS_NOTIF_COORD_ANCHOR"] = "锚点"
L["SETTINGS_NOTIF_COORD_X"] = "X 偏移"
L["SETTINGS_NOTIF_COORD_Y"] = "Y 偏移"
L["SETTINGS_NOTIF_COORD_APPLY"] = APPLY or "应用"
L["NOTIF_ANCHOR_PROGRESS_LANE_LABEL"] = "进度和待办"
L["SETTINGS_SECTION_REMINDER_TOAST"] = "待办提醒提示"
L["REMINDER_TOAST_MATCH_CRITERIA"] = "与进度弹窗相同的锚点"
L["REMINDER_TOAST_USES_CRITERIA_LANE"] = "使用进度通道（X/Y 进度弹窗）"
L["SET_REMINDER_TOAST_POSITION"] = "设置提醒弹窗位置"
L["NOTIFICATION_GHOST_REMINDER_TOAST"] = "待办提醒弹窗"
L["REMINDER_DRAG_TOAST_DRAG_MSG"] = "拖动预览，然后右键保存并关闭。"
L["PLAN_GEO_BUCKET_WEEKLY_VAULT"] = "每周宝库（团队/地下城/世界）"
L["PLAN_GEO_BUCKET_WEEKLY_ACTIVITY"] = "每周任务与活动"
L["PLAN_GEO_BUCKET_ACHIEVEMENT"] = "成就"
L["PLAN_GEO_BUCKET_COLLECTION"] = "收藏"
L["PLAN_GEO_BUCKET_PROFESSION"] = "专业"
L["PLAN_GEO_BUCKET_CUSTOM"] = "自定义"
L["PLAN_GEO_INSTANCE_GATE"] = "副本入口：#%s"
L["PLAN_GEO_ELLIPSIS"] = "…"
L["DEBUG_MODE"] = "调试日志"
...
L["STORAGE_COLLAPSE_ALL_TOOLTIP"] = "折叠所有存储分类和嵌套类别。"
...
L["SHOW_PLANNED_DISABLED_HERE"] = "不筛选待办清单和每周进度。切换状态会保存你对坐骑、宠物、玩具及其他浏览标签页的偏好。"
...
L["ACHIEVEMENT_FRAME_WN_TOOLTIP_TRACKED"] = "已在追踪（目标追踪）。"
...
L["TOOLTIP_ONLINE_CHARACTER"] = "当前角色"
...
L["TRY_COUNT_CLICK_HINT"] = "左键点击设置该掉落物的尝试次数。"
L["TRIES"] = "次"
...
L["ACHIEVEMENT_POINTS_ACCOUNT"] = "账号"
L["ACHIEVEMENT_POINTS_CHARACTER"] = "角色"
L["STATS_ACH_COL_SCORE"] = "分数"
L["STATS_ACH_METRIC_COUNT"] = "数量"
L["STATS_ACH_METRIC_SCORE"] = "分数"
L["STATS_ACH_CARD_SCORE"] = "成就分数"
L["STATS_ACH_CARD_CHARACTER"] = "角色成就"
L["STATS_ACH_COL_CURRENT_TOTAL"] = "当前 / 总数"
L["STATS_ACH_COL_CHARACTER_WARBAND"] = "角色 / 战团"
L["STATS_ACHIEVEMENTS_PROGRESS"] = "%s / %s 已完成 (剩余 %s)"
L["STATS_TODO_TITLE"] = "待办"
L["STATS_TODO_PROGRESS"] = "%s / %s 已完成 (剩余 %s)"
...
L["WEEKLY_VAULT"] = "每周宝库"
L["CUSTOM"] = "自定义"
L["NO_PLANS_IN_CATEGORY"] = "此分类暂无待办。\n从待办标签页添加目标。"
L["SOURCE_LABEL"] = "来源："
L["ZONE_LABEL"] = "区域："
L["VENDOR_LABEL"] = "商人："
L["DROP_LABEL"] = "掉落："
...
L["CHARACTERS_EXPAND_ALL"] = "全部展开"
L["CHARACTERS_EXPAND_ALL_TOOLTIP"] = "展开收藏、角色和未追踪分类。"
L["CHARACTERS_COLLAPSE_ALL"] = "全部折叠"
L["CHARACTERS_COLLAPSE_ALL_TOOLTIP"] = "折叠收藏、角色和未追踪分类。"
L["CHARACTERS_SECTION_TOGGLE_EXPAND_TOOLTIP"] = "展开收藏、角色和未追踪分类。"
L["CHARACTERS_SECTION_TOGGLE_COLLAPSE_TOOLTIP"] = "折叠收藏、角色和未追踪分类。"
...
L["CUSTOM_HEADER_ASSIGN_TOOLTIP_TITLE"] = "自定义标题"
L["CUSTOM_HEADER_ASSIGN_TOOLTIP_DESC"] = "将此角色移动到你创建的一个标题中（筛选 → 新建自定义标题）。"
L["FAVORITE_EDIT_ON_CHARACTER_TAB"] = "在角色标签页更改收藏。"
L["CUSTOM_HEADER_EMPTY"] = "此标题下没有角色。请使用角色行上的文件夹按钮。"
L["CUSTOM_HEADER_NEW"] = "新建自定义分区"
L["CUSTOM_HEADER_DELETE_PICK"] = "删除自定义分区..."
L["CUSTOM_HEADER_REMOVE_ASSIGN"] = "从自定义分区移除"
L["CUSTOM_HEADER_NEW_DIALOG_TITLE"] = "新建自定义分区"
L["CUSTOM_HEADER_NEW_DIALOG_HINT"] = "名称（最多32字符）。可搜索并勾选。在名称框按回车保存。"
L["CUSTOM_HEADER_ROSTER_WINDOW_HINT"] = "第一列表：默认已勾选（仍在此分区）。取消勾选以排队移除。第二列表：勾选以排队添加。点击添加所选后才会保存。"
L["CUSTOM_HEADER_ROSTER_CLOSE"] = CLOSE or "关闭"
L["CUSTOM_HEADER_NEW_DIALOG_LABEL"] = "分区名称"
L["CUSTOM_HEADER_NEW_DIALOG_CREATE"] = "创建分区"
L["CUSTOM_HEADER_DELETE_DIALOG_TITLE"] = "删除自定义分区？"
L["CUSTOM_HEADER_DELETE_DIALOG_BODY"] = "移除分区 |cffffcc00%s|r 并取消其角色的分组？"
L["CUSTOM_HEADER_MENU_SECTION_HEADERS"] = "自定义标题"
L["CUSTOM_HEADER_MENU_NEW"] = "新建自定义分组..."
L["CUSTOM_HEADER_MENU_NONE_YET"] = "尚无分组，请使用新建自定义分组。"
L["CUSTOM_HEADER_MENU_RENAME_GROUP"] = "重命名分类"
L["CUSTOM_HEADER_MENU_RENAME_FMT"] = "重命名：%s"
L["CUSTOM_HEADER_RENAME_DIALOG_TITLE"] = "重命名分类"
L["CUSTOM_HEADER_MOVE_UP"] = "上移分类"
L["CUSTOM_HEADER_MOVE_DOWN"] = "下移分类"
L["CHARACTER_MENU_STOP_TRACKING"] = "停止追踪"
L["CHARACTER_MENU_START_TRACKING"] = "开始追踪"
L["CHARACTER_MENU_DELETE"] = "删除角色"
L["CONFIG_SECTION_GOLD_TOTAL"] = "分类金币总计"
L["CONFIG_SECTION_GOLD_TOTAL_DESC"] = "在角色标签页的每个分类标题上显示该分类的金币总和。使用每个角色最后一次记录的金额，因此安装后尚未登录过的角色不会计入。"
...
L["CUSTOM_HEADER_MENU_NO_CANDIDATES"] = "没有可添加的角色。"
L["CUSTOM_HEADER_MENU_ADD_FMT"] = "添加：%s"
L["CUSTOM_HEADER_ROW_ADD_TOOLTIP"] = "编辑此分组"
L["CUSTOM_HEADER_ROW_ADD_TOOLTIP_BODY"] = "搜索并勾选角色后点击添加所选。在名单窗口勾选第一列可从本分组移除。每名角色最多属于一个自定义分组。"
L["CUSTOM_HEADER_PICKER_FILTER_LABEL"] = "搜索"
L["CUSTOM_HEADER_PICKER_EMPTY"] = "没有匹配的角色。"
L["CUSTOM_HEADER_ADD_SELECTED"] = "添加所选"
L["CUSTOM_HEADER_COL_CHARACTER"] = "角色"
L["CUSTOM_HEADER_COL_LEVEL"] = "等级"
L["CUSTOM_HEADER_COL_REALM"] = "服务器"
L["CUSTOM_HEADER_COL_SECTION"] = "分组"
L["CUSTOM_HEADER_SECTION_NONE"] = NONE or "无"
L["CUSTOM_HEADER_LOCK_TOOLTIP_TITLE"] = "锁定分组"
L["CUSTOM_HEADER_LOCK_TOOLTIP_DESC"] = "锁定此分组，防止其中的角色被意外移动至其他分组。"
L["CUSTOM_HEADER_UNLOCK_TOOLTIP_TITLE"] = "解锁分组"
L["CUSTOM_HEADER_UNLOCK_TOOLTIP_DESC"] = "此分组已锁定以防误动角色。点击即可解锁。"
L["CUSTOM_HEADER_ROW_LOCKED_TITLE"] = "分组已锁定"
L["CUSTOM_HEADER_ROW_LOCKED_TOOLTIP"] = "角色已锁定在分组“%s”中。如需移动，请先解锁该分组。"
L["CUSTOM_HEADER_ROW_WILL_MOVE"] = "将从“%s”移动"
L["CUSTOM_HEADER_SECTION_LOCKED_REMOVE_TOOLTIP"] = "此分组已锁定。请先解锁分组再移除成员。"
L["CUSTOM_HEADER_LOCKED_SHORT"] = "已锁定"
L["CUSTOM_HEADER_LOCK_CHAR"] = "将角色锁定在当前分组"
L["CUSTOM_HEADER_UNLOCK_CHAR"] = "解锁此角色"
L["REAGENT_DEPOSIT_BTN"] = "材料"
L["REAGENT_DEPOSIT_TITLE"] = "材料存入管理"
L["REAGENT_DEPOSIT_ENABLE"] = "启用材料存入管理"
L["REAGENT_DEPOSIT_AUTO_OPEN"] = "打开银行时自动存入"
L["REAGENT_DEPOSIT_AUTO_OPEN_DESC"] = "每次打开银行窗口时，自动将符合条件的物品存入银行。"
L["REAGENT_DEPOSIT_IGNORE_FOOD"] = "忽略食物与饮料（包含战团绑定）"
L["REAGENT_DEPOSIT_IGNORE_FOOD_DESC"] = "绝不自动将食物、饮料、大餐或丰盛餐点存入银行，保护您的团队副本与地下城消耗品。"
L["REAGENT_DEPOSIT_CHAR_ONLY"] = "仅限此角色 (%s)"
L["REAGENT_DEPOSIT_DESTINATION"] = "存入目标"
L["REAGENT_DEPOSIT_DEST_WARBAND"] = "战团银行（战网账号）"
L["REAGENT_DEPOSIT_DEST_REAGENT"] = "个人材料银行"
L["REAGENT_DEPOSIT_DEST_WARBAND_DESC"] = "将匹配的材料和代币存入战团银行，整个战网账号共享。"
L["REAGENT_DEPOSIT_DEST_WARBAND_NOTE"] = "注意：根据暴雪游戏规则，灵魂绑定（Soulbound）物品无法存入战团银行。"
L["REAGENT_DEPOSIT_DEST_REAGENT_DESC"] = "将匹配的专业材料存入该角色的个人材料银行栏。"
L["REAGENT_DEPOSIT_DEST_REAGENT_NOTE"] = "注意：仅支持标准制造专业材料。盟约或小游戏内容物品不被接受。"
L["REAGENT_DEPOSIT_CATEGORIES"] = "存入分类"
L["REAGENT_DEPOSIT_SELECT_ALL"] = "全选"
L["REAGENT_DEPOSIT_CLEAR_ALL"] = "全不选"
L["REAGENT_DEPOSIT_NOW"] = "立即存入物品"
L["REAGENT_DEPOSIT_SENT"] = "正在存入..."
L["REAGENT_DEPOSIT_BANK_CLOSED_TIP"] = "请打开银行或战团银行以立即存入物品。"
L["REAGENT_CAT_HERBS"] = "草药"
L["REAGENT_CAT_MINING"] = "矿石与石头"
L["REAGENT_CAT_LEATHER"] = "皮革与生皮"
L["REAGENT_CAT_CLOTH"] = "布料"
L["REAGENT_CAT_ENCHANTING"] = "附魔"
L["REAGENT_CAT_INSCRIPTION"] = "铭文"
L["REAGENT_CAT_COOKING"] = "烹饪"
L["REAGENT_CAT_GEMS"] = "宝石"
L["REAGENT_CAT_PARTS"] = "工程学零件"
L["REAGENT_CAT_ELEMENTAL"] = "元素"
L["REAGENT_CAT_GENERAL"] = "通用材料"
L["REAGENT_CAT_TOKENS"] = "代币物品（荣耀印记等）"
L["REAGENT_CAT_WARBOUND"] = "战团绑定装备 (WuE)"
...
L["GUILD_BANK_SCAN_COMPLETE"] = "公会银行已扫描：%d 件物品。WN 搜索提示已更新。"
L["EMPTY_STORAGE_TITLE"] = "暂无存储数据"
L["EMPTY_STORAGE_DESC"] = "打开银行或背包时会扫描物品。\n访问银行即可开始追踪存储。"
L["EMPTY_PLANS_TITLE"] = "暂无计划"
L["EMPTY_PLANS_DESC"] = "在上方浏览坐骑、宠物、玩具或成就\n以添加收集目标并追踪进度。"
L["EMPTY_PLANS_ACTIVE_TITLE"] = "暂无待办项"
L["EMPTY_PLANS_ACTIVE_DESC"] = "在上方浏览坐骑、宠物、玩具或成就，\n或使用添加宝库追踪宏伟宝库进度。"
L["EMPTY_PLANS_WEEKLY_TITLE"] = "暂无每周进度"
L["EMPTY_PLANS_WEEKLY_DESC"] = "使用上方的添加任务按钮，\n开始追踪角色的每周任务进度。"
L["EMPTY_PLANS_MOUNT_TITLE"] = "暂无坐骑"
L["EMPTY_PLANS_MOUNT_DESC"] = "从此标签页将坐骑加入待办，或调整显示计划 / 显示已完成。"
L["EMPTY_PLANS_PET_TITLE"] = "暂无宠物"
L["EMPTY_PLANS_PET_DESC"] = "从此标签页将宠物加入待办，或调整显示计划 / 显示已完成。"
L["EMPTY_PLANS_TOY_TITLE"] = "暂无玩具"
L["EMPTY_PLANS_TOY_DESC"] = "从此标签页将玩具加入待办，或调整显示计划 / 显示已完成。"
L["EMPTY_PLANS_ILLUSION_TITLE"] = "暂无幻化"
L["EMPTY_PLANS_ILLUSION_DESC"] = "从此标签页将幻化加入待办，或调整显示计划 / 显示已完成。"
L["EMPTY_PLANS_TITLE_TAB_TITLE"] = "暂无头衔"
L["EMPTY_PLANS_TITLE_TAB_DESC"] = "从此标签页将头衔加入待办，或调整显示计划 / 显示已完成。"
...
L["EMPTY_COLLECTIONS_MOUNTS_TITLE"] = "暂无坐骑"
L["EMPTY_COLLECTIONS_MOUNTS_DESC"] = "调整搜索或筛选，或等待坐骑列表加载。\n若列表仍为空，请尝试 /reload。"
L["EMPTY_COLLECTIONS_PETS_TITLE"] = "暂无宠物"
L["EMPTY_COLLECTIONS_PETS_DESC"] = "调整搜索或筛选，或等待宠物列表加载。\n若列表仍为空，请尝试 /reload。"
L["EMPTY_COLLECTIONS_TOYS_TITLE"] = "暂无玩具"
...
L["MAIL_DETAILS_TOTAL_GOLD"] = "总计: %s"
...
L["ITEMS_EXPAND_ALL_TOOLTIP"] = "展开当前银行子标签的所有物品类型分组（个人、战团、公会或背包）。"
L["ITEMS_COLLAPSE_ALL_TOOLTIP"] = "折叠当前银行子标签的所有物品类型分组。"
L["ITEMS_DISABLED_TITLE"] = "战团银行物品"
L["ITEMS_LOADING"] = "正在加载背包数据"
L["ITEMS_LOADING_STAGE_WAIT"] = "等待开始"
L["ITEMS_LOADING_STAGE_INIT"] = "正在初始化物品缓存"
L["ITEMS_LOADING_STAGE_RESTORE"] = "正在读取已保存库存"
L["ITEMS_LOADING_STAGE_DEFER"] = "正在准备背包扫描"
L["ITEMS_LOADING_STAGE_SCAN"] = "正在扫描背包"
L["ITEMS_WARBAND_LOADING_TITLE"] = "正在加载战团银行"
L["ITEMS_WARBAND_LOADING_PREP"] = "正在准备界面布局"
L["ITEMS_WARBAND_LOADING_DRAW"] = "正在构建个人物品与战团银行"
...
L["PVE_HEADER_NIGHTMARE_SHORT"] = "噩梦"
L["PVE_HEADER_VAULTS_SHORT"] = "宝库"
L["PVE_COL_VAULT_STATUS"] = "宝库状态"
L["PVE_COL_NEBULOUS_VOIDCORE"] = "星云虚空核"
...
L["PVE_COMPACT_MANAFLUX"] = "法力熔剂"
L["PVE_CURRENCY_VIEW_CURRENT"] = "当前"
L["PVE_CURRENCY_VIEW_WEEKLY"] = "每周"
L["PVE_CURRENCY_VIEW_SHIFT_HINT"] = "按住 Shift 可临时切换另一种显示。"
L["PVE_CURRENCY_VIEW_TOGGLE_HINT"] = "点击可在当前显示与周进度显示之间切换。"
...
L["PVE_VAULT_SLOT_REMAINING_FORMAT"] = "栏位 %d：还需 |cffffcc00%d|r"
...
L["REP_EXPAND_ALL_TOOLTIP"] = "展开所有声望分类和内容更新标题。"
L["REP_COLLAPSE_ALL_TOOLTIP"] = "折叠所有声望分类和内容更新标题。"
...
L["CURRENCY_EXPAND_ALL_TOOLTIP"] = "展开列表中的所有货币分类标题。"
L["CURRENCY_COLLAPSE_ALL_TOOLTIP"] = "折叠列表中的所有货币分类标题。"
...
L["CURRENCY_TOOLTIP_MORE_CHARACTERS"] = "还有 %d 个角色"
...
L["DAILY_PLAN_EXISTS_DESC"] = "%s 已有活跃的每周任务计划。可在「每周进度」分类中找到。"
L["WEEKLY_VAULT_CARD"] = "宏伟宝库"
L["WEEKLY_VAULT_COMPLETE"] = "宏伟宝库 - 完成"
L["UNKNOWN_SOURCE"] = "未知来源"
L["DAILY_TASKS_PREFIX"] = "每日任务追踪 - "
L["QUEST_CATEGORY_DESC_ASSIGNMENTS"] = "特殊任务与每周任务进度"
...
L["LANGUAGE_SELECT_LABEL"] = "语言"
L["LANGUAGE_SELECT_DESC"] = "选择插件界面语言。自动将跟随你的 WoW 游戏客户端。部分游戏术语将保持客户端语言。"
L["LANGUAGE_TR_FONT_HINT"] = "如果土耳其语字符显示不正常，可以尝试 Exo、Arial 等其他字体。"
L["LANGUAGE_AUTO"] = "自动（游戏客户端）"
L["LANGUAGE_RELOAD_NOTICE"] = "语言更改将在重载界面后生效。"
...
L["USE_ALERTFRAME_POSITION"] = "使用信息通知位置"
L["USE_ALERTFRAME_POSITION_ACTIVE"] = "正在使用暴雪信息通知位置"
L["NOTIFICATION_GHOST_MAIN"] = "成就 / 通知"
L["NOTIFICATION_GHOST_CRITERIA"] = "标准 / 待办通道"
...
L["PVP_DESC"] = "比较战团中所有角色的评级赛制：2v2、3v3、单人乱斗、闪电战和评级战场的评分，含每周与赛季胜场记录。追踪荣誉等级、荣誉与征服点上限、带评分变化的近期对战记录以及当前的乱斗。"
...
L["STATISTICS_SUBTITLE"] = "收藏进度、金币和账号动态"
...
L["COLLECTIONS_TT_TODO_TITLE"] = "待办列表"
L["COLLECTIONS_TT_TODO_ADD"] = "左键点击将此条目加入待办列表。"
L["COLLECTIONS_TT_TODO_REMOVE"] = "左键点击将此条目从待办列表移除。"
L["COLLECTIONS_TT_TRACK_TITLE"] = "目标追踪"
L["COLLECTIONS_TT_TRACK_ENABLE"] = "左键点击在暴雪目标中显示进度（最多同时 10 个）。"
L["COLLECTIONS_TT_TRACK_DISABLE"] = "左键点击停止在暴雪目标中追踪。"
L["COLLECTIONS_TT_TRACK_COMPLETED"] = "该成就已完成，无法追踪。"
L["COLLECTIONS_DETAIL_TT_ON_TODO"] = "左键点击从待办列表移除。"
L["COLLECTIONS_DETAIL_TT_ADD_TODO"] = "左键点击加入待办列表。"
...
L["MAIL_REMINDER"] = "邮件过期提醒"
L["MAIL_REMINDER_TOOLTIP"] = "当任意受追踪角色的邮件将在一周内过期时，登录时显示提醒。角色标签页的信封图标在最后一周变为橙色，最后一天变为红色。"
L["MAIL_REMINDER_TITLE"] = "邮件即将过期！"
L["MAIL_REMINDER_ACTION"] = "你有 %d 封邮件即将过期，最快的还有 %s"
L["MAIL_REMINDER_ACTION_SIMPLE"] = "你有 %d 封邮件即将过期"
L["VAULT_REMINDER_TOOLTIP"] = "当你有未领取的宏伟宝库奖励时，登录时显示提醒弹窗"
L["CONFIG_PLAN_REMINDER_TOAST"] = "待办提醒弹窗"
L["CONFIG_PLAN_REMINDER_TOAST_DESC"] = "待办提醒触发时显示简短提示（每日登录、每月登录、每周重置、进入区域或副本等）。待办卡片仍显示号角标记。"
...
L["REPUTATION_GAINS"] = "聊天中显示声望获取"
L["REPUTATION_GAINS_TOOLTIP"] = "仅在游戏于聊天中报告的声望变化时显示 [WN-Reputation] 行（另含名望升级与地下堡伙伴经验战利品）。不会在扫描期间广播每个发生变化的阵营。"
L["CURRENCY_GAINS"] = "显示货币获取"
L["CURRENCY_GAINS_TOOLTIP"] = "获得货币时在聊天中显示货币获取消息"
L["SCREEN_FLASH_EFFECT"] = "掉落时屏幕闪烁"
L["SCREEN_FLASH_EFFECT_TOOLTIP"] = "追踪的收藏品最终掉落时短暂闪烁屏幕。"
L["TRY_COUNTER_DROP_SCREENSHOT"] = "掉落时自动截图"
L["TRY_COUNTER_DROP_SCREENSHOT_TOOLTIP"] = "尝试追踪的收藏品掉落弹窗出现后，自动截取游戏画面并保存到“屏幕截图”文件夹。"
L["AUTO_TRY_COUNTER"] = "追踪掉落尝试"
L["AUTO_TRY_COUNTER_TOOLTIP"] = "统计坐骑、宠物、玩具和幻象相关的失败击杀、开启与施法。掉落弹窗会显示总尝试次数。"
L["SYNC_TRY_COUNT_DOWN_TO_STATISTICS"] = "向下对齐到统计数据"
L["SYNC_TRY_COUNT_DOWN_TO_STATISTICS_TOOLTIP"] = "对有统计 ID 的首领，尝试次数通常只会增加到与《魔兽世界》统计击杀数一致。启用后，当统计数更低时也会下调虚高的计数（例如 Rarity 插件导入后）。在每个小号上使用 /wn tc sync-stats。"
L["SETTINGS_ESC_HINT"] = "按 |cff999999ESC|r 关闭此窗口。"
L["HIDE_TRY_COUNTER_CHAT"] = "在聊天中隐藏尝试次数"
L["HIDE_TRY_COUNTER_CHAT_TOOLTIP"] = "隐藏聊天中所有尝试计数消息（[WN-Counter]、[WN-Drops]、获得/钓起等）。尝试总数仍会在界面和待办标签页更新；弹窗与屏幕闪烁不受影响。\n\n开启时，下方的“进入副本时列出掉落”与聊天路由相关选项将禁用。"
...
L["TRYCOUNTER_CHAT_ROUTE_DESC"] = "尝试计数消息的输出位置。默认跟随拾取标签页。"
...
-- Settings - Position
L["DRAG_POSITION_MSG"] = "拖动绿色=主弹窗，蓝色=进度通道（标准与待办）。右键预览可保存并关闭。"
L["DRAG_POSITION_STACK_MSG"] = "拖动堆叠预览（成就在上，标准与待办在下）。右键获取精确 X/Y。再次点击“设置位置”可保存并关闭。"
L["DRAG_BOTH_POSITION_MSG"] = "拖动定位。右键保存与通知和标准相同的位置。"
L["NOTIF_UNIFIED_TOAST_LAYOUT"] = "单一堆叠锚点（所有弹窗类型共享一个位置）"
L["NOTIF_PER_LANE_HINT"] = "独立锚点：选择通道，拖动预览，右键获取精确 X/Y。再次点击同一通道按钮即可保存。"
L["NOTIF_POS_BTN_ACH"] = "成就"
L["NOTIF_POS_BTN_CRITERIA"] = "进度"
L["NOTIF_POS_BTN_TRY"] = "尝试"
L["NOTIF_POS_BTN_REMINDER"] = "提醒"
L["NOTIF_DRAG_LANE_GHOST_MSG"] = "拖动预览，然后右键获取坐标。再次点击同一通道按钮即可保存。"
L["NOTIF_USE_PER_LANE_BUTTONS"] = "使用下方各类型按钮定位每个弹窗通道，或重新开启统一堆叠。"
L["NOTIF_GHOST_LABEL_ACHIEVEMENT"] = "成就/主要弹窗"
L["NOTIF_GHOST_LABEL_CRITERIA"] = "标准 / 进度弹窗"
L["NOTIF_GHOST_LABEL_TRY"] = "尝试次数弹窗"
L["NOTIF_GHOST_LABEL_REMINDER"] = "待办提醒弹窗"
...
L["TEST_STACK_CRITERIA"] = "标准进度（测试）"
L["TEST_STACK_REMINDER"] = "待办提醒（测试）"
L["NOTIFICATION_DEFAULT_TITLE"] = "通知"

-- Settings - Theme & Appearance
L["THEME_APPEARANCE"] = "主题与外观"
L["SETTINGS_SECTION_THEME_APPEARANCE"] = "外观"
...
L["UI_CHROME"] = "界面风格"
L["UI_CHROME_TOOLTIP"] = "现代风格使用 Warband Nexus 自定义界面。经典风格使用暴雪默认 UI。"
L["UI_CHROME_MODERN"] = "现代"
L["UI_CHROME_CLASSIC"] = "经典"
L["THEME_MODE"] = "外观"
L["THEME_MODE_TOOLTIP"] = "界面风格为现代时可选择深色或浅色。经典风格仅使用暴雪默认界面。"
L["THEME_MODE_DARK"] = "深色"
L["THEME_MODE_LIGHT"] = "浅色"
L["THEME_MODE_CLASSIC"] = "经典"
L["THEME_MODE_RELOAD_HINT"] = "主题已更新。"
L["SHELL_BACKGROUND_OPACITY"] = "窗口背景不透明度"
L["SHELL_BACKGROUND_OPACITY_DESC"] = "调整插件主窗口背景的不透明度。"
...
L["ANTI_ALIASING"] = "字体描边"
L["ANTI_ALIASING_DESC"] = "为文字添加细边框，使标签在浅色背景和彩色文字上保持可读。"
L["ANTI_ALIASING_HINT"] = "描边在两种主题下都会绘制经典魔兽世界文字边框。浅色模式下会自动调整墨色，避免深色职业色和金色在描边上变成黑块。"
L["AA_NONE"] = "关闭（平滑）"
L["AA_OUTLINE"] = "描边（默认）"
L["AA_THICKOUTLINE"] = "粗描边"
...
L["MODULE_PVP"] = "PvP"
L["MODULE_PVP_DESC"] = "追踪评级赛制、荣誉进度和对战记录。关闭后将停止所有 PvP 数据收集。"
L["MODULE_PLANS"] = "待办"
L["MODULE_PLANS_DESC"] = "追踪坐骑、宠物、玩具、成就和自定义任务的个人目标"
L["MODULE_PROFESSIONS"] = "专业"
L["MODULE_PROFESSIONS_DESC"] = "追踪所有角色的专业技能、工具、专注、知识和配方。在专业技能窗口打开时，配方助手会显示各材料的背包数量。"
L["MODULE_GEAR"] = "装备"
...
L["MODULE_TRY_COUNTER_DESC"] = "自动追踪 NPC、首领、钓鱼和容器的掉落尝试。禁用将停止所有计数器处理、提示和通知。"
L["PROFESSIONS_DISABLED_TITLE"] = "专业"

-- Tooltip Service
L["ITEM_NUMBER_FORMAT"] = "物品 #%s"
L["WN_SEARCH"] = "WN 搜索"
L["TOOLTIP_WN_KEYS"] = "WN 钥匙"
L["TOOLTIP_KEYSTONE_THIS"] = "此钥匙: +%d %s"
...
L["MINIMAP_LEFT_CLICK_ACTION_FMT"] = "左键：%s"
L["MINIMAP_RIGHT_CLICK_MENU"] = "右键：菜单"
L["RIGHT_CLICK_PLANS"] = "右键：打开待办"
L["RIGHT_CLICK_SHORTCUT_MENU"] = "右键：快捷菜单"
L["CONFIG_MINIMAP_LEFT_CLICK_HEADER"] = "小地图左键点击"
L["CONFIG_MINIMAP_LEFT_CLICK_TOGGLE"] = "左键：切换窗口"
L["CONFIG_MINIMAP_LEFT_CLICK_TOGGLE_DESC"] = "左键点击小地图按钮可打开或关闭主窗口。"
...
L["NAV_SETTINGS_TOOLTIP"] = "Warband Nexus 选项与偏好设置"
L["SETTINGS_TAB_TITLE"] = "设置"
L["SETTINGS_TAB_SUBTITLE"] = "在左侧选择分类，在右侧调整选项。"
L["SETTINGS_PANEL_GENERAL"] = "常规"
...
L["SETTINGS_PANEL_NOTIFICATIONS_DESC"] = "弹窗、聊天提醒、收藏品与尝试次数计数。"
L["SETTINGS_PANEL_APPEARANCE"] = "主题"
L["SETTINGS_PANEL_APPEARANCE_DESC"] = "主题颜色、字体与预设配色。"
L["SETTINGS_PANEL_ADVANCED"] = "高级"
L["SETTINGS_PANEL_ADVANCED_DESC"] = "调试日志、缓存刷新与物品追踪。"
L["SETTINGS_PANEL_ABOUT"] = "关于"
L["SETTINGS_PANEL_ABOUT_DESC"] = "致谢、贡献者与各标签页说明。"
L["SETTINGS_SECTION_NOTIF_MASTER"] = "总开关与提醒"
L["SETTINGS_SECTION_NOTIF_ACHIEVEMENTS"] = "成就弹窗"
L["SETTINGS_SECTION_NOTIF_COLLECTIBLES"] = "收藏品"
L["SETTINGS_SECTION_NOTIF_CHAT"] = "聊天消息"
L["SETTINGS_SECTION_NOTIF_TRY_COUNTER"] = "尝试次数"
L["HEADER_INFO_TOOLTIP"] = "插件说明与致谢"
L["HEADER_INFO_TOOLTIP_HINT"] = "功能与贡献者 — 名单在顶部。"
L["CONTRIBUTORS_TITLE"] = "贡献者"
L["ABOUT_PATREON_SUPPORTERS"] = "Patreon 支持者"
L["ABOUT_PATREON_SUPPORTER_1"] = "Melissa CD"
L["ABOUT_PATREON_SUPPORTER_2"] = "Bedroom"
L["ABOUT_COMMUNITY_TITLE"] = "社区"
L["ABOUT_COMMUNITY_HINT"] = "点击按钮显示链接，然后按 Ctrl+C 复制。"
L["THANK_YOU_MSG"] = "感谢使用 Warband Nexus！"

-- Information Dialog - Professions Tab
L["INFO_TAB_PROFESSIONS"] = "专业"
L["PROFESSIONS_INFO_DESC"] = "在可排序的表格中查看每个已追踪角色的制造类专业：技能等级、已装备工具、专注与充能、知识点数、配方覆盖以及每周知识进度。打开各角色的专业技能面板（默认 K）后数据会更新。专业技能窗口保持打开时，配方助手会显示你背包中每种材料的数量。"
...
L["TOAST_CAT_PLAN"] = "计划"
L["TOAST_CAT_ITEM"] = "物品"
L["TOAST_CAT_TITLE"] = "头衔"
L["TOAST_CAT_VAULT"] = "宝库"
L["TOAST_CAT_MAIL"] = "邮件"
L["TOAST_BADGE_TRAVELERS_LOG"] = "旅者日志"
L["TOAST_BADGE_ATTEMPTS"] = "尝试"
L["TOAST_CAT_REPUTATION"] = "名望"
L["TOAST_CAT_QUEST"] = "任务"
...
L["DEBUG_RELOAD_UI_BTN"] = "重载界面"
L["DEBUG_RELOAD_UI_TOOLTIP"] = "重载整个界面(/reload)。魔兽世界无法热重载插件 Lua；保存文件后使用。"
L["DEBUG_DISABLED"] = "调试模式已禁用。"
L["CHARACTER_LABEL"] = "角色："
L["TRACK_USAGE"] = "用法：启用 | 禁用 | 状态"
...
L["VAULT_TRACKER_STATUS_SLOTS_READY"] = "栏位已获得"

-- Easy Access tooltips (VaultButton EAL)
L["EA_MENU_TOOLTIP_STAR"] = "星标表示左键操作。"
L["EA_MENU_TOOLTIP_SET_ACTION"] = "右键菜单项可设置左键操作。"
L["EA_TOOLTIP_BOSS_FALLBACK"] = "首领 %d"
L["EA_TOOLTIP_BOSS_KILLED"] = "已击败：%s"
L["EA_TOOLTIP_BOSS_NOT_KILLED"] = "未击败"
L["EA_TOOLTIP_BOSS_REMAINING"] = "剩余：%s"
L["EA_TOOLTIP_BOUNTY_DONE"] = "已收集"
L["EA_TOOLTIP_BOUNTY_LABEL"] = "珍宝猎手的奖赏"
L["EA_TOOLTIP_BOUNTY_TODO"] = "未收集"
L["EA_TOOLTIP_CAT_DUNGEON"] = "地下城"
L["EA_TOOLTIP_CAT_RAID"] = "团队副本"
L["EA_TOOLTIP_CAT_WORLD"] = "世界"
L["EA_TOOLTIP_CONTROLS"] = "左键：操作  |  右键：菜单  |  拖动移动"
L["EA_TOOLTIP_GRID_SUB"] = "团队、地下城、世界栏与追踪器一致。按住 Shift：显示剩余激活次数。"
L["EA_TOOLTIP_SHIFT_HINT"] = "按住 Shift 查看宝库剩余进度。"
L["EA_TOOLTIP_SECTION_VAULT"] = "宏伟宝库"
L["EA_TOOLTIP_SECTION_WARBAND"] = "战团"
L["EA_TOOLTIP_FOOTER_LMB"] = "左键"
L["EA_TOOLTIP_FOOTER_RMB"] = "右键"
L["EA_TOOLTIP_FOOTER_DRAG"] = "拖动"
L["EA_TOOLTIP_LINE_CHARACTER"] = "角色"
L["EA_TOOLTIP_LINE_ILVL"] = "物品等级"
L["EA_TOOLTIP_LINE_GOLD"] = "金币"
L["EA_TOOLTIP_LINE_TODO"] = "待办"
L["EA_TOOLTIP_NO_CHAR"] = "暂无角色数据。"
L["EA_TOOLTIP_CONTROL_LEFT"] = "左键"
L["EA_TOOLTIP_CONTROL_RIGHT"] = "右键"
L["EA_TOOLTIP_CONTROL_RIGHT_VAL"] = "快捷菜单"
L["EA_TOOLTIP_CONTROL_DRAG"] = "拖动"
L["EA_TOOLTIP_CONTROL_DRAG_VAL"] = "在屏幕上移动"
L["EA_TOOLTIP_ACTION_PVE"] = "PvE 标签"
L["EA_TOOLTIP_ACTION_CHARS"] = "角色标签"
L["EA_TOOLTIP_ACTION_VAULT"] = "宝库追踪"
L["EA_TOOLTIP_ACTION_SAVED"] = "已存副本"
L["EA_TOOLTIP_ACTION_PLANS"] = "计划 / 待办"
L["EA_TOOLTIP_INSTANCE_BOSSES"] = "已击败首领 %d/%d"
L["EA_TOOLTIP_INSTANCE_CHARS"] = "%d 个角色在锁定中"
L["EA_TOOLTIP_INSTANCE_CLEARED_BY"] = "完全通关：%s"
L["EA_TOOLTIP_LOCKOUT_PROGRESS"] = "已击败首领 %d/%d"
L["EA_TOOLTIP_LOCKOUT_RESET"] = "锁定将在 %s 后重置"
L["EA_TOOLTIP_MANAFLUX_HELD"] = "持有 %d"
L["EA_TOOLTIP_MANAFLUX_LABEL"] = "法力熔剂"
L["EA_TOOLTIP_NO_CHAR_VAULT"] = "该角色尚无宝库数据。请打开一次宏伟宝库。"
L["EA_TOOLTIP_NO_WARBAND_VAULT"] = "本周没有已追踪的宝库活动。"
L["EA_TOOLTIP_OPEN_PVE"] = "左键：打开 PvE 标签页"
L["EA_TOOLTIP_SLOT_DONE_SHORT"] = "完成"
L["EA_TOOLTIP_SLOT_UPGRADE_SHORT"] = "升级"
L["EA_TOOLTIP_STASH_CLAIMED"] = "已领取 %d/%d"
L["EA_TOOLTIP_STASH_HEADER_DESC"] = "该角色本周鎏金藏匿物领取情况。"
L["EA_TOOLTIP_STASH_LABEL"] = "鎏金藏匿物"
L["EA_TOOLTIP_STASH_SCAN_HINT"] = "T11 丰饶地下堡奖励。请用该角色登录并打开地下堡 (J) 扫描一次。"
L["EA_TOOLTIP_STASH_UNKNOWN"] = "?/%d"
L["EA_TOOLTIP_STATUS_IN_PROGRESS"] = "本周进行中"
L["EA_TOOLTIP_STATUS_SLOTS_EARNED"] = "已获得 %d 个栏位 - 在宏伟宝库领取"
L["EA_TOOLTIP_SUMMARY_CHAR_BOUNTY"] = "赏金已收集"
L["EA_TOOLTIP_SUMMARY_CHAR_PROGRESS"] = "进行中"
L["EA_TOOLTIP_SUMMARY_CHAR_READY"] = "可领取"
L["EA_TOOLTIP_SUMMARY_CHAR_SLOTS"] = "已获得 %d 个栏位"
L["EA_TOOLTIP_SUMMARY_PROGRESS_COUNT"] = "进行中 %d"
L["EA_TOOLTIP_SUMMARY_READY_COUNT"] = "可领取 %d"
L["EA_BADGE_TOOLTIP_TITLE"] = "待领取宝库奖励"
L["EA_BADGE_TOOLTIP_NONE"] = "没有可领取的宝库奖励。"
L["EA_BADGE_TOOLTIP_MORE"] = "... 还有 %d 个"
L["EA_BADGE_TOOLTIP_HINT"] = "右键菜单打开宝库追踪器查看本周进度。"
L["EA_TOOLTIP_VOIDCORE_CAPPED_SUFFIX"] = "（已满）"
L["EA_TOOLTIP_VOIDCORE_HELD"] = "持有 %d"
L["EA_TOOLTIP_VOIDCORE_LABEL"] = "虚空核心"
...
L["CONFIG_VAULT_OPT_SUMMARY_MOUSEOVER"] = "战团摘要悬停显示"
L["CONFIG_VAULT_OPT_SUMMARY_MOUSEOVER_DESC"] = "悬停时显示战团的宝库摘要。关闭则仅显示当前角色。"
L["SETTINGS_SECTION_VAULT_DISPLAY"] = "鼠标提示与菜单"
L["CONFIG_VAULT_DISPLAY_TOOLTIP_HEADER"] = "鼠标悬停提示"
L["CONFIG_VAULT_DISPLAY_MENU_HEADER"] = "右键菜单"
L["CONFIG_VAULT_DISPLAY_VAULT"] = "宏伟宝库进度"
L["CONFIG_VAULT_DISPLAY_VAULT_DESC"] = "团队副本、地下城和世界栏位以及领取状态。"
L["CONFIG_VAULT_DISPLAY_GOLD"] = "金币"
L["CONFIG_VAULT_DISPLAY_GOLD_DESC"] = "鼠标悬停提示中显示角色的金币数量。"
L["CONFIG_VAULT_DISPLAY_TODO"] = "角色待办计划"
L["CONFIG_VAULT_DISPLAY_TODO_DESC"] = "该角色的活跃计划数量。"
L["CONFIG_VAULT_DISPLAY_BOUNTY"] = "珍宝猎手的奖赏"
L["CONFIG_VAULT_DISPLAY_BOUNTY_DESC"] = "每周地下堡珍宝猎手的奖赏状态。"
L["CONFIG_VAULT_DISPLAY_VOIDCORE"] = "晦暗虚空核心"
L["CONFIG_VAULT_DISPLAY_VOIDCORE_DESC"] = "本赛季晦暗虚空核心进度"
L["CONFIG_VAULT_DISPLAY_STASH"] = "鎏金藏匿物"
L["CONFIG_VAULT_DISPLAY_STASH_DESC"] = "每周鎏金藏匿物的领取状态。"
L["CONFIG_VAULT_DISPLAY_MANAFLUX"] = "黎明之光法力熔剂"
L["CONFIG_VAULT_DISPLAY_MANAFLUX_DESC"] = "持有的黎明之光法力熔剂货币。"
L["CONFIG_VAULT_DISPLAY_KEYSTONE"] = "史诗钥石"
L["CONFIG_VAULT_DISPLAY_KEYSTONE_DESC"] = "拥有的钥石等级和地下城。"
L["CONFIG_VAULT_DISPLAY_MYTHIC_SCORE"] = "史诗钥石评分"
L["CONFIG_VAULT_DISPLAY_MYTHIC_SCORE_DESC"] = "史诗钥石总评分。"
L["CONFIG_VAULT_DISPLAY_MENU_VAULT"] = "宝库摘要"
L["CONFIG_VAULT_DISPLAY_MENU_VAULT_DESC"] = "在菜单标题下显示团队副本、地下城、世界和状态。"
L["CONFIG_VAULT_DISPLAY_MENU_KEYSTONE"] = "钥石行"
L["CONFIG_VAULT_DISPLAY_MENU_KEYSTONE_DESC"] = "在菜单中显示当前角色的钥石。"
L["CONFIG_VAULT_DISPLAY_MENU_SCORE"] = "史诗钥石评分行"
L["CONFIG_VAULT_DISPLAY_MENU_SCORE_DESC"] = "在菜单中显示史诗钥石总评分。"
L["EA_TOOLTIP_KEYSTONE_LABEL"] = "钥石"
L["EA_TOOLTIP_KEYSTONE_NONE"] = "没有钥石"
L["EA_TOOLTIP_KEYSTONE_FORMAT"] = "+%d %s"
L["EA_TOOLTIP_MYTHIC_SCORE_LABEL"] = "史诗钥石评分"
...
L["CONFIG_VAULT_LEFT_CLICK_ITEMS"] = "左键：银行标签页"
L["CONFIG_VAULT_LEFT_CLICK_ITEMS_DESC"] = "左键快捷访问打开银行标签页。"
L["CONFIG_VAULT_LEFT_CLICK_GEAR"] = "左键：装备标签页"
L["CONFIG_VAULT_LEFT_CLICK_GEAR_DESC"] = "左键快捷访问打开装备标签页。"
L["CONFIG_VAULT_LEFT_CLICK_CURRENCY"] = "左键：货币标签页"
L["CONFIG_VAULT_LEFT_CLICK_CURRENCY_DESC"] = "左键快捷访问打开货币标签页。"
L["CONFIG_VAULT_LEFT_CLICK_REPUTATIONS"] = "左键：声望标签页"
L["CONFIG_VAULT_LEFT_CLICK_REPUTATIONS_DESC"] = "左键快捷访问打开声望标签页。"
L["CONFIG_VAULT_LEFT_CLICK_PROFESSIONS"] = "左键：专业标签页"
L["CONFIG_VAULT_LEFT_CLICK_PROFESSIONS_DESC"] = "左键快捷访问打开专业标签页。"
L["CONFIG_VAULT_LEFT_CLICK_COLLECTIONS"] = "左键：收藏品标签页"
L["CONFIG_VAULT_LEFT_CLICK_COLLECTIONS_DESC"] = "左键快捷访问打开收藏品标签页。"
L["CONFIG_VAULT_LEFT_CLICK_PLANS_TAB"] = "左键：待办标签页"
L["CONFIG_VAULT_LEFT_CLICK_PLANS_TAB_DESC"] = "左键快捷访问打开待办标签页。"
L["CONFIG_VAULT_LEFT_CLICK_STATS"] = "左键：统计标签页"
L["CONFIG_VAULT_LEFT_CLICK_STATS_DESC"] = "左键快捷访问打开统计标签页。"
L["CONFIG_VAULT_LEFT_CLICK_SETTINGS"] = "左键：设置"
L["CONFIG_VAULT_LEFT_CLICK_SETTINGS_DESC"] = "左键快捷访问打开Warband Nexus 设置。"
L["CMD_QT"] = "打开快捷访问菜单"
...
L["SET_ALERT"] = "设置提醒"
L["SET_ALERT_SECTION_SCHEDULE"] = "登录和重置"
L["SET_ALERT_BEFORE_RESET_GROUP"] = "每周重置前几天"
L["SET_ALERT_SECTION_LOCATION"] = "区域和副本"
L["SET_ALERT_SECTION_QUESTS"] = "任务与事件"
L["SET_ALERT_MUTEX_QUEST_BLOCKED"] = "禁用，因为 %s 已开启。请关闭后再为此提醒启用任务与事件。"
L["SET_ALERT_MUTEX_ZONE_BLOCKED"] = "已禁用，因为 %s 已开启。请关闭后再为此提醒启用区域与副本。"
L["SET_ALERT_QUESTS_HINT"] = "选择一个分类。勾选的条目决定了触发此提醒的任务或事件范围。"
L["REMINDER_OPT_QUEST_TRACK"] = "当地图上存在选中的任务时提醒"
L["REMINDER_QUEST_SELECTED_COUNT"] = "已选任务 (%d)"
L["REMINDER_QUEST_SELECTED_EMPTY"] = "未选择任务（该类型任意激活任务均匹配）。"
L["REMINDER_QUEST_CATALOG_HINT_SHORT"] = "从左侧选择分类，然后在右侧勾选具体任务。"
L["SET_ALERT_SECTION_FOCUS"] = "焦点"
L["REMINDER_OPT_ZONE_ENTER_MATCHING"] = "进入匹配区域时提醒我"
L["REMINDER_ZONE_GET_ID"] = "获取ID"
L["REMINDER_ZONE_NAME_LABEL"] = "区域"
L["REMINDER_ZONE_NAME_UNKNOWN"] = "未知地图ID"
L["REMINDER_ZONE_FIELD_SAVED_WITH_ALERT"] = "点击保存时，字段中的ID会被保存（按回车键会立即将其添加到列表中）。"
L["REMOVE_ALERT"] = "移除提醒"
...
L["REMINDER_TOAST_TITLE"] = "待办"
L["REMINDER_AGGREGATE_CALENDAR_TITLE"] = "多个提醒"
L["REMINDER_AGGREGATE_CALENDAR_BODY"] = "你有 %d 个待办提醒。"
...
L["REMINDER_OPT_MONTHLY"] = "每个自然月首次登录时提醒"
L["REMINDER_MONTHLY_LOGIN"] = "每月登录"
L["REMINDER_OPT_ZONE_HINTS"] = "匹配计划标题/来源文本中的区域名"
L["REMINDER_ZONE_MAPID_LABEL"] = "地图ID"
L["REMINDER_ZONE_ADD"] = "添加"
L["REMINDER_ZONE_CURRENT"] = "当前"
L["REMINDER_ZONE_MANUAL_COUNT"] = "手动地图：%d"
L["REMINDER_ZONE_SELECTED_COUNT"] = "已选择区域（%d）"
L["REMINDER_ZONE_SELECTED_EMPTY"] = "未选择区域。请从下方浏览器添加，或输入地图ID后按回车键。"
L["REMINDER_ZONE_MANUAL_EMPTY"] = "尚未保存任何地图。请使用获取ID、在字段中按回车键，或从下方列表中添加。"
L["REMINDER_ZONE_MANUAL_REMOVE"] = "移除"
L["REMINDER_ZONE_CATALOG_TITLE"] = "按内容更新分类区域"
L["REMINDER_ZONE_CATALOG_HINT"] = "在左侧选择一个内容更新。列表按当前客户端类型分组显示地图（C_Map + 地下城手册的团队副本与地下城）。添加你需要的行，然后保存——只有当你的当前地图ID与已保存行完全匹配时才会触发进入区域提醒（不包括父级区域）。"
L["REMINDER_ZONE_CATALOG_HINT_SHORT"] = "左侧为资料片，右侧为添加。完成后保存。"
L["REMINDER_ZONE_CATALOG_EXPANSIONS_LABEL"] = "资料片"
L["REMINDER_ZONE_CATALOG_MAPS_LABEL"] = "地图"
L["REMINDER_ZONE_CATALOG_COL_TYPE"] = "类型"
L["REMINDER_ZONE_CATALOG_COL_MAP"] = "地图"
L["REMINDER_ZONE_INSTANCE_PARENT_ROW_SUFFIX"] = "所有"
L["REMINDER_ZONE_MAIN_MAP_SUFFIX"] = "主地图"
L["REMINDER_ZONE_PICKER_HINT_RAID"] = "团队"
L["REMINDER_ZONE_PICKER_HINT_DUNGEON"] = "地下城"
L["REMINDER_ZONE_HINT_MECHAGON_ISLAND"] = "麦卡贡岛"
L["REMINDER_ZONE_HINT_MECHAGON_ROBODROME"] = "机械天穹"
L["REMINDER_ZONE_HINT_ORGRIMMAR_CLEFT"] = "暗影裂口"
L["REMINDER_ZONE_HINT_DELVE_UIMAP"] = "#%d"
L["REMINDER_ZONE_CATALOG_OPEN_WORLD"] = "开放世界"
L["REMINDER_ZONE_CATALOG_INSTANCES"] = "地下城和团队副本"
L["REMINDER_ZONE_CATALOG_RELATED_AREAS"] = "相关地区"
L["REMINDER_ZONE_CATALOG_RAIDS"] = "团队副本"
L["REMINDER_ZONE_CATALOG_DUNGEONS"] = "地下城"
L["REMINDER_ZONE_CATALOG_DELVES"] = "地下堡"
L["REMINDER_ZONE_CATALOG_AREAS"] = "微型区域"
L["REMINDER_ZONE_CATALOG_SCENARIOS"] = "场景战役和独立地图"
L["REMINDER_ZONE_CATALOG_REGIONS"] = "地区"
L["REMINDER_ZONE_MIDNIGHT_WORLD_EVENTS"] = "世界事件和区域"
L["REMINDER_QUEST_CAT_CONTENT_EVENTS"] = "内容事件"
L["REMINDER_ZONE_CATALOG_OTHER"] = "其他地图"
L["REMINDER_ZONE_KIND_TAG_RAID"] = "[团队]"
L["REMINDER_ZONE_KIND_TAG_DUNGEON"] = "[地下城]"
L["REMINDER_ZONE_KIND_TAG_DELVE"] = "[地下堡]"
L["REMINDER_ZONE_KIND_TAG_ZONE"] = "[区域]"
L["REMINDER_ZONE_KIND_TAG_AREA"] = "[区域]"
L["REMINDER_ZONE_KIND_TAG_MISC"] = "[其他]"
L["REMINDER_ZONE_KIND_TAG_SCENARIO"] = "[场景]"
L["REMINDER_ZONE_KIND_TAG_REGION"] = "[地区]"
L["REMINDER_ZONE_KIND_TAG_UNKNOWN"] = "[？]"
L["REMINDER_ZONE_CAT_TAG_ZONE"] = "[区域]"
L["REMINDER_ZONE_CAT_TAG_INSTANCE"] = "[副本]"
L["REMINDER_ZONE_CAT_TAG_RELATED"] = "[+]"
L["REMINDER_ZONE_CATALOG_ADD"] = "添加"
L["REMINDER_ZONE_CAT_MIDNIGHT"] = "至暗之夜"
L["REMINDER_ZONE_CAT_TWW"] = "地心之战"
L["REMINDER_ZONE_CAT_DRAGONFLIGHT"] = "巨龙时代"
L["REMINDER_ZONE_CAT_SHADOWLANDS"] = "暗影国度"
L["REMINDER_ZONE_CAT_BFA"] = "争霸艾泽拉斯"
L["REMINDER_ZONE_CAT_LEGION"] = "军团再临"
L["REMINDER_ZONE_CAT_WOD"] = "德拉诺之王"
L["REMINDER_ZONE_CAT_MOP"] = "熊猫人之谜"
L["REMINDER_ZONE_CAT_CATA"] = "大地的裂变"
L["REMINDER_ZONE_CAT_WRATH"] = "巫妖王之怒"
L["REMINDER_ZONE_CAT_BC"] = "燃烧的远征"
L["REMINDER_ZONE_CAT_KALIMDOR"] = "卡利姆多"
L["REMINDER_ZONE_CAT_EASTERN_KINGDOMS"] = "东部王国"
L["REMINDER_CARD_CLICK_OPEN_SETTINGS"] = "点击号角图标打开提醒设置。"
L["REMINDER_OPT_INSTANCE"] = "进入此副本时提醒"
L["REMINDER_INSTANCE_CAPTURE"] = "捕获当前副本"
L["REMINDER_INSTANCE_NONE"] = "未捕获副本。"
L["REMINDER_INSTANCE_CAPTURED_FMT"] = "instanceID %s，难度 %s（nil = 任意）"
L["REMINDER_INSTANCE_NOT_INSIDE"] = "请先进入地下城或团队副本，然后再捕获。"
L["REMINDER_INSTANCE_ENTER"] = "进入副本（%s）"
L["REMINDER_INSTANCE_GENERIC"] = "地下城或团队副本"
L["REMINDER_OPT_WORLD_QUEST_ACTIVE"] = "所选世界任务在地图上激活时提醒"
L["REMINDER_OPT_CONTENT_EVENT_ACTIVE"] = "当地图上存在选中的至暗之夜事件时提醒"
L["REMINDER_WORLD_QUEST_ACTIVE"] = "世界任务已激活 - %s"
L["REMINDER_CONTENT_EVENT_ACTIVE"] = "正在进行的活动 - %s"
L["REMINDER_QUEST_CATALOG_TITLE"] = "选择任务"
L["REMINDER_QUEST_CATALOG_HINT"] = "参考列表（不限于今日激活）。勾选条目可限定提醒范围；不勾选 = 该分类下任何激活的都会提醒。"
L["REMINDER_QUEST_CATALOG_SECTIONS_LABEL"] = "区域"
L["REMINDER_QUEST_CATALOG_QUESTS_LABEL"] = "任务"
L["REMINDER_QUEST_CATALOG_CATEGORY_LABEL"] = "分类"
L["REMINDER_QUEST_CATALOG_LIST_LABEL"] = "任务"
L["REMINDER_QUEST_CATALOG_TYPE_LABEL"] = "类型"
L["REMINDER_QUEST_CATALOG_ENTRIES_LABEL"] = "条目"
L["REMINDER_QUEST_CATALOG_COL_SELECT"] = "追踪"
L["REMINDER_QUEST_CATALOG_COL_TYPE"] = "类型"
L["REMINDER_QUEST_CATALOG_COL_STATUS"] = "状态"
L["REMINDER_QUEST_CATALOG_COL_ENTRY"] = "条目"
L["REMINDER_QUEST_CATALOG_COL_TITLE"] = "标题"
L["REMINDER_QUEST_CATALOG_COL_EVENT"] = "事件"
L["REMINDER_QUEST_CATALOG_COL_QUEST"] = "任务"
L["REMINDER_QUEST_CAT_CALENDAR"] = "世界事件"
L["REMINDER_QUEST_TAG_ZONE_EVENT"] = "区域事件"
L["REMINDER_QUEST_TAG_CONTENT_EVENT"] = "内容事件"
L["REMINDER_QUEST_TAG_CALENDAR"] = "事件"
L["REMINDER_QUEST_CATALOG_GRP_ACTIVE"] = "当前激活"
L["REMINDER_QUEST_CATALOG_GRP_CATALOG"] = "已知任务"
L["REMINDER_QUEST_CATALOG_EMPTY_WQ"] = "该区域暂无世界任务记录。请在游戏内造访该区域后重新打开此对话框。"
L["REMINDER_QUEST_CATALOG_EMPTY_EVENTS"] = "目录中未找到内容事件。"
L["REMINDER_WQ_CAT_SILVERMOON"] = "银月城"
L["REMINDER_WQ_CAT_EVERSONG"] = "永歌森林"
L["REMINDER_WQ_CAT_ISLE"] = "奎尔丹纳斯岛"
L["REMINDER_WQ_CAT_HARANDAR"] = "哈籁恩达尔"
L["REMINDER_WQ_CAT_ZULAMAN"] = "祖阿曼"
L["REMINDER_WQ_CAT_VOIDSTORM"] = "虚影风暴"
L["REMINDER_WQ_CAT_COILED_ISLE"] = "The Coiled Isle"
L["REMINDER_WQ_CAT_QUELTHALAS"] = "奎尔萨拉斯（全部）"
L["REMINDER_EVENT_GRP_SOIREE"] = "萨瑟利尔的晚宴"
L["REMINDER_EVENT_GRP_ABUNDANCE"] = "丰饶"
L["REMINDER_EVENT_GRP_HARANIR"] = "哈籁尼尔传说"
L["REMINDER_EVENT_GRP_STORMARION"] = "风暴突袭战"
L["REMINDER_EVENT_GRP_OTHER"] = "其他事件"
L["REMINDER_EVENT_GRP_WORLD_EVENTS"] = "世界事件"
L["REMINDER_EVENT_GRP_MIDNIGHT_ZONE"] = "至暗之夜区域事件"
L["QUEST_CAT_WORLD_QUESTS"] = "世界任务"
L["QUEST_CAT_WORLD_EVENTS"] = "世界事件"
L["REMINDER_HOLIDAY_DARKMOON"] = "暗月马戏团"
L["REMINDER_HOLIDAY_LUNAR"] = "春节"
L["REMINDER_HOLIDAY_WINTER_VEIL"] = "冬幕节"
L["REMINDER_HOLIDAY_HALLOWS_END"] = "万圣节"
L["REMINDER_HOLIDAY_LOVE"] = "情人节"
L["REMINDER_HOLIDAY_MIDSUMMER"] = "仲夏火焰节"
L["REMINDER_HOLIDAY_BREWFEST"] = "美酒节"
L["REMINDER_HOLIDAY_NOBLEGARDEN"] = "复活节"
L["REMINDER_HOLIDAY_PILGRIM"] = "感恩节"
L["REMINDER_HOLIDAY_CHILDRENS_WEEK"] = "儿童周"
L["REMINDER_HOLIDAY_DAY_OF_DEAD"] = "悼念日"
L["REMINDER_HOLIDAY_FIREWORKS"] = "焰火表演"
L["REMINDER_HOLIDAY_HARVEST"] = "收获节"
L["REMINDER_HOLIDAY_NEW_YEAR"] = "新年庆典"
L["REMINDER_HOLIDAY_PEON_DAY"] = "苦工节"
L["REMINDER_HOLIDAY_PIRATES_DAY"] = "海盗日"
L["REMINDER_HOLIDAY_WANDERERS"] = "云游节"
L["REMINDER_HOLIDAY_AUCTION_DANCE"] = "舞会"
L["REMINDER_HOLIDAY_CALL_SCARAB"] = "甲虫的召唤"
L["REMINDER_HOLIDAY_FREE_TSHIRT"] = "免费T恤日"
L["REMINDER_HOLIDAY_GLOWCAP"] = "亮顶节"
L["REMINDER_HOLIDAY_GNOMEREGAN"] = "诺莫瑞根马拉松"
L["REMINDER_HOLIDAY_HIPPOGRYPH"] = "角鹰兽孵化日"
L["REMINDER_HOLIDAY_KIRIN_TOR"] = "肯瑞托旅店趴"
L["REMINDER_HOLIDAY_LUMINOUS"] = "幽光之星"
L["REMINDER_HOLIDAY_TADPOLES"] = "蝌蚪远足日"
L["REMINDER_HOLIDAY_MOONKIN"] = "枭兽节"
L["REMINDER_HOLIDAY_SPRING_BALLOON"] = "春日气球节"
L["REMINDER_HOLIDAY_THOUSAND_BOAT"] = "赛艇大会"
L["REMINDER_HOLIDAY_TRIAL_STYLE"] = "时尚试炼"
L["REMINDER_HOLIDAY_UNGORO"] = "安戈洛狂欢节"
L["REMINDER_HOLIDAY_VOLUNTEER"] = "志愿军日"
L["REMINDER_HOLIDAY_TIMEWALKING"] = "时空漫游地下城事件"
L["REMINDER_HOLIDAY_CALL_TO_ARMS"] = "战斗的号角（战场）"
L["REMINDER_WORLD_EVENT_CATALOG_TITLE"] = "世界事件"
L["REMINDER_WORLD_EVENT_CATALOG_HINT"] = "游戏日历中的季节事件。状态显示该事件当前是否激活。"
L["REMINDER_WORLD_EVENT_CATALOG_EMPTY"] = "目录中无日历事件。"
L["REMINDER_OPT_WORLD_EVENT_ACTIVE"] = "当选定的世界事件激活时提醒"
L["REMINDER_WORLD_EVENT_ACTIVE"] = "世界事件激活 - %s"
L["REMINDER_WORLD_EVENT_STATUS_ACTIVE"] = "激活"
L["REMINDER_WORLD_EVENT_STATUS_INACTIVE"] = "未激活"
L["REMINDER_QUEST_TAG_WQ"] = "世界任务"
L["REMINDER_QUEST_TAG_EVENT"] = "事件"
L["REMINDER_QUEST_TAG_ACTIVE"] = "激活"
L["REMINDER_SHORT_WORLD_QUEST"] = "地图上的世界任务"
L["REMINDER_SHORT_CONTENT_EVENT"] = "地图上的事件"
L["REMINDER_FOCUS_LOCATION"] = "仅针对此计划的区域/副本提醒"
L["REMINDER_SHORT_DAILY"] = "每日登录"
L["REMINDER_SHORT_WEEKLY"] = "每周重置"
L["REMINDER_SHORT_MONTHLY"] = "每月登录"
L["REMINDER_SHORT_BEFORE_RESET"] = "重置前 %d 天"
L["REMINDER_SHORT_ZONE"] = "进入区域"
L["REMINDER_SHORT_INSTANCE"] = "副本"
L["REMINDER_SHORT_FOCUS"] = "位置焦点"
L["REMINDER_SHORT_WORLD_EVENT"] = "世界事件"
L["REMINDER_CONFIGURED_TITLE"] = "提醒已保存"
L["REMINDER_CONFIGURED_BODY"] = "提醒：%s"
L["REMINDER_CONFIGURED_NONE"] = "未选择提醒"
L["REMINDER_CLEARED_TITLE"] = "提醒已清除"
L["REMINDER_CARD_CLICK_CONFIGURE"] = "点击以配置提醒。"
L["REMINDER_COLLECTIBLE_ZONE_HINT"] = "收藏品很少在 API 中暴露固定区域；请添加 uiMapID、捕获副本，或匹配存储/来源文本中的区域名。"
L["REMINDER_TOY_ZONE_HINT"] = "玩具在日志中通常缺少丰富的来源信息——请使用手动添加地图ID或捕获副本。"
...
L["COLLECTIONS_ACHIEVEMENT_EARNED_LINE"] = "%s - 由 %s 获得"
L["COLLECTIONS_ACHIEVEMENT_EARNED_BY_ONLY"] = "由 %s 获得"
L["COLLECTIONS_ACHIEVEMENT_BY_WARBAND"] = "战团"
L["COLLECTIONS_RECENT_TAB_EMPTY"] = "未记录任何信息"
L["COLLECTIONS_RECENT_TAB_EMPTY_DESC"] = "最近获得的坐骑、宠物、玩具和成就会显示在这里。"
...
L["COLLECTIONS_RECENT_CARD_RESET_TOOLTIP_BODY"] = "仅清除此“最近获得”分类中的记录，不会删除坐骑、宠物、玩具和成就。"
...
L["COLLECTIONS_RECENT_TOOLTIP_EARNED_BY"] = "获得自 %s"
L["COLLECTIONS_RECENT_TOOLTIP_RECORDED"] = "记录时间: %s"
...
L["PROFESSIONS_EXPAND_ALL_TOOLTIP"] = "展开收藏、角色和未追踪分类。"
L["PROFESSIONS_COLLAPSE_ALL_TOOLTIP"] = "折叠收藏、角色和未追踪分类。"
L["PROFESSIONS_TRACKED_FORMAT"] = "%s 个已跟踪 - %s 个有专业数据"
L["PROFESSIONS_WIDE_TABLE_HINT"] = "提示：使用下方滚动条或 Shift+滚轮查看所有列。"
L["PROFESSIONS_LAYOUT_HINT"] = "提示：使用列视图显示周常、论述、宝藏及其他进度。"
...
L["PROF_INFO_TOOL"] = "工具"
L["PROF_INFO_ACC1"] = "配件 1"
L["PROF_INFO_ACC2"] = "配件 2"
...
L["CUSTOM_PLAN_REPEAT_UNTIL_REMOVED"] = "重复直到删除此计划"
L["CUSTOM_PLAN_CYCLES_UNTIL_REMOVED"] = "直至删除"
L["DESCRIPTION"] = "描述"
L["PARSE_AMOUNT"] = "数量"
L["PARSE_LOCATION"] = "位置"
...
L["TRYCOUNTER_DISABLED_MODULE"] = "设置中已关闭尝试计数模块，击杀不会计入。请启用模块 - 尝试计数 以及 通知 - 自动尝试计数。"
L["TRYCOUNTER_DISABLED_AUTO"] = "设置中已关闭自动尝试计数，击杀不会计入。请启用 通知 - 自动尝试计数（尝试计数模块也需开启）。"
L["TRYCOUNTER_DIFF_FILTER_DEBUG"] = "难度过滤：无可追踪掉落 (encDiff=%s, label=%s, 需要=%s, 已收集=%s)。"
...
L["TRYCOUNTER_PROBE_REQ_TIMEWALKING"] = "仅时空漫游"
...
L["CONFIG_MAIN_NAV_LAYOUT"] = "主窗口导航布局"
L["CONFIG_MAIN_NAV_LAYOUT_DESC"] = "顶部标签行或左侧图标栏；在界面重载(/reload)后生效。"
L["CONFIG_MAIN_NAV_LAYOUT_TOP"] = "横向标签（顶部）"
L["CONFIG_MAIN_NAV_LAYOUT_RAIL"] = "左侧文字菜单"
L["CONFIG_MAIN_NAV_LAYOUT_RELOAD_NOTICE"] = "主导航在界面重载(/reload)后生效。"
L["CONFIG_SHOW_ITEMS_TOOLTIP"] = "在提示中显示物品"
L["CONFIG_SHOW_ITEMS_TOOLTIP_DESC"] = "在物品提示中显示战团和角色物品数量。"
L["CONFIG_SHOW_TOOLTIP_ITEM_ID"] = "在提示中显示物品 ID"
L["CONFIG_SHOW_TOOLTIP_ITEM_ID_DESC"] = "在物品提示底部追加数字物品 ID。"
...
L["CONFIG_MOD_PROFESSIONS_DESC"] = "专业技能标签页：各角色的技能、工具、知识、配方、专注与每周知识。"
...
L["SORT_MODE_CLASS"] = "职业（A-Z）"
L["SORT_MODE_LEVEL"] = "等级（最高）"
L["SORT_MODE_ILVL"] = "装等（最高）"
L["SORT_MODE_PVP_RATING"] = "评分（最高）"
L["SORT_MODE_GOLD"] = "金币（最高）"
L["SORT_MODE_REALM"] = "服务器 (A-Z)"
L["SORT_MODE_GUILD"] = "公会 (A-Z)"
L["FILTER_MENU_TOOLTIP"] = "排序、按分类筛选以及管理自定义角色标题。"
L["FILTER_SUBMENU_SORT"] = "排序…"
L["FILTER_SUBMENU_VIEW"] = "显示分类…"
L["SECTION_FILTER_ALL"] = "所有分类"
L["SECTION_FILTER_FAVORITES"] = "仅限收藏"
L["SECTION_FILTER_REGULAR"] = "仅限角色（未分组）"
L["SECTION_FILTER_UNTRACKED"] = "仅限未追踪"
-- Gold Management
...
L["GEAR_CURRENCY_PANEL_HOVER_HINT"] = "悬停已装备物品可查看纹章消耗和来源。"
L["GEAR_TT_DAWNCREST_WORD"] = "迷雾纹章"
L["GEAR_TT_SECTION_DAWNCREST"] = "迷雾纹章"
L["GEAR_TT_SECTION_SOURCES"] = "来源"
L["GEAR_TT_TRACK_RANK_FORMAT"] = "%s %d/%d"
L["GEAR_TT_NEXT_STEP_CRESTS"] = "下一步：%d %s。"
L["GEAR_TT_NEXT_STEP_GOLD_ONLY"] = "下一步：仅需金币（你已在此部位达到该物品等级）。"
L["GEAR_TT_REMAINING_TRACK_CRESTS"] = "该路线剩余纹章：%d（共 %d %s）。"
L["GEAR_TT_CRAFTED_NEXT_RECAST"] = "下次再造目标：%s（物品等级 %d），%d %s。"
L["GEAR_TT_UPGRADE_FALLBACK_LEAD"] = "升级使用曙光纹章（数量见货币面板）。各等级示例："
L["GEAR_LAYOUT_SCROLL_HINT"] = "窗口较窄：可横向滚动或拉宽窗口。"
...
L["GEAR_TT_ENCHANT_QUALITY_LINE"] = "附魔品质：%d/3"
...
L["GEAR_CRAFTED_COST_DAWNCREST"] = "消耗：%d %s 曙光纹章"
L["GEAR_CRAFTED_NEXT_TIER_CRESTS"] = "%s（装等 %d）：纹章 %d/%d（还需 %d）"

-- Characters UI
L["WOW_TOKEN_LABEL"] = "时光徽章"
L["WOW_TOKEN_COUNT_LABEL"] = "徽章"
...
L["GROUP_PROFESSION"] = BATTLE_PET_SOURCE_4 or "专业"
...
L["TAB_PROFESSIONS"] = TRADE_SKILLS or "专业"
L["TAB_COLLECTIONS"] = "收藏"
L["BACKPACK_LABEL"] = BACKPACK_TOOLTIP or "背包"
L["CHARACTER_BANK"] = BANK or "银行"
L["ITEMS_SUBTAB_BANK"] = BANK or "银行"
L["CHARACTER_INVENTORY"] = INVENTORY_TOOLTIP or "背包"
L["SETTINGS_SECTION_TAB_INVENTORY"] = INVENTORY_TOOLTIP or "背包"
L["MODULE_ITEMS"] = BANK or "银行"
L["INFO_TAB_ITEMS"] = BANK or "银行"
L["CONFIG_MOD_ITEMS"] = BANK or "银行"
L["RESET_NONE"] = NONE or "无"
L["MAIL_TOOLTIP_TITLE"] = MAIL_LABEL or "邮件"
L["MAIL_TOOLTIP_FROM_LABEL"] = FROM or "发件人"
L["MAIL_TOOLTIP_SUBJECT_LABEL"] = MAIL_SUBJECT_LABEL or "主题"
L["MAIL_TOOLTIP_CURRENCY_LABEL"] = CURRENCY or "货币"
L["MAIL_TOOLTIP_UNKNOWN_SENDER"] = UNKNOWN or "未知"
L["SOURCE_UNKNOWN"] = UNKNOWN or "未知"
L["TOOLTIP_UNKNOWN"] = UNKNOWN or "未知"
L["ONLINE"] = GUILD_ONLINE_LABEL or "在线"
L["GEAR_OFFLINE_BADGE"] = PLAYER_OFFLINE or "离线"
L["STALE_CHARACTER_COPIES_DISMISS"] = PET_DISMISS or "解散"
L["CUSTOM_HEADER_PICKER_FILTER_LABEL"] = SEARCH or "搜索"
L["CUSTOM_HEADER_COL_CHARACTER"] = CHARACTER or "角色"
L["CUSTOM_HEADER_COL_LEVEL"] = LEVEL or "等级"
L["CUSTOM_HEADER_REMOVE_LINK"] = REMOVE or "移除"
L["REMINDER_ZONE_ADD"] = ADD or "添加"
L["REMINDER_ZONE_CATALOG_ADD"] = ADD or "添加"
L["REMINDER_ZONE_MANUAL_REMOVE"] = REMOVE or "移除"
L["SEARCH_BUTTON"] = SEARCH or "搜索"
L["COMPLETE_LABEL"] = COMPLETE or "完成"
L["DESCRIPTION_LABEL"] = DESCRIPTION or "描述"
L["DESCRIPTION"] = DESCRIPTION or "描述"
L["SOURCE_LABEL"] = SOURCE or "来源:"
L["SOURCE"] = SOURCE or "来源"
L["ZONE_LABEL"] = (ZONE or "区域") .. ":"
L["REMINDER_ZONE_NAME_LABEL"] = ZONE or "区域"
L["VENDOR_LABEL"] = (BATTLE_PET_SOURCE_3 or "商人") .. ":"
L["DROP_LABEL"] = (BATTLE_PET_SOURCE_1 or "掉落") .. ":"
L["FACTION_LABEL"] = (FACTION or "阵营") .. ":"
L["REP_FACTION_FALLBACK"] = FACTION or "阵营"
L["CUSTOM"] = CUSTOM or "自定义"
L["PLAN_GEO_BUCKET_CUSTOM"] = CUSTOM or "自定义"
L["TYPE_CUSTOM"] = CUSTOM or "自定义"
L["QUEST_CAT_DAILY"] = DAILY or "每日"
L["QUEST_CAT_WEEKLY"] = WEEKLY or "每周"
L["REMINDER_OPT_DAILY_SHORT"] = DAILY or "每日"
L["REMINDER_OPT_WEEKLY_SHORT"] = WEEKLY or "每周"
L["CURRENCY_LABEL_WEEKLY"] = WEEKLY or "每周"
L["PVE_CURRENCY_VIEW_WEEKLY"] = WEEKLY or "每周"
L["PVE_HEADER_RAID_SHORT"] = RAID or "团队"
L["EA_TOOLTIP_CAT_RAID"] = RAID or "团队"
L["REMINDER_ZONE_PICKER_HINT_RAID"] = RAID or "团队"
L["EA_TOOLTIP_CAT_DUNGEON"] = LFG_TYPE_DUNGEON or "地下城"
L["REMINDER_ZONE_PICKER_HINT_DUNGEON"] = LFG_TYPE_DUNGEON or "地下城"
L["SETTINGS_PANEL_GENERAL"] = GENERAL or "常规"
L["SETTINGS_SECTION_NOTIF_MASTER"] = GENERAL or "常规"
L["VAULT_BUTTON_MENU_SETTINGS"] = SETTINGS or "设置"
L["PROF_FILTER_ALL"] = ALL or "全部"
L["ACHIEVEMENT"] = BATTLE_PET_SOURCE_6 or "成就"
L["TOAST_CAT_MOUNT"] = MOUNT or "坐骑"
L["TOAST_CAT_PET"] = PET or "宠物"
L["TOAST_CAT_TOY"] = TOY or "玩具"
L["TOAST_CAT_ITEM"] = ITEM or "物品"
L["TOAST_CAT_QUEST"] = BATTLE_PET_SOURCE_2 or "任务"
L["TOAST_CAT_ACHIEVEMENT"] = BATTLE_PET_SOURCE_6 or "成就"
L["PVE_HEADER_STATUS_SHORT"] = STATUS or "状态"
L["REMINDER_QUEST_CATALOG_COL_STATUS"] = STATUS or "状态"
L["EQUIPMENT"] = BAG_FILTER_EQUIPMENT or "装备"
L["FISHING"] = PROFESSIONS_FISHING or "钓鱼"
L["COLLECTIONS_CONTENT_TITLE_ACHIEVEMENTS"] = ACHIEVEMENTS or "成就"
L["PLAN_GEO_BUCKET_ACHIEVEMENT"] = ACHIEVEMENTS or "成就"
L["COLLECTIONS_CONTENT_TITLE_MOUNTS"] = MOUNTS or "坐骑"
L["COLLECTIONS_CONTENT_TITLE_PETS"] = PETS or "宠物"
L["ACHIEVEMENT_POINTS_CHARACTER"] = CHARACTER or "角色"
L["INFO_TAB_CURRENCY"] = CURRENCY or "货币"
L["NOTIF_POS_BTN_ACH"] = BATTLE_PET_SOURCE_6 or "成就"
L["ACHIEVEMENT_POINTS"] = ACHIEVEMENT_POINTS or "成就点数"
L["STATUS_LABEL"] = (STATUS or "状态") .. ":"
L["MONEY_LOGS_RESET"] = RESET or "重置"
L["VAULT_SUMMARY_COL_NAME"] = CHARACTER or "角色"
L["VAULT_TRACK_WAITING_RESET_SHORT"] = RESET or "重置"
L["OPTIONS_MENU"] = GAMEOPTIONS_MENU or OPTIONS or "选项"
L["SETTINGS_TAB_TITLE"] = SETTINGS or "设置"
L["SETTINGS_PANEL_NOTIFICATIONS"] = NOTIFICATIONS or "通知"
L["CONFIG_NOTIFICATIONS"] = NOTIFICATIONS or "通知"
L["HIDE_FILTER_BUTTON"] = HIDE or "隐藏"
L["LOOT_ALERTS_MOUNT"] = MOUNTS or "坐骑"
L["LOOT_ALERTS_PET"] = PETS or "宠物"
...
L["INFO_TAB_STATISTICS"] = STATISTICS or "统计"
L["INFO_TAB_REPUTATIONS"] = REPUTATION or "声望"
L["INFO_TAB_PROFESSIONS"] = TRADE_SKILLS or "专业"
L["INFO_TAB_COLLECTIONS"] = "收藏"
L["MODULE_PROFESSIONS"] = TRADE_SKILLS or "专业"
L["MODULE_COLLECTIONS"] = "收藏"
L["LT_REPUTATIONS"] = REPUTATION or "声望"
L["LT_PROFESSIONS"] = TRADE_SKILLS or "专业"
L["CONFIG_MOD_REPUTATIONS"] = REPUTATION or "声望"
L["CONFIG_MOD_PROFESSIONS"] = TRADE_SKILLS or "专业"
L["SKILL"] = SKILL or "技能"
L["RECIPES"] = AUCTION_CATEGORY_RECIPES or "配方"
L["LOADING"] = LFG_LIST_LOADING or "加载中..."
L["ITEM_LOADING_NAME"] = LFG_LIST_LOADING or "加载中..."
L["REMINDER_QUEST_CATALOG_COL_QUEST"] = BATTLE_PET_SOURCE_2 or "任务"
L["REMINDER_QUEST_CATALOG_SECTIONS_LABEL"] = ZONE or "区域"
L["REMINDER_ZONE_CATALOG_COL_MAP"] = BRAWL_TOOLTIP_MAP or "地图"
L["DEBUG_RELOAD_UI_BTN"] = RELOADUI or "重载界面"

L["GEAR_TAB_TITLE"] = "装备管理"
L["GEAR_TAB_DESC"] = "已装备、升级选项及跨角色升级候选"
L["GEAR_STORAGE_WARBOUND"] = "战团绑定"
L["GEAR_STORAGE_BOE"] = "装绑"
L["GEAR_STORAGE_WARBOUND_UNTIL_EQUIPPED"] = "装备前战团绑定"
L["GEAR_STORAGE_TITLE"] = "装备升级推荐"
L["GEAR_RECOMMENDED_TITLE"] = "推荐"
L["GEAR_STORAGE_SUBTITLE"] = ""
L["GEAR_STORAGE_TABLE_HDR_SLOT"] = "栏位"
L["GEAR_STORAGE_TABLE_HDR_GEAR"] = "装备"
L["GEAR_STORAGE_TABLE_HDR_RECOMMEND"] = "推荐"
L["GEAR_STORAGE_TABLE_HDR_LOCATION"] = "位置"
L["GEAR_STORAGE_TABLE_HDR_ILVL"] = "等级"
L["GEAR_STORAGE_TABLE_HDR_ITEM"] = ITEM or "物品"
L["GEAR_STORAGE_TABLE_HDR_SOURCE"] = "来源"
L["GEAR_STORAGE_EMPTY"] = "储藏中没有比这些栏位已装备更好的物品。"
L["GEAR_STORAGE_EMPTY_NO_BOE_WOE"] = "物品栏未找到可升级的装绑或装备前战团绑定物品。"
L["GEAR_STORAGE_SCANNING"] = "正在扫描存储中的升级..."
L["GEAR_TAB_LOADING"] = "正在加载装备..."
...
L["CLICK_TO_COPY_LINK"] = "左键点击复制 Wowhead 链接。"
L["CLICK_TO_COPY_URL"] = "点击复制链接"
...
L["EVENT_GROUP_STORMARION"] = "风暴突袭战"
L["QUEST_CATEGORY_DESC_WEEKLY"] = "火花、6个世界任务、世界首领、探究、钥石、全素之卷（12.0.7+）"
L["QUEST_CATEGORY_DESC_WORLD"] = "区域可重复的世界任务"
L["QUEST_CATEGORY_DESC_DAILY"] = "来自NPC的每日可重复任务"
L["QUEST_CATEGORY_DESC_EVENTS"] = "奖励目标、任务和活动"
L["ADD_QUEST_TOOLTIP"] = "追踪此角色的至暗之夜每周目标。"
L["WEEKLY_CORE_BADGE"] = "（核心）"
L["WEEKLY_CATALOG_UPCOMING_NOTE"] = "当你的客户端上线 12.0.7 补丁后，这些目标才会显示。"
L["WEEKLY_CATALOG_SECTION_UPCOMING"] = "12.0.7 补丁（即将推出）"
L["WEEKLY_PRESET_ALL"] = "追踪所有可用项"
L["WEEKLY_PRESET_ESSENTIALS"] = "每周必做"
L["WEEKLY_PROGRESS_TRACKER"] = "每周进度"
L["WEEKLY_PROGRESS_ADD_TITLE"] = "追踪每周进度"
L["WEEKLY_PROGRESS_EDIT_TITLE"] = "编辑每周进度"
L["WEEKLY_TRACK_ITEMS"] = "追踪特定目标："
L["WEEKLY_TRACK_CATEGORIES"] = "追踪分类："
L["WEEKLY_TRACK_DYNAMIC_NOTE"] = "启用后，此分类中地图上所有活跃任务都会被追踪。"
L["WEEKLY_PROGRESS_CONFIGURE"] = "配置追踪"
L["WEEKLY_PROGRESS_CONFIGURE_HELP"] = "选择要追踪的分类和特定每周目标。"
L["GEAR_NO_TRACKED_CHARACTERS_TITLE"] = "没有追踪的角色"
L["GEAR_NO_TRACKED_CHARACTERS_DESC"] = "登录一个角色以开始追踪装备。"
L["GEAR_FILTER_EMPTY_TITLE"] = "没有角色符合等级筛选"
L["GEAR_FILTER_EMPTY_DESC"] = "关闭“隐藏”或使用上方的隐藏按钮降低等级门槛，以再次显示角色。"
...
L["PVP_SUBTITLE"] = "评级进度、荣誉与比赛记录"
L["PVP_RATED_BRACKETS"] = "评级模式"
L["PVP_RATING"] = "评级"
L["PVP_SEASON_BEST"] = "赛季最佳"
L["PVP_WEEKLY"] = "每周 胜/场"
L["PVP_HONOR_LEVEL"] = "荣誉等级%d"
L["PVP_CONQUEST"] = "征服"
L["PVP_SESSION_STATS"] = "本次会话"
L["PVP_LIFETIME_STATS"] = "累计"
L["PVP_RECENT_MATCHES"] = "最近比赛"
L["PVP_RESET_HISTORY"] = "重置统计"
L["PVP_SHOW_LESS"] = "收起"
L["PVP_NO_MATCHES"] = "暂无比赛记录"
L["PVP_DRAW"] = "平局"
L["PVP_MODE_RBG"] = "评级战场"
L["PVP_MODE_SHUFFLE"] = "单人混战"
L["PVP_MODE_BLITZ"] = "闪电战"
L["PVP_HEADER_SOLO"] = "单人"
L["PVP_HEADER_SHUFFLE"] = "混战"
L["PVP_HEADER_BG"] = "战场"
L["PVP_MODE_ARENA"] = "竞技场"
L["PVP_MODE_BG"] = "战场"
L["PVP_LEVEL_PROGRESS"] = "PvP等级进度"
L["PVP_WEEKLY_CAP"] = "每周上限"
L["PVP_SEASON_CAP"] = "赛季上限"
L["PVP_INFINITY"] = "∞"
L["PVP_COL_RESULT"] = "结果"
L["PVP_COL_MODE"] = "模式"
L["PVP_COL_DELTA"] = "+/-"
L["PVP_COL_DURATION"] = "时长"
L["PVP_COL_MAP"] = "地图"
L["PVP_COL_AGO"] = "之前"
L["PVP_WARBAND_OVERVIEW"] = "战团PvP总览"
L["PVP_SEASON_N"] = "第%d赛季"
L["PVP_COL_CHARACTER"] = "角色"
L["PVP_WEEKLY_ROUNDS"] = "每周回合"
L["PVP_WIN_RATE"] = "胜率"
L["PVP_TT_KILLING_BLOWS"] = "致命一击"
L["PVP_TT_DEATHS"] = "死亡"
L["PVP_TT_DAMAGE"] = "伤害"
L["PVP_TT_HEALING"] = "治疗"
L["PVP_TT_HONOR_GAINED"] = "获得荣誉"
L["PVP_TT_MMR"] = "MMR"
...
L["CONCENTRATION_CAP_IN"] = "%s后满额"
L["CONCENTRATION_CAPPED"] = "已满额 (1,000/1,000)"
L["CONCENTRATION_EXPIRING_ALERT"] = "%s (%s) 的专注即将达到上限"
L["CASCADE_SAVINGS_BANNER"] = "连锁惠及 %d 个小号：战团共节省 %d 个%s"
L["CASCADE_AFFECTED_ALTS"] = "升级至 %d 将为以下角色解锁全账号纹章折扣："
L["NEAREST_ELIGIBLE_ALT"] = "最佳角色: %s (%s)"
L["KEYSTONE_SYNERGY_TITLE"] = "钥石联动协同"
L["KEYSTONE_RATING_BOOST"] = "%s 持有：为 %s 带来 +%d 潜在评分"
L["KEYSTONE_REROLL_SUGGESTION"] = "建议重置目标：%s（%d 个角色需要评分）"
