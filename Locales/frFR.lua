...
L["CHANGELOG_V245"] = "CORRECTIONS ET AMÉLIORATIONS :\n- Correction du suivi de Concentration\n- Ajout du support des écrans Ultra-Wide\n- Mise à jour de la section Expéditions\n- Correction du suivi de la Grande Chambre\n- Correction des compteurs de tentatives\n- Améliorations générales des performances\n- Ajout du débogueur de fuites mémoire\n\nMerci pour votre soutien !\n\nPour signaler des problèmes ou donner votre avis, laissez un commentaire sur CurseForge - Warband Nexus."
