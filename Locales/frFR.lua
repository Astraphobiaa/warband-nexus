...
L["CHANGELOG_V247"] = "NOUVELLES FONCTIONNALITÉS :\n- Mise à l'échelle UI : Ajustez la taille de l'addon dans les Paramètres\n- Automatisation de l'or : Paramètres de gestion par personnage\n- Saisie d'or : Formatage en direct avec maximum de 9 999 999po\n\nAMÉLIORATIONS :\n- UI Réputation : Refonte majeure avec meilleur agencement\n- UI Stockage : Refactorisé pour de meilleures performances\n- UI Métiers : Colonnes et agencement améliorés\n- Minicarte : Noms colorés par classe, infobulle améliorée\n- Journal d'or : Affichage des transactions amélioré\n- Hiérarchie UI : Ordre des cadres optimisé\n\nPERFORMANCES & LOCALISATION :\n- Modules obsolètes supprimés, nettoyage majeur du code\n- 11 langues synchronisées (1 404 clés, aucune lacune)\n- Intégration des WoW Global Strings\n\nMerci pour votre soutien !\nPour signaler des problèmes ou donner votre avis, laissez un commentaire sur CurseForge - Warband Nexus."
