...
L["KEYBINDING_REPLACES"] = "Cette touche était assignée à %s — elle sert maintenant à Warband Nexus."
L["KEYBINDING_SAVED"] = "Raccourci enregistré."
L["KEYBINDING_COMBAT"] = "Impossible de modifier les raccourcis en combat."
L["KEYBINDING_SETFAILED"] = "Impossible d'assigner cette touche. Essayez Échap > Options > Raccourcis."
L["KEYBINDING_VERIFY_FAIL"] = "La touche est encore assignée à une autre action (%s). Ouvrez Échap > Options > Raccourcis, supprimez cette assignation puis réessayez ici."
...
L["PLANS_COLLECTIONS"] = "Liste de tâches"
...
L["VAULT_UNLOCKED"] = "Déverrouillé"
L["VAULT_LOCKED"] = "Verrouillé"
...
L["VAULT_REWARD_ON_UNLOCK"] = "Récompense au déverrouillage"
L["VAULT_UPGRADE_HINT"] = "Amélioration"
...
L["VAULT_COMPLETE_PREFIX"] = "Compléter"
...
L["CHANGELOG_V250"] = "NOUVELLES FONCTIONNALITÉS :\n- Onglet To-Do : Section Plans renommée en To-Do avec nouveau design\n- Minuteur de réinitialisation : Compte à rebours en direct\n- Aperçu des personnages : Carte résumé avec progression quêtes & coffre\n- Liens Wowhead : Clic droit pour copier les URLs Wowhead\n- Équipement fabriqué : Info de tier au lieu de la notation X/6\n- Système de rappels : Login quotidien, reset hebdo et déclencheurs de compte à rebours\n\nONGLET ÉQUIPEMENT :\n- Les objets fabriqués affichent tier + ilvl (ex. 'Mythe 285') au lieu de 'Mythe 5/6'\n- Les objets fabriqués au max ilvl n'affichent plus de fausse flèche d'amélioration\n- L'infobulle montre le coût de refabrication, tier recommandé et crêtes manquantes\n\nCONNAISSANCES DE MÉTIER :\n- Ajout du suivi des quêtes de collecte Herboristerie et Minage\n- Ajout de la variante manquante de quête Enchantement\n- Vérification de tous les IDs de traités, uniques, trésors et collecte\n\nPERFORMANCE :\n- Mises à jour de redimensionnement limitées — plus de saccades\n- Frames de l'onglet équipement regroupés — ~60 créations en moins par rafraîchissement\n- Fuite de frame corrigée lors de l'expansion de description de plan\n\nCORRECTIONS :\n- Le dialogue de rappel ne supprime plus les alertes de zone\n- Correction de la protection anti-taint pour l'équipement de métier\n- Correction de la résolution du nom de tier\n- Correction du max ilvl de 289 à 285\n\nMerci pour votre soutien !\nPour signaler des problèmes, laissez un commentaire sur CurseForge - Warband Nexus."
...
L["CROSS_CHAR_SUMMARY"] = "Aperçu des personnages"
...
L["QUEST_TYPE_CONTENT_EVENTS_DESC"] = "Objectifs bonus, tâches d'événement et activités style campagne"
...
L["PARENT_ACHIEVEMENT"] = "Haut-fait précédent"
...
L["ADD_ITEMS_TO_PLANS"] = "Ajoutez des objets à vos plans pour les voir ici !"
...
L["CRITERIA_POSITION_LABEL"] = "Position de la progression des critères"
...
L["GEAR_NO_CURRENCY_DATA"] = "Pas encore de données de devises"
L["GEAR_NO_ITEMS_FOUND"] = "Aucun objet équipé correspondant trouvé"
L["GEAR_NO_STORAGE_FINDS"] = "Aucune amélioration de banque trouvée. Ouvrez les onglets de banque pour de meilleurs résultats."
L["GEAR_NO_UPGRADE_ITEMS"] = "Aucune amélioration disponible – tout l'équipement est au niveau max ou non pris en charge."
L["GEAR_NO_UPGRADES_AVAILABLE"] = "Aucune amélioration disponible avec les ressources actuelles"
L["GEAR_SEARCH_PLACEHOLDER"] = "Rechercher des objets équipés..."
L["GEAR_SECTION_EQUIPPED"] = "ÉQUIPEMENT ÉQUIPÉ"
L["GEAR_SECTION_LIST"] = "Tous les objets équipés"
L["GEAR_SECTION_RESOURCES"] = "RESSOURCES"
L["GEAR_SECTION_STORAGE"] = "Améliorations de banque"
L["GEAR_SECTION_UPGRADES"] = "Opportunités d'amélioration"
...
L["GEAR_STORAGE_DESC"] = "Meilleures améliorations BoE / Lié au groupe par emplacement"
...
L["GEAR_UPGRADE_CURRENT_CHAR_ONLY"] = "Infos d'amélioration disponibles uniquement pour le personnage actuel."
L["GEAR_UPGRADEABLE_SLOTS"] = "emplacement(s) améliorable(s)"
...
L["POPUP_POSITION_SAME_CRITERIA"] = "Même position pour tout (haut fait, progression des critères, etc.)"
L["PROF_DATA_SOURCE_NOTE"] = "Concentration, connaissances et recettes se mettent à jour quand vous ouvrez la fenêtre des métiers (K) sur chaque personnage."
L["PROF_FILTER_ALL"] = "Tout"
L["PROF_FILTER_EXPANSION"] = "Filtre d'extension"
L["PROF_FILTER_STRICT_NOTE"] = "Afficher uniquement les données de métier de cette extension pour tous les personnages."
L["PROF_FIRSTCRAFT_HEADER"] = "Recettes à bonus de première fabrication"
L["PROF_FIRSTCRAFT_NO_DATA"] = "Aucune donnée de métier disponible."
L["PROF_FIRSTCRAFT_NONE"] = "Aucune recette apprise avec bonus de première fabrication restant."
L["PROF_FIRSTCRAFT_OPEN_WINDOW"] = "Ouvrez d'abord une fenêtre de métier, puis relancez cette commande."
...
L["RESET_CRITERIA_BLIZZARD"] = "Réinitialiser (côté droit)"
...
L["SET_POSITION_CRITERIA"] = "Définir la position des critères"
...
L["SOURCE"] = "Source"
L["SOURCE_QUEST_REWARD"] = "Récompense de quête"
...
L["FILTER_LABEL"] = FILTER or "Filtrer"
...
L["STAT_CRITICAL_STRIKE"] = STAT_CRITICAL_STRIKE or "Coup critique"
