...
L["CHANGELOG_V250"] = "NOUVELLES FONCTIONNALITÉS :\n- Onglet To-Do : Section Plans renommée en To-Do avec nouveau design\n- Minuteur de réinitialisation : Compte à rebours en direct en haut des tâches quotidiennes\n- Aperçu des personnages : Carte résumé multi-personnages avec progression quêtes & coffre\n\nAMÉLIORATIONS :\n- Tâches quotidiennes : Progression par catégorie (Hebdo, Monde, Quotidien, Missions, Événements)\n- Suivi du coffre : Progression compacte M+/Raid/Monde par personnage\n- Sections repliables : La carte d'aperçu supporte déplier/replier\n\nLOCALISATION :\n- Traductions complètes pour les 11 langues mises à jour\n- Nouveaux textes : Réinitialisation hebdomadaire, Aperçu personnages, descriptions To-Do\n\nMerci pour votre soutien !\nPour signaler des problèmes ou donner votre avis, laissez un commentaire sur CurseForge - Warband Nexus."
