...
L["GOLD_MANAGEMENT_DESC"] = "Configurez la gestion automatique de l'or. Les dépôts et les retraits sont effectués automatiquement lorsque la banque est ouverte en utilisant l'API C_Bank."
L["GOLD_MANAGEMENT_WARNING"] = "|cff44ff44Entièrement Automatique :|r Les dépôts et les retraits d'or sont effectués automatiquement lorsque la banque est ouverte. Définissez votre montant cible et laissez l'addon gérer votre or !"
...
L["GOLD_MANAGEMENT_MODE_DEPOSIT_DESC"] = "Si vous avez plus de X or, l'excédent sera automatiquement déposé dans la banque de bande de guerre."
L["GOLD_MANAGEMENT_MODE_WITHDRAW"] = "Retrait Uniquement"
L["GOLD_MANAGEMENT_MODE_WITHDRAW_DESC"] = "Si vous avez moins de X or, la différence sera automatiquement retirée de la banque de bande de guerre."
L["GOLD_MANAGEMENT_MODE_BOTH"] = "Les Deux"
L["GOLD_MANAGEMENT_MODE_BOTH_DESC"] = "Maintenir automatiquement exactement X or sur votre personnage (dépôt si plus, retrait si moins)."
L["GOLD_MANAGEMENT_TARGET"] = "Montant d'Or Cible"
L["GOLD_MANAGEMENT_GOLD_LABEL"] = "or"
L["GOLD_MANAGEMENT_HELPER"] = "Entrez le montant d'or que vous souhaitez conserver sur ce personnage. L'addon gérera automatiquement votre or lorsque vous ouvrirez la banque."
L["GOLD_MANAGEMENT_NOTIFICATION_DEPOSIT"] = "Déposer %s dans la banque de bande de guerre (vous avez %s)"
L["GOLD_MANAGEMENT_NOTIFICATION_WITHDRAW"] = "Retirer %s de la banque de bande de guerre (vous avez %s)"
L["GOLD_MANAGEMENT_DEPOSITED"] = "Déposé %s dans la banque de bande de guerre"
L["GOLD_MANAGEMENT_WITHDRAWN"] = "Retiré %s de la banque de bande de guerre"
