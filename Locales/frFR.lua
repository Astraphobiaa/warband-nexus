...
L["TODO_SLOT_TOOLTIP_ADD"] = "Cliquer pour ajouter à votre liste À faire."
L["TODO_SLOT_TOOLTIP_REMOVE"] = "Cliquer pour retirer de votre liste À faire."
L["TODO_SUMMARY_MORE_SOURCES"] = "+%d de plus"
L["TRACK_SLOT_TOOLTIP_UNTRACK"] = "Cliquer pour arrêter le suivi dans les objectifs Blizzard."
L["TRACK_SLOT_DISABLED_COMPLETED"] = "Les hauts faits terminés ne peuvent pas être suivis dans les objectifs."
