...
L["CHANGELOG_V242"] = "NOUVELLES FONCTIONNALITÉS:\n- Suivi Guilde & XP Repos: adhésion guilde et XP repos par personnage\n- Logs Or & Automatisation - Onglet Objets: logs or, historique dépôts/retraits\n- Nouvel onglet: Équipement: équipé, améliorations, recommandations banque, candidats\n- Nouvel onglet: Collections: montures, familiers, jouets, transmog, progression\n\nAMÉLIORATIONS:\n- Mises à jour Midnight pour PvE, réputations, devises\n- Professions & Recettes, Plans, Paramètres, Performances, Notifications\n- Localisation pour les 11 langues\n\nMerci pour votre soutien! CurseForge - Warband Nexus."
