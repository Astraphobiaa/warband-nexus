...
L["CHANGELOG_V255"] = "v2.5.5\nAméliorations :\n- Onglets réorganisés — stockage, équipement et monnaies plus accessibles\n- Équipement : crests en couleur ; quantité détenue vs plafond saisonnier\n- To-Do : liste renommée ; compteur de tentatives ; clic droit dans Montures\n- Cartes To-Do : boutons sans chevauchement\n- Aide et notes de mise à jour plus courtes\n\nCorrections :\n- Barre de synchro au login ne reste plus bloquée (combat ou erreur)\n- La barre se masque seule après une longue attente si besoin\n\nCurseForge : Warband Nexus"
