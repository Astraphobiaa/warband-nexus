...
L["AUTO_SCAN_DESC"] = "Escanear autom�ticamente el banco al abrirlo"
...
L["TAB_SETTINGS_DESC"] = "Configurar el comportamiento de las pesta�as del banco"
L["IGNORED_TABS"] = "Pesta�as ignoradas"
L["IGNORED_TABS_DESC"] = "Seleccionar pesta�as a excluir del escaneo y operaciones"
L["TAB_1"] = "Pesta�a de banda 1"
L["TAB_2"] = "Pesta�a de banda 2"
L["TAB_3"] = "Pesta�a de banda 3"
L["TAB_4"] = "Pesta�a de banda 4"
L["TAB_5"] = "Pesta�a de banda 5"
...
L["CATEGORY_TRADE_GOODS"] = BAG_FILTER_TRADE_GOODS or "Mercanc�as"
L["CATEGORY_QUEST"] = BAG_FILTER_QUEST_ITEMS or "Objetos de misi�n"
L["CATEGORY_MISCELLANEOUS"] = BAG_FILTER_MISCELLANEOUS or "Miscel�nea"
...
-- Statistics
L["STATS_HEADER"] = STATISTICS or "Estad�sticas"
...
L["BONUS_SKILL"] = "Habilidad de bonificaci�n:"
...
L["TRACKING_WILL_BEGIN"] = "La recopilaci�n de datos comenzar� de inmediato."
...
L["PVE_SUBTITLE"] = "Gran B�veda, Bloqueos de Banda y M�tica+ en tu Banda de Guerra"
...
L["REP_FOOTER_DESC"] = "Las reputaciones se escanean autom�ticamente al iniciar sesi�n y cuando cambian. Usa el panel de reputaci�n en el juego para ver informaci�n detallada y recompensas."
...
L["CURRENCY_TRANSFER_NOTICE_DESC"] = "La API de Blizzard no admite transferencias autom�ticas de monedas. Por favor, usa la ventana de monedas en el juego para transferir manualmente las monedas de Banda de Guerra."
...
L["RECIPE_BROWSER_DESC"] = "Abre tu ventana de Profesi�n en el juego para explorar recetas.\nEl addon escanear� las recetas disponibles cuando la ventana est� abierta."
L["SOURCE_ACHIEVEMENT_FORMAT"] = "Fuente: [Logro %s]"
L["WEEKLY_PLAN_EXISTS_DESC"] = "%s ya tiene un plan activo de b�veda semanal. Puedes encontrarlo en la categor�a 'Mis Planes'."
...
L["WEEKLY_VAULT_CARD"] = "Tarjeta de B�veda Semanal"
L["WEEKLY_VAULT_COMPLETE"] = "Tarjeta de B�veda Semanal - Completada"
...
L["AUTO_SCAN_ITEMS"] = "Escaneo autom�tico de objetos"
...
L["PVE_DESC"] = "Rastrea el progreso de Gran B�veda con indicadores de nivel, puntuaciones y claves M�tica+, afijos, historial de mazmorras y moneda de mejora en todos los personajes."
...
L["PLANS_DESC"] = "Rastrea monturas, mascotas, juguetes, logros y transmog no recolectados. A�ade objetivos, ve fuentes de drop y sigue los contadores de intentos. Acceso v�a /wn plan o �cono del minimapa."
...
L["SHOW_TOOLTIP_ITEM_COUNT_TOOLTIP"] = "Muestra la cantidad de objetos de la banda de guerra y del personaje en las descripciones emergentes (B�squeda de WN)."
L["AUTO_SCAN_TOOLTIP"] = "Escanear y almacenar en cach� objetos autom�ticamente cuando abres bancos o bolsas"
...
L["ENABLE_NOTIFICATIONS_TOOLTIP"] = "Interruptor maestro para todas las ventanas emergentes de notificaci�n"
L["VAULT_REMINDER"] = "Recordatorio de B�veda"
L["VAULT_REMINDER_TOOLTIP"] = "Mostrar recordatorio cuando tengas recompensas de B�veda Semanal sin reclamar"
...
-- Settings - Position
-- =============================================
L["DRAG_POSITION_MSG"] = "Arrastra el marco verde para establecer la posici�n de la ventana emergente. Clic derecho para confirmar."
L["POSITION_RESET_MSG"] = "Posici�n de la ventana emergente restablecida al predeterminado (Centro Superior)"
L["POSITION_SAVED_MSG"] = "�Posici�n de la ventana emergente guardada!"
...
L["RESOLUTION_NORMALIZATION_TOOLTIP"] = "Ajustar tama�os de fuente basados en resoluci�n de pantalla y escala de interfaz para que el texto permanezca del mismo tama�o f�sico en diferentes monitores"
...
L["WEEKLY_VAULT_PLAN_FORMAT"] = "Plan de B�veda Semanal - %s"
L["ALL_SLOTS_COMPLETE"] = "�Todos los Espacios Completados!"
L["QUEST_COMPLETED_SUFFIX"] = "Completada"
L["WEEKLY_VAULT_READY"] = "�B�veda Semanal Lista!"
...
L["TRACKING_DISABLED_SCAN_MSG"] = "El rastreo de personajes est� desactivado. Activa el rastreo en la configuraci�n para escanear el banco."
...
L["REP_LOADING_FETCHING"] = "Obteniendo datos de reputaci�n..."
...
L["ZONE_PREFIX"] = "Zona: "
L["ADDED"] = "A�adido"
L["WEEKLY_VAULT_TRACKER"] = "Rastreador de B�veda Semanal"
...
L["WEEKLY_VAULT_PLAN_NAME"] = "B�veda Semanal - %s"
L["VAULT_PLANS_RESET"] = "�Los planes de Gran B�veda semanal han sido reiniciados! (%d plan%s)"
...
L["GOLD_MANAGEMENT_DESC"] = "Configura la gesti�n autom�tica de oro. Tanto los dep�sitos como los retiros se realizan autom�ticamente cuando el banco est� abierto usando la API C_Bank."
