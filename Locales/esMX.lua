...
L["CHANGELOG_V245"] = "CORRECCIONES Y MEJORAS:\n- Corregido el seguimiento de Concentración\n- Añadido soporte para monitores Ultra-Wide\n- Actualizada la sección de Misiones del Mundo\n- Corregido el seguimiento de la Gran Bóveda\n- Corregidos los contadores de intentos\n- Mejoras generales de rendimiento\n- Añadido depurador de fugas de memoria\n\n¡Gracias por tu apoyo!\n\nPara reportar problemas o dar feedback, deja un comentario en CurseForge - Warband Nexus."
