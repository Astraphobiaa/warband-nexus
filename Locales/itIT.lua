...
L["CHANGELOG_V242"] = "NUOVE FUNZIONALITÀ:\n- Tracciamento Gilda & XP Riposo: adesione gilda e XP riposo per personaggio\n- Log Oro & Automazione - Scheda Oggetti: log oro, storico depositi/prelievi\n- Nuova scheda: Equipaggiamento: equipaggiato, miglioramenti, raccomandazioni banco, candidati\n- Nuova scheda: Collezioni: cavalcature, mascotte, giocattoli, transmog, progresso\n\nMIGLIORAMENTI:\n- Aggiornamenti Midnight per PvE, reputazioni, valute\n- Professioni, Ricette, Piani, Impostazioni, Prestazioni, Notifiche\n- Localizzazione per 11 lingue\n\nGrazie per il supporto! CurseForge - Warband Nexus."
