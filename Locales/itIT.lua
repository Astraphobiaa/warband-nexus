...
L["CHANGELOG_V250"] = "NUOVE FUNZIONALITÀ:\n- Scheda To-Do: Sezione Piani rinominata in To-Do con nuovo design\n- Timer reset settimanale: Conto alla rovescia in tempo reale nella vista attività giornaliere\n- Panoramica personaggi: Scheda riepilogo multi-personaggio con progresso missioni e caveau\n\nMIGLIORAMENTI:\n- Attività giornaliere: Progresso per categoria (Settimanale, Mondo, Giornaliero, Incarichi, Eventi)\n- Tracciamento caveau: Progresso compatto M+/Raid/Mondo per personaggio\n- Sezioni comprimibili: La scheda panoramica supporta espansione/compressione\n\nLOCALIZZAZIONE:\n- Traduzioni complete per tutte le 11 lingue aggiornate\n- Nuovi testi: Reset settimanale, Panoramica personaggi, descrizioni To-Do\n\nGrazie per il vostro supporto!\nPer segnalare problemi o dare feedback, lascia un commento su CurseForge - Warband Nexus."
