...
L["CHANGELOG_V255"] = "v2.5.5\nMiglioramenti:\n- Schede riordinate — deposito, equipaggiamento e valute più accessibili\n- Equipaggiamento: crest a colori; quantità posseduta vs tetto stagionale\n- To-Do: elenco rinominato; contatore tentativi; tasto destro in Cavalcature\n- Card To-Do: pulsanti senza sovrapposizioni\n- Aiuto e note più brevi\n\nCorrezioni:\n- Barra di sync all’ingresso non si blocca più (combattimento o errore)\n- La barra si nasconde da sola dopo molta attesa\n\nCurseForge: Warband Nexus"
