...
L["KEYBINDING_REPLACES"] = "Quel tasto era assegnato a %s â€” ora Ã¨ per Warband Nexus."
L["KEYBINDING_SAVED"] = "Scorciatoia salvata."
L["KEYBINDING_COMBAT"] = "Non puoi modificare i tasti in combattimento."
L["KEYBINDING_SETFAILED"] = "Impossibile assegnare quel tasto. Prova Esc > Opzioni > Tasti."
L["KEYBINDING_VERIFY_FAIL"] = "Il tasto Ã¨ ancora assegnato a un'altra azione (%s). Apri Esc > Opzioni > Tasti, rimuovi quell'assegnazione e riprova qui."
...
L["ENABLE_ADDON_DESC"] = "Abilita o disabilita le funzionalitÃ  di Warband Nexus"
...
L["SHOW_ITEM_COUNT_DESC"] = "Mostra le quantitÃ  impilate sugli oggetti"
L["HIGHLIGHT_QUALITY"] = "Evidenzia per qualitÃ "
L["HIGHLIGHT_QUALITY_DESC"] = "Aggiungi bordi colorati in base alla qualitÃ  dell'oggetto"
...
L["DEPOSIT_QUEUE_EMPTY"] = "La coda di deposito Ã¨ vuota."
...
L["PLANS_MY_PLANS"] = "Lista attivitÃ "
L["PLANS_COLLECTIONS"] = "Lista attivitÃ "
...
L["TRY_COUNT_RIGHT_CLICK_HINT"] = "Tasto destro per modificare il numero di tentativi."
...
L["ERROR_GENERIC"] = "Si Ã¨ verificato un errore."
L["ERROR_API_UNAVAILABLE"] = "L'API richiesta non Ã¨ disponibile."
...
L["NO_PLANNED_ACTIVITY"] = "Nessuna attivitÃ  pianificata"
...
L["SKILL_LABEL"] = "AbilitÃ :"
L["OVERALL_SKILL"] = "AbilitÃ  complessiva:"
L["BONUS_SKILL"] = "AbilitÃ  bonus:"
...
L["CHARACTER_IS_TRACKED"] = "Questo personaggio Ã¨ tracciato."
...
L["TRACKING_WILL_BEGIN"] = "La raccolta dati inizierÃ  immediatamente."
L["CHARACTER_NOT_TRACKED"] = "Questo personaggio non Ã¨ tracciato."
...
L["VAULT_UNLOCK_FORMAT"] = "Completa %s attivitÃ  per sbloccare"
L["VAULT_NEXT_TIER_FORMAT"] = "Prossimo livello: %d iLvl al completamento di %s"
L["VAULT_REMAINING_FORMAT"] = "Rimanenti: %s attivitÃ "
...
L["VAULT_UNLOCKED"] = "Sbloccato"
L["VAULT_LOCKED"] = "Bloccato"
L["VAULT_IN_PROGRESS"] = "In corso"
L["VAULT_COMPLETED_ACTIVITIES"] = "Completato"
L["VAULT_CURRENT_TIER"] = "Livello attuale"
L["VAULT_REWARD"] = "Ricompensa"
L["VAULT_REWARD_ON_UNLOCK"] = "Ricompensa allo sblocco"
L["VAULT_UPGRADE_HINT"] = "Potenziamento"
L["VAULT_MAX_TIER"] = "Livello massimo"
L["VAULT_AT_MAX"] = "Livello massimo raggiunto!"
L["VAULT_BEST_SO_FAR"] = "Migliore finora"
...
L["VAULT_COMPLETE_PREFIX"] = "Completa"
L["VAULT_SLOT1_HINT"] = "Prima scelta da questa riga"
L["VAULT_SLOT2_HINT"] = "Seconda scelta (piÃ¹ opzioni!)"
L["VAULT_SLOT3_HINT"] = "Terza scelta (opzioni massime)"
...
L["CRACKED_KEYSTONE"] = "Chiave di volta incrinata"
L["SEASON"] = "Stagione"
...
L["REP_API_UNAVAILABLE_DESC"] = "L'API C_Reputation non Ã¨ disponibile su questo server. Questa funzionalitÃ  richiede WoW 12.0.1 (Midnight)."
...
L["CURRENCY_TRANSFER_INFO"] = "Il pannello valute si aprirÃ  automaticamente.\nDovrai fare clic destro manualmente sulla valuta per trasferirla."
L["SAVE"] = "Salva"
...
L["CROSS_CHAR_SUMMARY"] = "Panoramica personaggi"
...
L["QUEST_TYPE_CONTENT_EVENTS"] = "Eventi di contenuto"
L["QUEST_TYPE_CONTENT_EVENTS_DESC"] = "Obiettivi bonus, incarichi evento e attivitÃ  in stile campagna"
...
L["SHOW_TOOLTIP_ITEM_COUNT_TOOLTIP"] = "Mostra quantitÃ  oggetti Warband e personaggio nei tooltip (Ricerca WN)."
...
L["MODULE_PROFESSIONS_DESC"] = "Traccia abilitÃ  professionali, concentrazione, conoscenza e finestra compagno ricette"
...
L["CURRENCY_ACCOUNT_WIDE_NOTE"] = "Intero account (Warband) â€” stesso saldo su tutti i personaggi."
L["YOU_MARKER"] = "(Tu)"
...
L["PROFESSIONS_INFO_DESC"] = "Traccia abilitÃ  professionali, concentrazione, conoscenza e alberi specializzazione su tutti i personaggi. Include Recipe Companion per fonti reagenti."
...
L["CHANGELOG_V256"] = "v2.5.6\nMiglioramenti:\n- Reame piÃ¹ leggibile in equipaggiamento, piani settimanali, tracker piani, dialogo tracciamento; le chiavi salvate restano nel testo normalizzato Blizzard\n- Collezionabili: elenco NPC ampliato (Redini del Divoratore di sangue domato, BfA); note forziere vs boss e bottino multi-cadavere per i tentativi\n- SplitCharacterKey + divisione solo al primo trattino per Nome-Reame\n- Audit montature: DB Lua Mounts community + Wowhead/WoWDB\n\nCorrezioni:\n- Contatore tentativi: bottino chat + tabelle condivise â€” non si perdono piÃ¹ aggiornamenti CHAT (es. Divoratore di sangue)\n- Reami con trattini (Azjol-Nerub): chiavi canoniche, riparazione GetAllCharacters, statistiche/minimappa; migrazione una tantum campo reame\n- ID cavalcature: Verdant Skitterfly (192764), cristallo qiraji rosso (21321)\n- Dialogo tracciamento: GetRealmName protetto per valori segreti\n\nLocalizzazione:\n- Suggerimenti TRY_COUNT clic / tasto destro in tutte le lingue\n\nRepo: Git contiene solo le sorgenti dellâ€™addon (Core, Modules, Locales, toc, CHANGES)\n\nCurseForge: Warband Nexus"

L["CHANGELOG_V257"] = "v2.5.7b\nMiglioramenti:\n- Personaggi: ordine predefinito (personaggio online prima, poi livello, nome); nuovi profili; chiavi di ordinamento sconosciute â†’ prima voce del menu\n- Personaggi: personaggio connesso sempre in cima in Preferiti/Personaggi/Non tracciati; ordine manuale coerente\n- Contatore tentativi: difficoltÃ  istanza con GetInstanceInfo + snapshot allâ€™ingresso (corregge Normal errato in mitico, es. Mechagon HK-8)\n- Contatore: un filtro difficoltÃ  per bottino, ENC ritardato e CHAT; stessa chiave dedup encounter_ del bottino\n- Contatore: chiave encounter_ con 0 tracciabili per evitare doppi conteggi\n- Contatore: bottino open-world fuso conta cadaveri con lo stesso oggetto cavalcatura (BfA Divoratore di sangue)\n- Equipaggiamento: larghezza selettore personaggio\n\nCorrezioni:\n- Contatore: incremento dopo messaggio di esclusione difficoltÃ \n\nLocalizzazione: SORT_MODE_DEFAULT\n\nCurseForge: Warband Nexus"

L["CHANGELOG_V258"] = "v2.5.8\nCorrezioni:\n- Contatore tentativi: CHAT_MSG_LOOT non genera piÃ¹ errori nel percorso di attribuzione pesca (dichiarazione anticipata di CurrentUnitsHaveMobLootContext; prima globale nil).\n\nCurseForge: Warband Nexus"

L["CHANGELOG_V259"] = [=[v2.5.9 (03.04.2026)

Miglioramenti
- Collezionabili / contatore tentativi: battaglia di Dazar'alor â€” Glacial Tidestorm solo mitico da Lady Jaina (non LFR). G.M.O.D.: LFR da Jaina; normale/eroico/mitico da Mekkatorque (hotfix 2019). Supporto LFR esplicito; reseed statistiche con statisticIds per riga bottino; Mekkatorque senza somma LFR Jaina (13379).
...
--- 2.5.8 ---
Correzioni
- Contatore: CHAT_MSG_LOOT percorso pesca â€” CurrentUnitsHaveMobLootContext dichiarato in anticipo (prima nil globale).
...
Miglioramenti
- Personaggi: nuovo ordinamento predefinito (personaggio connesso, poi livello decrescente, poi nome Aâ€“Z). Nuovi profili: characterSort.key = default. Chiavi sconosciute â†’ prima voce menu. Connesso in cima in Preferiti, tracciati e non tracciati (anche ordine manuale); seed manuale include tutta la sezione, online per primo; characterOrder con lista non tracciati; riordino mantiene online in cima.
...
- Contatore: difficoltÃ  istanza preferisce snapshot all'ingresso (PLAYER_ENTERING_WORLD, ID istanza), poi GetInstanceInfo, prima di ENCOUNTER_END e API â€” corregge mitico letto come normale (es. Mechagon HK-8). ResolveLiveInstanceDifficultyID per M+ e API con difficoltÃ  0; ResolveEffectiveEncounterDifficultyID unifica il gate.
...
- Contatore: [WN-Drops] intestazione TRYCOUNTER_INSTANCE_DROPS_HEADER; difficoltÃ  richiesta tra parentesi dopo il link â€” verde/rosso/ambra.

Correzioni
- Contatore: incremento dopo messaggio esclusione difficoltÃ  (bottino vs ENC/CHAT).
...
--- 2.5.6 ---
Miglioramenti
- Reame piÃ¹ leggibile in equipaggiamento, piani, tracker, tracciamento.
- Collezionabili: piÃ¹ NPC Bloodfeaster BfA; note forziere vs boss e multi-cadavere.
- SplitCharacterKey + primo trattino Nome-Reame.
- Mount: DB Lua community + Wowhead/WoWDB.

Correzioni
- Contatore: chat bottino + tabelle condivise â€” aggiornamenti CHAT ok.
...
L["CURRENCY_WINDOW_OPENED"] = "Il pannello valute Ã¨ ora aperto!"
...
L["SKILLUP_DESC"] = "Ricette che possono ancora aumentare il tuo livello di abilitÃ "
...
L["TRYCOUNTER_AFTER_TRIES"] = "dopo %d tentativi"
L["TRYCOUNTER_FIRST_TRY"] = "al primo tentativo!"
...
L["TRYCOUNTER_INSTANCE_COLLECTIBLE_DETECTED"] = "Collezionabile rilevato : "
L["TRYCOUNTER_INSTANCE_WRONG_DIFF"] = "DifficoltÃ  errata: serve %s (sei in %s)."
L["TRYCOUNTER_INSTANCE_REQUIRES_UNVERIFIED"] = "Richiede %s (difficoltÃ  attuale sconosciuta)."
...
L["TRYCOUNTER_INSTANCE_DROPS_TRUNCATED"] = "â€¦ altre |cffffccff%d|r â€” |cffffffff/wn check|r su un boss (bersaglio o mouse)."
...
L["CONFIG_MOD_PROFESSIONS_DESC"] = "Traccia abilitÃ  professionali, ricette e concentrazione."
...
L["CONFIG_RESET_PLANS_CONFIRM"] = "Questo rimuoverÃ  tutti i piani completati. Continuare?"
...
L["CONFIG_DELETE_CONFIRM"] = "Sei sicuro di voler eliminare permanentemente tutti i dati di questo personaggio? Questa azione non puÃ² essere annullata."
...
L["GOLD_MANAGEMENT_DESC"] = "Configura la gestione automatica dell'oro. Sia i depositi che i prelievi vengono eseguiti automaticamente quando la banca Ã¨ aperta usando l'API C_Bank."
L["GOLD_MANAGEMENT_WARNING"] = "|cff44ff44Completamente automatico:|r Sia i depositi che i prelievi di oro vengono eseguiti automaticamente quando la banca Ã¨ aperta. Imposta l'importo target e lascia che l'addon gestisca il tuo oro!"
...
L["CHILDREN_ACHIEVEMENTS"] = "Imprese successive"
L["LOADING_ACHIEVEMENTS"] = "Caricamento imprese..."
L["PARENT_ACHIEVEMENT"] = "Impresa precedente"
...
L["ADD_ITEMS_TO_PLANS"] = "Aggiungi oggetti ai tuoi piani per vederli qui!"
...
L["COLLECTIONS_CONTENT_SUB_ACHIEVEMENTS"] = "Sfoglia per categoria; criteri e dettagli a destra."
L["COLLECTIONS_CONTENT_TITLE_MOUNTS"] = "Cavalcature"
L["COLLECTIONS_CONTENT_SUB_MOUNTS"] = "Raggruppate per fonte; anteprima a destra."
L["COLLECTIONS_CONTENT_TITLE_PETS"] = "Mascotte"
L["COLLECTIONS_CONTENT_SUB_PETS"] = "Raggruppate per fonte; modello a destra."
L["COLLECTIONS_CONTENT_TITLE_TOYS"] = "Scrigno dei giocattoli"
L["COLLECTIONS_CONTENT_SUB_TOYS"] = "Raggruppati per fonte; dettagli a destra."
L["COLLECTIONS_CONTENT_TITLE_RECENT"] = "Acquisizioni recenti"
L["COLLECTIONS_CONTENT_SUB_RECENT"] = "Fino a 10 voci piÃ¹ recenti per categoria, prima le piÃ¹ nuove."
L["COLLECTIONS_SUBTAB_RECENT"] = "Recenti"
L["COLLECTIONS_RECENT_TAB_EMPTY"] = "Nessuna acquisizione registrata. Nuove cavalcature, mascotte, giocattoli e imprese appariranno qui."
L["COLLECTIONS_RECENT_SECTION_HEAD_FMT"] = "%s â€” ultimi %d"
L["COLLECTIONS_RECENT_SECTION_NONE"] = "Nessuna ancora."
L["COLLECTIONS_RECENT_SECTION_ROW"] = "%s Â· %s"
L["COLLECTIONS_RECENT_SEARCH_EMPTY"] = "Nessuna voce corrispondente."
L["COLLECTIONS_RECENT_HEADER"] = "Ultime acquisizioni"
L["COLLECTIONS_RECENT_EMPTY"] = "Gli oggetti ottenuti appariranno qui con un timestamp breve."
...
L["COLLECTIONS_RECENT_SECTION_MOUNTS"] = "Cavalcature recenti"
L["COLLECTIONS_RECENT_SECTION_PETS"] = "Mascotte recenti"
L["COLLECTIONS_RECENT_SECTION_TOYS"] = "Giocattoli recenti"
L["COLLECTIONS_RECENT_SECTION_ACHIEVEMENTS"] = "Imprese recenti"
L["COLLECTIONS_RECENT_SECTION_EMPTY"] = "Nessuna acquisizione recente per questa categoria."
L["COLLECTIONS_RECENT_SECTION_LINE"] = "%s Â· %s"
L["COLLECTIONS_COMING_SOON_DESC"] = "Panoramica collezioni (cavalcature, mascotte, giocattoli, transmog) sarÃ  disponibile qui."
L["COLLECTIONS_COMING_SOON_TITLE"] = "In arrivo"
...
L["CRITERIA_POSITION_LABEL"] = "Posizione progresso criteri"
...
L["GEAR_NO_CURRENCY_DATA"] = "Nessun dato valuta ancora"
L["GEAR_NO_ITEMS_FOUND"] = "Nessun oggetto equipaggiato corrispondente trovato"
L["GEAR_NO_STORAGE_FINDS"] = "Nessun upgrade deposito trovato. Apri le schede della banca per risultati migliori."
L["GEAR_NO_UPGRADE_ITEMS"] = "Nessun upgrade disponibile: tutto l'equipaggiamento Ã¨ al livello max o non supportato."
L["GEAR_NO_UPGRADES_AVAILABLE"] = "Nessun upgrade disponibile con le risorse attuali"
L["GEAR_SEARCH_PLACEHOLDER"] = "Cerca oggetti equipaggiati..."
L["GEAR_SECTION_EQUIPPED"] = "EQUIPAGGIAMENTO EQUIPAGGIATO"
L["GEAR_SECTION_LIST"] = "Tutti gli oggetti equipaggiati"
L["GEAR_SECTION_RESOURCES"] = "RISORSE"
L["GEAR_SECTION_STORAGE"] = "Upgrade deposito"
L["GEAR_SECTION_UPGRADES"] = "OpportunitÃ  di upgrade"
L["GEAR_STORAGE_BEST"] = "Migliore"
...
L["GEAR_STORAGE_DESC"] = "Migliori miglioramenti BoE / Vincolato alla banda per slot"
...
L["GEAR_UPGRADE_CURRENT_CHAR_ONLY"] = "Info upgrade disponibile solo per il personaggio attuale."
L["GEAR_UPGRADEABLE_SLOTS"] = "slot migliorabili"
L["LT_COLLECTION_DATA"] = "Dati collezione"
L["LT_COLLECTION_SCAN"] = "Scan collezione"
...
L["POPUP_POSITION_MAIN"] = "Principale (imprese, cavalcature, ecc.)"
L["POPUP_POSITION_SAME_CRITERIA"] = "Stessa posizione per tutto (impresa, progresso criteri, ecc.)"
L["PROF_DATA_SOURCE_NOTE"] = "Concentrazione, conoscenza e ricette si aggiornano aprendo la finestra professioni (K) su ogni personaggio."
L["PROF_FILTER_ALL"] = "Tutti"
L["PROF_FILTER_EXPANSION"] = "Filtro espansione"
L["PROF_FILTER_STRICT_NOTE"] = "Mostra solo dati professione di questa espansione per tutti i personaggi."
L["PROF_FIRSTCRAFT_HEADER"] = "Ricette bonus prima creazione"
L["PROF_FIRSTCRAFT_NO_DATA"] = "Nessun dato professione disponibile."
L["PROF_FIRSTCRAFT_NONE"] = "Nessuna ricetta appresa con bonus prima creazione rimanente."
L["PROF_FIRSTCRAFT_OPEN_WINDOW"] = "Apri prima una finestra professione e riesegui questo comando."
L["PROF_FIRSTCRAFT_RECIPES"] = "ricetta/e"
L["PROF_FIRSTCRAFT_TOTAL"] = "Totale"
L["RECIPES_COLUMN_FORMAT"] = "La colonna mostra Appreso / Totale (il totale include non appresi)"
L["RESET_CRITERIA_BLIZZARD"] = "Reimposta (lato destro)"
...
L["SET_POSITION_CRITERIA"] = "Imposta posizione criteri"
...
L["SOURCE"] = "Fonte"
L["SOURCE_QUEST_REWARD"] = "Ricompensa missione"
...
L["PROF_INFO_UNLOCKED"] = "Sbloccato"
L["PROF_INFO_LOCKED"] = "Bloccato"
L["PROF_INFO_UNLEARNED"] = "Non appreso"
L["PROF_INFO_NODES"] = "nodi"
L["PROF_INFO_RANKS"] = "gradi"
L["NOTIFICATION_FIRST_TRY"] = "Ottenuto al primo tentativo!"
L["NOTIFICATION_GRIND_TRIES"] = "Che fatica! %d tentativi!"
L["NOTIFICATION_GOT_IT_AFTER"] = "Ottenuto dopo %d tentativi!"
L["NOTIFICATION_TRY_SUBTITLE"] = "%d tentativi"
L["NOTIFICATION_TRY_SUBTITLE_FIRST"] = "Primo tentativo!"
...
L["GOLD_MGMT_TARGET_LABEL"] = "Obiettivo"
...
Correzioni
- Contatore tentativi: distinzione piÃ¹ netta tra pesca, raccolta professioni e bottino solo da oggetti; meno conteggi falsi. Sessione bottino e CHAT_MSG_LOOT affinate.

UI Piani
- Lista cose da fare e progresso settimanale: Mostra pianificati / Mostra completati allineati alle schede sfoglia; stati vuoti piÃ¹ chiari per achievement e liste.
