...
L["LOOT_ALERTS_TOOLTIP"] = "Interruttore principale dei popup collezionabili. Disattivarlo nasconde tutte le notifiche dei collezionabili."
L["LOOT_ALERTS_MOUNT"] = "Notifiche cavalcature"
L["LOOT_ALERTS_MOUNT_TOOLTIP"] = "Mostra notifica quando collezioni una nuova cavalcatura."
L["LOOT_ALERTS_PET"] = "Notifiche mascotte"
L["LOOT_ALERTS_PET_TOOLTIP"] = "Mostra notifica quando collezioni una nuova mascotte."
L["LOOT_ALERTS_TOY"] = "Notifiche giocattoli"
L["LOOT_ALERTS_TOY_TOOLTIP"] = "Mostra notifica quando collezioni un nuovo giocattolo."
L["LOOT_ALERTS_TRANSMOG"] = "Notifiche aspetto"
L["LOOT_ALERTS_TRANSMOG_TOOLTIP"] = "Mostra notifica quando collezioni un nuovo aspetto armatura o arma."
L["LOOT_ALERTS_ILLUSION"] = "Notifiche illusioni"
L["LOOT_ALERTS_ILLUSION_TOOLTIP"] = "Mostra notifica quando collezioni una nuova illusione arma."
L["LOOT_ALERTS_TITLE"] = "Notifiche titoli"
L["LOOT_ALERTS_TITLE_TOOLTIP"] = "Mostra notifica quando ottieni un nuovo titolo."
L["LOOT_ALERTS_ACHIEVEMENT"] = "Notifiche imprese"
L["LOOT_ALERTS_ACHIEVEMENT_TOOLTIP"] = "Mostra notifica quando ottieni una nuova impresa."
...
L["GOLD_MANAGEMENT_DESC"] = "Configura la gestione automatica dell'oro. Sia i depositi che i prelievi vengono eseguiti automaticamente quando la banca è aperta utilizzando l'API C_Bank."
...
L["GOLD_MANAGEMENT_MODE"] = "Modalità di Gestione"
L["GOLD_MANAGEMENT_MODE_DEPOSIT"] = "Solo Deposito"
L["GOLD_MANAGEMENT_MODE_DEPOSIT_DESC"] = "Se hai più di X oro, l'eccesso verrà automaticamente depositato nella banca della banda di guerra."
L["GOLD_MANAGEMENT_MODE_WITHDRAW"] = "Solo Prelievo"
L["GOLD_MANAGEMENT_MODE_WITHDRAW_DESC"] = "Se hai meno di X oro, la differenza verrà automaticamente prelevata dalla banca della banda di guerra."
L["GOLD_MANAGEMENT_MODE_BOTH"] = "Entrambi"
L["GOLD_MANAGEMENT_MODE_BOTH_DESC"] = "Mantieni automaticamente esattamente X oro sul tuo personaggio (deposita se ne hai di più, preleva se ne hai di meno)."
L["GOLD_MANAGEMENT_TARGET"] = "Importo Oro Target"
L["GOLD_MANAGEMENT_GOLD_LABEL"] = "oro"
L["GOLD_MANAGEMENT_HELPER"] = "Inserisci la quantità di oro che desideri mantenere su questo personaggio. L'addon gestirà automaticamente il tuo oro quando aprirai la banca."
L["GOLD_MANAGEMENT_NOTIFICATION_DEPOSIT"] = "Deposita %s nella banca della banda di guerra (hai %s)"
L["GOLD_MANAGEMENT_NOTIFICATION_WITHDRAW"] = "Preleva %s dalla banca della banda di guerra (hai %s)"
L["GOLD_MANAGEMENT_DEPOSITED"] = "Depositato %s nella banca della banda di guerra"
L["GOLD_MANAGEMENT_WITHDRAWN"] = "Prelevato %s dalla banca della banda di guerra"
