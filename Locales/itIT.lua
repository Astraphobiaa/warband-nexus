...
L["CHANGELOG_V247"] = "NUOVE FUNZIONALITÀ:\n- Ridimensionamento UI: Regola la dimensione dell'addon nelle Impostazioni\n- Automazione oro: Impostazioni di gestione oro per personaggio\n- Inserimento oro: Formattazione in tempo reale con massimo 9.999.999po\n\nMIGLIORAMENTI:\n- UI Reputazione: Revisione completa con layout migliorato\n- UI Deposito: Rifattorizzato per prestazioni migliori\n- UI Professioni: Colonne e layout migliorati\n- Minimappa: Nomi colorati per classe, tooltip migliorato\n- Registro oro: Visualizzazione transazioni migliorata\n- Gerarchia UI: Ordine dei frame ottimizzato\n\nPRESTAZIONI E LOCALIZZAZIONE:\n- Moduli obsoleti rimossi, pulizia importante del codice\n- 11 lingue sincronizzate (1.404 chiavi, nessuna lacuna)\n- Integrazione WoW Global Strings\n\nGrazie per il vostro supporto!\nPer segnalare problemi o dare feedback, lascia un commento su CurseForge - Warband Nexus."
