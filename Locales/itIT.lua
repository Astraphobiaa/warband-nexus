...
L["KEYBINDING_REPLACES"] = "Quel tasto era assegnato a %s — ora è per Warband Nexus."
...
L["KEYBINDING_VERIFY_FAIL"] = "Il tasto è ancora assegnato a un'altra azione (%s). Apri Esc > Opzioni > Tasti, rimuovi quell'assegnazione e riprova qui."
...
L["PLANS_MY_PLANS"] = "Lista attività"
L["PLANS_COLLECTIONS"] = "Lista attività"
...
L["VAULT_SLOT2_HINT"] = "Seconda scelta (più opzioni!)"
...
L["QUEST_TYPE_CONTENT_EVENTS_DESC"] = "Obiettivi bonus, incarichi evento e attività in stile campagna"
...
L["TRYCOUNTER_INSTANCE_WRONG_DIFF"] = "Difficoltà errata: serve %s (sei in %s)."
L["TRYCOUNTER_INSTANCE_REQUIRES_UNVERIFIED"] = "Richiede %s (difficoltà attuale sconosciuta)."
...
L["TRYCOUNTER_INSTANCE_DROPS_TRUNCATED"] = "… altre |cffffccff%d|r — |cffffffff/wn check|r su un boss (bersaglio o mouse)."
...
L["COLLECTIONS_CONTENT_SUB_RECENT"] = "Fino a 10 voci più recenti per categoria, prima le più nuove."
...
L["COLLECTIONS_RECENT_SECTION_HEAD_FMT"] = "%s — ultimi %d"
...
L["COLLECTIONS_COMING_SOON_DESC"] = "Panoramica collezioni (cavalcature, mascotte, giocattoli, transmog) sarà disponibile qui."
...
L["GEAR_NO_UPGRADE_ITEMS"] = "Nessun upgrade disponibile: tutto l'equipaggiamento è al livello max o non supportato."
...
L["GEAR_SECTION_UPGRADES"] = "Opportunità di upgrade"
