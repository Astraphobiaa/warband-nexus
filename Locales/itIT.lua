...
L["CHANGELOG_V250"] = "NUOVE FUNZIONALITÀ:\n- Scheda To-Do: Sezione Piani rinominata in To-Do\n- Timer reset settimanale: Conto alla rovescia in tempo reale\n- Panoramica personaggi: Scheda riepilogo con progresso missioni e caveau\n- Link Wowhead: Tasto destro per copiare URL Wowhead\n- Equip. fabbricato: Info di tier invece della notazione X/6\n- Sistema promemoria: Login giornaliero, reset settimanale e timer\n\nSCHEDA EQUIPAGGIAMENTO:\n- Gli oggetti fabbricati mostrano tier + ilvl (es. 'Mito 285') invece di 'Mito 5/6'\n- Gli oggetti fabbricati all'ilvl massimo non mostrano più freccia falsa\n- Il tooltip mostra costo, tier consigliato e creste mancanti\n\nCONOSCENZA PROFESSIONI:\n- Aggiunto tracciamento settimanale raccolta per Erboristeria e Estrazione\n- Aggiunta variante mancante di missione settimanale Incantamento\n- Verificati tutti gli ID di trattati, unici, tesori e raccolta\n\nPRESTAZIONI:\n- Aggiornamenti ridimensionamento limitati — niente più cali di FPS\n- Frame della scheda equip. raggruppati — ~60 creazioni in meno per aggiornamento\n- Corretto leak di frame nell'espansione descrizione piano\n\nCORREZIONI:\n- Il dialogo promemoria non cancella più gli avvisi di zona\n- Corretta lacuna di protezione anti-taint per equip. professione\n- Corretta risoluzione nome tier\n- Corretto max ilvl da 289 a 285\n\nGrazie per il supporto!\nPer segnalare problemi, lascia un commento su CurseForge - Warband Nexus."
